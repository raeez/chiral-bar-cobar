...
The genus-0 four-point vertex is universal.
...
$\widehat{\mathfrak{sl}}_2 \to \mathrm{Vir}$; the same
ghost-number argument applies to any principal DS reduction
$\widehat{\fg} \to \cW(\fg)$ (the ghost-number grading of the
BRST complex is universal), yielding
Conjecture~\ref{conj:general-ds-primitivity} in the main text.
