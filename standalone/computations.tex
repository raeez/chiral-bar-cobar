...
\begin{remark}[Wave-14 reconstitution anchor]\label{rem:wave14-anchor-comp}
...
\emph{Step~2.} At degree $k \geq 2$, every HPL tree has at least
...
obstruction that kills all higher-degree components.
