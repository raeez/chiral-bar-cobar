...
closes for 3d HT theories with a conformal vector and a BRST
primitive of holomorphic translation at non-critical level (the
topologization theorem, proved for affine KM); without that primitive
the structure remains $\SCchtop$.
