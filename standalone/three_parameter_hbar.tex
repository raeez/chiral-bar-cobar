...
The Beilinson discipline substitutes $\Psi = 3$: then $(\Psi-1)/\Psi = 2/3$
but $1/\Psi = 1/3$. A direct Miura computation at $N = 3$, spin $s = 3$,
$\Psi = 3$ (verifiable by elementary symmetric expansion of
$T(u) = \prod_{i=1}^3 (u + \Lambda_i)$) reads off $2/3$, not
$1/3$.
\end{remark}
