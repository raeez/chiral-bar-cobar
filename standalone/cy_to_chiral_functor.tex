...
$\kappa_{\mathrm{ch}} = \chi(S)/2$ does not apply (\textup{AP-CY34},
\textup{AP182}). The McKay orbifold $[\bC^3/\bZ_3]$ gives
...
\begin{remark}[HZ-7 compliance: all $\kappa$ subscripts explicit]
...
forbidden in Vol~III (HZ-7). The identifications
