...
additive invariant; the Hodge-supertrace Route~A $\Xi = \kappa_{\mathrm{ch}}$
is K\"unneth-multiplicative and vanishes on $K3 \times E$.
See Volume~III
...
Hodge-supertrace $\Xi = \kappa_{\mathrm{ch}}$ is
K\"unneth-multiplicative and gives
$\Xi(K3 \times E) = 2 \cdot 0 = 0$; the two routes label
genuinely distinct invariants.  See Volume~III
Remark~\ref{V3-rem:beauville-kappa-formula-subscript-split}
