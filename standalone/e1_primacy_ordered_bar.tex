...
\textup{\cite{EK98}} the resulting filtration is PBW-flat over
$\hbar$. Koszulity of the pure-braid Orlik--Solomon algebra
(Shelton--Yuzvinsky~\textup{\cite{SheltonYuzvinsky}}) identifies
...
extends to an action of the braid group $\mathrm{PBr}_n$ by
Yang--Baxter; the quotient
$\Barord(\cA)_n/\mathrm{PBr}_n$ is the symmetric bar
