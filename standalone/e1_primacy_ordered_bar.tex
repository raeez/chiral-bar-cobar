...
defined on~$\bar\cA$, not on $\cA$ itself~\cite[AP132]{Lor26}.
...
$\Sigma_n$-coinvariants suffice; V2-AP4); it does not factor
...
families (V2-AP4). Under this twist the comparison between ribbon and
...
under $R$-twisted $\Sigma_n$-coinvariants (V2-AP4), and
...
\begin{remark}[Categorical level of the $\Etwo$ braided structure; AP-CY56]
...
most common conflation (FM40, MP1), we state explicitly \emph{which
...
the twist reduces to the naive one on the pole-free subclass; V2-AP4)
