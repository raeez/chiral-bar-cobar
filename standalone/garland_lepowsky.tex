...
complementarity sum vanishes family-specifically; the general
$W$-algebra statement $\kappa + \kappa' = K/2$ reduces to~$0$ here
because $K_{\ghat} = 0$). The shadow obstruction tower is class~$L$
...
and (ii) the chiral Positselski $(7,2)$ and $(5,3)$ theorems
(\textup{\textsf{thm:chiral-positselski-7-2}},
\textup{\textsf{thm:chiral-positselski-5-3}}), which give the
