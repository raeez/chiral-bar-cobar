...
The holographic datum has seven load-bearing faces. Face~(6) is the Drinfeld-centre
identification
...
$\SCchtop$ to $\Ethree^{\mathrm{top}}$ is proved cohomologically for
affine Kac--Moody algebras at non-critical level, where the Sugawara
...
% r-matrix pole order: simple pole, k*Omega/z
