...
$\cA^!\text{-mod}$ under the compact-generator open--closed
hypotheses. The
...
The ordered bar complex is the common source for the boundary-to-bulk
trace, the boundary-to-lines Koszul-dual passage, and the
bulk-to-lines complementarity cofibre. Commutativity of the triangle is
...
The derived chiral centre is the bulk algebra on the
boundary-linear comparison surface of a 3d HT gauge theory. This is
the content of the BBL identification: the bar construction on $\cA$
produces a coalgebra; the chiral Hochschild cochain complex of $\cA$
(computed from the bar resolution) produces the bulk observables; the
