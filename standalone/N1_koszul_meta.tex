...
description is not asserted by this consequence.
...
\item On the Koszul locus, $\ChirHoch^\bullet(\cA)$ has
 ...
 $0,1,2$ terms. A free-polynomial cup-product description is not
...
stronger and requires a separate multiplicative computation beyond
the Hilbert-polynomial theorem. Chiral Hochschild
...
cup-product algebra is stronger and is not asserted without a
separate multiplicative computation.
