...
Fix $n \ge 1$. The bar complex in arity~$n$ is constructed on the
...
lower-arity bar complexes, one for each vertex of~$T$.
$E_2$-collapse at each vertex arity gives acyclicity at $S_T$:
...
depth concerns the arity at which the shadow tower terminates.
