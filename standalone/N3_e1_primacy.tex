...
The ordered bar complex is primitive; the symmetric bar is
obtained from it by descent and coinvariants. The
...
$E_{1}$-coassociative on the curve geometry: a single primitive
