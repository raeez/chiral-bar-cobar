...
\verb|thm:chiral-qg-equiv-toroidal-formal-disk| via
Schiffmann--Vasserot CoHA plus Miki DIM gives chiral QG equivalence
at the formal-disk level; the global $\mathbb{P}^1\times\mathbb{P}^1$
case is conditional on class-$\mathsf{M}$ chain-level.
