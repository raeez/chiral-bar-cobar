...
% ================================================================
\appendix
\section{Note added in proof: ordered Koszul chiral algebra,
Yangian instance, chiral QG equivalence (ordered)}
\label{sec:n3-note-added}
% ================================================================

The 2026-04-16 closure wave inscribed three advances that directly
upgrade the open-problem section (\S\ref{sec:open-problems}) of
this note to partial theorems on the $E_1$-chiral side of the
atlas.
...
unitarity $R(z)\,R^{op}(-z)=\id$; automatic for rational Yangians
and generic-$q$ trigonometric $U_q(\widehat{\fg})$, vacuous when
