...
\subsection*{13.10.\enspace The deepest open problems (2026-04-17 state)}

The 2026-04-16 closure wave proved the periodic-CDG compatibility
for admissible Kazhdan--Lusztig, iterated Sugawara and the
$E_\infty$-topologization ladder, the chiral higher-Deligne
theorem, the SC$^{\mathrm{ch,top}}$ heptagon, the CY-D dimension
stratification, and the Francis--Gaitsgory $(\infty,2)$-equivalence
at properad level. The 2026-04-17 Beilinson-rectified audit
reduced the frontier to the following residual problems.

\smallskip\noindent\textbf{Beilinson-rectified residuals
(2026-04-17).}
