...
\item \emph{Super-complementarity canonical Verdier pairing}:
 $\kappa + \kappa^! = \max(m,n)$ holds for super-Yangians
 $Y(\mathfrak{sl}(m|n))$ at Sugawara-shifted dual level. Two
 admissible pairings (super-trace and Berezinian) coexist
 without programme-level canonicalisation; the Verdier
 pairing inscription is pending.
\end{enumerate}
