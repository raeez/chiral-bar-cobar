...
& ordered bar (level-$2$ $E_1$-coalgebra with deconcatenation before averaging, carrying the $R$-matrix and Yangian) versus symmetric bar ($\Sigma_n$-coinvariant shadow carrying only $\kappa$). The ordered bar generates; the symmetric bar averages
& \path{chapters/theory/e1_primacy_ordered_bar.tex} \\
