...
operators of order $k_{\max} - 1$ for $k_{\max} \geq 2$.  This
...
singularity (AP19): a pole of order $n$ in the OPE
...
\begin{itemize}
  ...
  \item If $k_{\max} \geq 2$: the collision residue has poles
...
collision residue after $d\log$ absorption (AP19) is
...
For $k_{\max} \geq 2$, the collision residue encodes ``higher Gaudin
