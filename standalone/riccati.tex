...
in governing the geometry of the shadow tower, not in the sense
...
is $1$ (the curvature $\kappa$ at arity $2$), the inequality
$d_{\mathrm{alg}} \leq 4$ forces all depths $d \geq 5$ to
arise from $d_{\mathrm{arith}}$.
