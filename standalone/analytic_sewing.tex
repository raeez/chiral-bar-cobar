...
\label{rem:wave14-AP203}
The resolution of AP203 (central-charge uniqueness of degree-$2$
curvature $m_0$) is via Hodge theory plus vacuum-proportionality:
...
\begin{remark}[HZ-1/HZ-4 compliance]
...
degeneration via Mok25 log-FM smoothness. This provides the
HZ-IV independent verification for the MC5 analytic theorem.
\end{remark}
