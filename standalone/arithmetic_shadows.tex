...
a constrained Epstein zeta function
	...
	Hecke $L$-functions at higher rank. The genus-$1$ Fourier
	Dirichlet series $D_2$ is Eisenstein; the shadow $L$-function
	$L^{\sh}_\cA(s) = \sum_{r \ge 2} S_r\, r^{-s}$ is a different,
	non-Euler series whose continuation requires a separate theorem.
	At integer level,
...
do not belong to the Kummer-irregular list. They still appear in the
