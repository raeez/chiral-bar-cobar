...
lattice: the $U_{12}$ chart closes the circularity of~\textup{FM197}.
...
resolution, closing~\textup{FM197}.
...
invoked; the circularity of FM197 is closed at the $U_{12}$
chart.
\end{proof}

\begin{remark}[Why this closes FM197]
\label{rem:fm197-closed}
FM197 flagged the classical Virasoro Koszulness proof as
...
chart inclusion, closing~\textup{FM161}.
...
FM161 flagged the gap between associative and chiral Koszulness
...
surjectivity is open and is the correct form of~FM161.
\end{remark}
...
prove a theorem whose conclusion is bar--cobar inversion (FM197).
This is circular.
...
its chiral content is stated but not produced (FM161).
