...
For the Yangian $Y_\hbar(\fg)$ with $\fg$ simple, every
associative PBW chart for which the RTT evaluation data define a
finite-PBW \(\Eone\)-chiral avatar maps to the corresponding
chiral Koszulness chart:
\[
