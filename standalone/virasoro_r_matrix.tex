...
% ================================================================
\section{Level-prefix audit: $k=0$ check and convention bridge}
\label{sec:level-prefix-audit-virr}
% ================================================================
...
\]
carries the central charge $c$ as explicit level prefix. The
level-prefix audit is: substitute $c = 0$. Both terms vanish: the
$c/2$ central term and the $T$ insertion (with $T \equiv 0$ on the
$c=0$ triviality). The $c=0$ check passes: $r^{\Vir}(z)|_{c=0} = 0$,
as required for any trace-form $r$-matrix.
