...
\item For class~M, topologisation itself is
 conjectural
 (Conjecture~\ref{conj:e-topologisation-general}):
 the bulk $\Ethree^{\mathrm{top}}$-algebra for
 Virasoro requires constructing the $3$d gravity
 BRST complex. Without topologisation, the target
 of the closing equivalence is not defined.
\end{enumerate}
