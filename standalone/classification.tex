...
$f^2 = Q_L$ with $f = \sum_{r \geq 2} S_r\, t^{r-2}$.
...
is not a Heisenberg algebra (same~$\kappa$, different OPE structure);
...
\begin{table}[ht]
\centering
\caption{Virasoro shadow coefficients $S_r$ for $r = 2, \dotsc, 7$}
...
derivation and the convolution recursion from $f^2 = Q_L$.
