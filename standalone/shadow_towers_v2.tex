...
is proved for single-generator (uniform-weight) chirally
Koszul algebras at all genera, and unconditionally at genus~$1$
for all families, by the
...
of the Hodge bundle and $\psi_1$ is the cotangent line class.
...
We prove the result for the principal DS reduction
$\widehat{\mathfrak{sl}}_2 \to \Vir$.
...
of the BRST complex is universal; we state the general case
