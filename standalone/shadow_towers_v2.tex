...
at all arities; the mechanism applies to all principal
...
identification is proved at all arities by induction on~$r$
...
The genus-$1$ arity-$2$ shadow amplitude has Fourier
...
S_r\,r^{-s}$, which extracts arity-level constant terms, is
