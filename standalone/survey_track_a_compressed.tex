...
conditions (eight genuinely independent bidirectional equivalences
among (i)--(x), with (vi) a proved consequence of (v) and (viii) a
one-way chiral Hochschild consequence on the Koszul locus; one
conditional on perfectness; one one-directional) characterise this
locus. The Koszulness programme
...
(twelve characterisations: of which eight (among (i)--(x)) are
genuinely independent bidirectional equivalences, one ((vi)) is a
consequence of (v), one ((viii)) is a one-way chiral Hochschild
consequence on the Koszul locus, one ((xi)) is conditional on
perfectness, and one ((xii)) is one-directional).
