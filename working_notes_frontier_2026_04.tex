...
r/2 \rfloor - 1}$.  The crucial identity:
$P_{\mathrm{harm}} = m_0/\kappa$, so
...
conformal field theories (Arakawa).  Their non-Koszulness means
the bar-cobar inversion fails: the null vectors that make the
theory rational simultaneously obstruct PBW concentration.  This
is the algebraic shadow of the representation-theoretic rigidity
of rational CFTs.
