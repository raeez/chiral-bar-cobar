...
\section{What the projector repairs}
The aligned projector resolves four recurring errors at once.
\begin{enumerate}
...
\end{enumerate}
The idempotent is therefore not an editorial technicality.  It is the algebraic memory of using the same decomposition of the physical experiment in both directions.
