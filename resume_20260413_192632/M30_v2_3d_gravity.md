...
session id: 019d8837-7bfb-7390-9b1b-675a3fb773dc
--------
user
<task>
...
SCOPE: Last 200 commits. Run: git log --oneline -200 -- chapters/connections/3d_gravity.tex | head -20
CLIMAX. Verify topologization scope (affine KM only, NOT unconditional — fix line 6516). Cross-check with CFG E_3. Genus tower.
