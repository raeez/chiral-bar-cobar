...
session id: 019d8835-17e3-7db0-a022-bc955d565fbe
--------
user
<task>
...
SCOPE: Last 200 commits. Run: git log --oneline -200 -- chapters/theory/chiral_koszul_pairs.tex | head -20
Theorem A + Koszul equivs. Verify filtered-comparison lemma (AP209). Verify (vii)/(viii) scope (AP216/AP217). SC-formality (AP218). Cross-check with FG [FG04].
