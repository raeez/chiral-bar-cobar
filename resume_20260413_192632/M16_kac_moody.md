...
session id: 019d8836-122b-76e1-abef-f4edecb760b2
--------
user
<task>
...
TARGET: chapters/examples/kac_moody.tex
SCOPE: Last 200 commits. Run: git log --oneline -200 -- chapters/examples/kac_moody.tex | head -20
Affine KM: kappa=dim(g)(k+h^v)/(2h^v), r=k*Omega/z. Verify Sugawara shift. Cross-check with Kac [Kac90]. Verify critical level k=-h^v.
