...
session id: 019d883b-c0ca-7532-ad52-004dea146c6c
--------
user
<task>
...
ALTERNATIVE PROOF of Theorem D via Grothendieck-Riemann-Roch. Direct: fiber bar complex = complex of vector bundles on M-bar_g. GRR on universal curve gives ch(R*pi_*(B_fib)) = kappa*ch(E).
