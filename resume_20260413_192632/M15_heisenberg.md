...
session id: 019d8836-122a-7d80-84aa-c1650fc05f4e
--------
user
<task>
...
TARGET: chapters/examples/heisenberg.tex
SCOPE: Last 200 commits. Run: git log --oneline -200 -- chapters/examples/heisenberg.tex | head -20
Heisenberg: kappa=k, r=k/z, class G. Verify all formulas against census. Cross-check with FLM [FLM88]. Verify k=0 abelian limit.
