...
Auto-generated on 2026-04-05 from the structured claim extractor in `scripts/generate_metadata.py`.
...
| Metric | Value |
|---|---:|
| ProvedHere claims | 2627 |
| Total tagged claims | 3344 |
...
|---|---:|
| `chapters/theory/higher_genus_modular_koszul.tex` | 219 |
| `chapters/connections/arithmetic_shadows.tex` | 124 |
...
| `lem:chiral-co-contra-adjunction` | `lemma` | 895 | Adjunction |
| `prop:chiral-inj-proj-resolutions` | `proposition` | 1012 | Injective and projective resolutions |
| `prop:cdg-hom-complex` | `proposition` | 1085 | Explicit CDG Hom-complex |
| `cor:coacyclic-injective-contractible` | `corollary` | 1129 | Contractibility of coacyclic injectives |
| `lem:Phi-Psi-properties` | `lemma` | 1197 | Key properties of \texorpdfstring{$\Phi_C^{\mathrm{ch}}$}{Phi_C^ch} and \texorpdfstring{$\Psi_C^{\mathrm{ch}}$}{Psi_C^ch} |
| `thm:chiral-co-contra-correspondence` | `theorem` | 1263 | Chiral comodule-contramodule correspondence |
| `thm:positselski-chiral-proved` | `theorem` | 1403 | Positselski equivalence for the chiral bar coalgebra |
| `thm:full-derived-module-equiv-proved` | `theorem` | 1460 | Flat finite-type reduction on the completed-dual side |
| `thm:bar-cobar-inversion-qi` | `theorem` | 1566 | Bar-cobar inversion is quasi-isomorphism |
| `lem:bar-cobar-associated-graded` | `lemma` | 1735 | Associated graded |
| `thm:bar-cobar-spectral-sequence` | `theorem` | 1751 | Bar-cobar spectral sequence |
| `thm:spectral-sequence-collapse` | `theorem` | 1805 | Collapse at \texorpdfstring{$E_2$}{E2} |
| `thm:genus-graded-convergence` | `theorem` | 1828 | Genus-graded convergence |
| `prop:counit-qi` | `proposition` | 1949 | Counit is quasi-isomorphism |
| `thm:bar-cobar-inversion-functorial` | `theorem` | 1961 | Functoriality of bar-cobar inversion |
| `lem:complete-filtered-comparison` | `lemma` | 2045 | Complete filtered comparison lemma |
| `cor:completed-derived-equivalence` | `corollary` | 2146 | Completed derived equivalence |
| `thm:barr-beck-lurie-koszulness` | `theorem` | 2258 | Barr--Beck--Lurie characterization of chiral Koszulness |
| `thm:fh-concentration-koszulness` | `theorem` | 2343 | Factorization homology concentration |
| `thm:fm-boundary-acyclicity` | `theorem` | 2403 | FM boundary acyclicity |
| `prop:lagrangian-perfectness` | `proposition` | 2594 | Perfectness for the standard landscape |
| `cor:lagrangian-unconditional` | `corollary` | 2730 | Unconditional Lagrangian criterion for the standard landscape |
| `prop:bar-fh` | `proposition` | 3080 | Bar construction as factorization homology |
| `prop:cobar-fh` | `proposition` | 3158 | Cobar as factorization cohomology |
| `prop:subexponential-growth-automatic` | `proposition` | 3706 | Sub-exponential growth is automatic |
| `thm:ks-centrality` | `theorem` | 3925 | Kodaira--Spencer centrality |
| `lem:two-eta-vanishing` | `lemma` | 3968 | Two-$\eta$ vanishing |
| `prop:square-zero-insertion` | `proposition` | 4019 | Square-zero insertion differential |
| `cor:two-step-scalar-sseq` | `corollary` | 4054 | Two-step scalar spectral sequence |
| `thm:quadratic-frontier` | `theorem` | 4100 | Quadratic frontier |
| `prop:eta-hessian-transfer` | `proposition` | 4194 | Homotopy-transfer construction of the $\eta$-Hessian |
| `lem:shifted-symmetry-H` | `lemma` | 4230 | Shifted symmetry on degree-two primitives |
| `thm:admissible-scalar-rigidity` | `theorem` | 4274 | Admissible cyclic rigidity |
| `cor:ds-not-first-frontier` | `corollary` | 4309 | Drinfeld--Sokolov reductions remain one-channel in the semisimple admissible sector |
| `thm:classification-scalar-genera` | `theorem` | 4354 | Classification of scalar genera |
| `thm:platonic-hierarchy-log` | `theorem` | 4424 | Five-step hierarchy of the categorical logarithm |
| `prop:cech-two-element-strict` | `proposition` | 4941 | Two-element covers are strict |
| `thm:divisor-core-calculus-inv` | `theorem` | 5269 | Divisor-core calculus |
| `cor:divisors-classify-submodules-inv` | `corollary` | 5329 | Divisors classify submodules |
| `thm:hom-equals-gcd-inv` | `theorem` | 5361 | \texorpdfstring{$\operatorname{Hom} = \gcd$}{Hom = gcd} |
| `thm:factorization-through-common-core-inv` | `theorem` | 5383 | Universal factorization through the common core |
| `thm:minimal-intrinsic-realization-inv` | `theorem` | 5481 | Minimal intrinsic realization |
| `thm:sector-determinant-inv` | `theorem` | 5529 | Sector determinant |
| `thm:casimir-moment-reconstruction-inv` | `theorem` | 5549 | Casimir moment reconstruction |
| `thm:primary-jordan-filtration-inv` | `theorem` | 5594 | Primary Jordan filtration |
| `cor:repeated-roots-extension-data` | `corollary` | 5625 | Repeated roots encode extension data |
| `thm:common-core-exact-sequences-inv` | `theorem` | 5657 | Common-core exact sequences |
| `prop:transport-factors-inv` | `proposition` | 5685 | Transport factors through the common core |
| `prop:sl3-w3-defect-inv` | `proposition` | 5752 | Exact defect decomposition |
| `prop:sl3-w3-projectors` | `proposition` | 5774 | Explicit coprime-locus projectors |

#### `chapters/theory/bar_construction.tex` (24)

| Label | Env | Line | Title |
|---|---|---:|---|
| `thm:bar-NAP-homology` | `theorem` | 270 | Bar construction as NAP homology |
| `lem:sign-compatibility` | `lemma` | 644 | Sign compatibility |
| `thm:bar-nilpotency-complete` | `theorem` | 734 | Nilpotency of bar differential |
| `prop:pole-decomposition` | `proposition` | 916 | Pole decomposition of the bar differential |
| `cor:bar-functorial` | `corollary` | 982 | Functoriality |
| `thm:stokes-config` | `theorem` | 997 | Stokes' theorem on configuration spaces |
| `cor:residues-anticommute` | `corollary` | 1092 | Residues anticommute at corners |
| `thm:arnold-three` | `theorem` | 1134 | Arnold relations |
| `comp:deg0` | `computation` | 1177 | Degree 0 |
| `comp:deg1-general` | `computation` | 1195 | Degree 1 |
| `thm:bar-functorial-complete` | `theorem` | 1317 | Bar construction is functorial |
| `cor:bar-natural` | `corollary` | 1356 | Natural transformation property |
| `prop:model-independence` | `proposition` | 1362 | Model independence |
| `thm:bar-coalgebra` | `theorem` | 1394 | Bar coalgebra |
| `thm:coassociativity-complete` | `theorem` | 1417 | Coassociativity |
| `thm:counit-axioms` | `theorem` | 1484 | Counit axioms |
| `cor:bar-is-dgcoalg` | `corollary` | 1535 | Bar complex is DG-coalgebra |
| `thm:diff-is-coderivation` | `theorem` | 1552 | Differential is coderivation |
| `lem:orientation` | `lemma` | 1639 | Orientation convention |
| `lem:residue-properties` | `lemma` | 1665 | Residue properties |
| `thm:geometric-equals-operadic-bar` | `theorem` | 1738 | Geometric bar \texorpdfstring{$=$}{=} operadic bar |
| `thm:residue-formula` | `theorem` | 1813 | Residue formula |
| `thm:bar-uniqueness-functoriality` | `theorem` | 1885 | Uniqueness and functoriality |
| `thm:bar-chiral` | `theorem` | 1995 | Bar complex is chiral |
...
| Label | Env | Line | Title |
|---|---|---:|---|
| `lem:twisted-product-cone-counit` | `lemma` | 242 | Left twisted tensor product as mapping cone |
| `lem:twisted-product-cone-unit` | `lemma` | 269 | Right twisted tensor product as mapping cone |
| `lem:filtered-comparison` | `lemma` | 289 | Filtered comparison |
| `thm:fundamental-twisting-morphisms` | `theorem` | 317 | Fundamental theorem of chiral twisting morphisms |
| `cor:three-bijections` | `corollary` | 392 | Three bijections for chiral twisting morphisms |
| `thm:pbw-koszulness-criterion` | `theorem` | 657 | PBW criterion for chiral Koszulness |
| `thm:km-chiral-koszul` | `theorem` | 735 | Affine Kac--Moody algebras are chiral Koszul |
| `thm:virasoro-chiral-koszul` | `theorem` | 790 | Virasoro chiral Koszulness |
| `cor:bar-cohomology-koszul-dual` | `corollary` | 834 | Bar cohomology computes Koszul dual |
| `thm:bar-concentration` | `theorem` | 1014 | Bar concentration for Koszul pairs |
| `prop:ainfty-formality-implies-koszul` | `proposition` | 1122 | Formality implies chiral Koszulness |
| `thm:ainfty-koszul-characterization` | `theorem` | 1156 | Converse: formality implies chiral Koszulness |
| `conj:ext-diagonal-vanishing` | `theorem` | 1226 | Ext diagonal vanishing criterion |
| `prop:pbw-universality` | `proposition` | 1264 | PBW universality |
| `cor:universal-koszul` | `corollary` | 1290 | Universal vertex algebras are chirally Koszul |
| `thm:kac-shapovalov-koszulness` | `theorem` | 1314 | Kac--Shapovalov criterion for simple quotients |
| `prop:li-bar-poisson-differential` | `proposition` | 1493 | Poisson differential on the Li--bar $E_1$ page |
| `thm:associated-variety-koszulness` | `theorem` | 1564 | Associated-variety criterion for Koszulness |
| `prop:large-orbit-obstruction` | `proposition` | 1666 | Nilradical obstruction at degenerate admissible levels |
| `thm:koszul-equivalences-meta` | `theorem` | 1800 | Equivalences of chiral Koszulness |
| `prop:koszulness-formality-equivalence` | `proposition` | 2245 | Koszulness as formality of the convolution algebra |
| `prop:cumulant-window-inversion` | `proposition` | 2486 | Cumulant-to-window inversion |
| `thm:bar-cobar-isomorphism-main` | `theorem` | 2542 | Geometric bar--cobar duality |
| `thm:yangian-self-dual` | `theorem` | 2719 | Yangian quadratic dual |
| `prop:yangian-koszul-general` | `proposition` | 2779 | Yangian Koszulness for all simple \texorpdfstring{$\mathfrak{g}$}{g} |
| `thm:coalgebra-axioms-verified` | `theorem` | 2933 | Coalgebra structure on \texorpdfstring{$\mathcal{A}_2^!$}{A2-dual} |
| `thm:bar-computes-koszul-dual-complete` | `theorem` | 3027 | Bar computes Koszul dual, complete statement |
| `lem:completion-convergence` | `lemma` | 3115 | Completion convergence |
| `cor:circularity-free-koszul` | `corollary` | 3164 | Circularity-free Koszul duality |
| `thm:e1-chiral-koszul-duality` | `theorem` | 3723 | \texorpdfstring{$\Eone$}{E1}-chiral Koszul duality |
| `cor:e1-self-duality` | `corollary` | 3941 | \texorpdfstring{$\Eone$}{E1}--\texorpdfstring{$\Eone$}{E1} Self-Duality |
| `thm:e1-module-koszul-duality` | `theorem` | 4028 | \texorpdfstring{$\Eone$}{E1}-module category Koszul duality |
| `prop:koszul-character-identity` | `proposition` | 4157 | Koszul character identity |
| `thm:structure-exchange` | `theorem` | 4199 | Structure exchange |
| `thm:ainfty-duality-exchange` | `theorem` | 4241 | \texorpdfstring{$A_\infty$}{A-infinity} duality |
| `prop:ff-involution-uniqueness` | `proposition` | 4287 | Uniqueness of the Feigin--Frenkel involution |
| `thm:curved-koszul-pairs` | `theorem` | 4325 | Curved Koszul pairs |
| `prop:koszul-dual-tensor-product` | `proposition` | 4534 | Koszul dual of tensor products in the quadratic case |
...
| `thm:comp-genus2-cross` | `theorem` | 1187 | Cross-consistency at genus~$2$ |
...
| `thm:e1-theorem-A-modular` | `theorem` | 725 | Theorem~$\mathrm{A}^{E_1}$ at all genera: ordered bar--cobar adjunction |
| `thm:e1-theorem-B-modular` | `theorem` | 795 | Theorem~$\mathrm{B}^{E_1}$ at all genera: ordered bar--cobar inversion |
| `thm:e1-theorem-C-modular` | `theorem` | 836 | Theorem~$\mathrm{C}^{E_1}$ at all genera: ordered complementarity |
| `thm:e1-theorem-D-modular` | `theorem` | 893 | Theorem~$\mathrm{D}^{E_1}$ at all genera: formal ordered arity-$2$ shadow series |
| `thm:e1-theorem-H-modular` | `theorem` | 981 | Theorem~$\mathrm{H}^{E_1}$ at all genera: ordered Hochschild at genus~$g$ |
| `lem:bare-graph-no-thooft` | `lemma` | 1182 | Bare graphs do not determine a 't~Hooft expansion |
| `thm:cyclicity-ribbon` | `theorem` | 1203 | Cyclicity is the ribbon-enabling datum |
| `cor:operads-too-small` | `corollary` | 1245 | Operads are too small for traces |
| `thm:exact-n-chi-weighting` | `theorem` | 1267 | Exact $N^{\chi}$ weighting from traced open color |
...
| `thm:center-geometric-inevitability` | `theorem` | 1813 | Geometric inevitability of the chiral center |
| `prop:braces-from-center` | `proposition` | 2006 | Brace operations from the operadic center |
...
| `lem:AF-dual-chiral` | `lemma` | 3631 | AF duality for chiral algebras |
| `prop:key-compat-DR` | `proposition` | 3656 | Key compatibility |
| `cor:bar-is-fh` | `corollary` | 3717 | Bar complex computes factorization cohomology |
| `lem:DR-verdier-compat` | `lemma` | 3763 | De Rham and Verdier duality |
| `lem:ran-duality-AF` | `lemma` | 3802 | Ran space duality |
| `lem:bar-as-fact-hom-AF` | `lemma` | 3831 | Bar as factorization homology |
| `lem:coalgebra-verdier-AF` | `lemma` | 3855 | Coalgebra from Verdier dual |
| `lem:diagram-commutes-AF` | `lemma` | 3880 | Diagram commutes |
| `lem:higher-genus-open-stratum-qi` | `lemma` | 3912 | Open-stratum quasi-isomorphism |
| `lem:higher-genus-boundary-qi` | `lemma` | 3961 | Boundary-stratum compatibility of \texorpdfstring{$\psi_g$}{psi-g} |
| `lem:extension-across-boundary-qi` | `lemma` | 3987 | Extension across boundary |
| `thm:higher-genus-inversion` | `theorem` | 4003 | Higher genus inversion |
| `lem:e2-collapse-higher-genus` | `lemma` | 4108 | \texorpdfstring{$E_2$}{E2} collapse at higher genus |
| `prop:pants-excision` | `proposition` | 4186 | Pants decomposition as excision |
| `prop:genus-induction-excision` | `proposition` | 4234 | Genus induction is iterated excision |
| `prop:e2-collapse-formality` | `proposition` | 4323 | \texorpdfstring{$E_2$}{E2}-collapse as formality |
| `thm:ambient-complementarity-tangent` | `theorem` | 4498 | Ambient complementarity in tangent form |
| `thm:ambient-complementarity-fmp` | `theorem` | 4541 | Ambient complementarity as shifted symplectic formal moduli problem |
| `thm:shifted-cotangent-normal-form` | `theorem` | 4799 | Shifted cotangent normal form |
| `prop:legendre-duality-potentials` | `proposition` | 4848 | Legendre duality of the two potentials |
| `prop:legendre-duality-cubic` | `proposition` | 4863 | Legendre duality of cubic tensors |
| `thm:derived-critical-locus` | `theorem` | 4893 | Derived critical locus of self-dual deformations |
| `prop:fake-complementarity-criterion` | `proposition` | 4917 | Criterion for fake complementarity |
| `thm:holo-comp-bulk-reconstruction` | `theorem` | 5113 | Protected dual transform |
| `thm:holo-comp-cotangent-realization` | `theorem` | 5163 | Shifted cotangent realization |
| `cor:holo-comp-spectral-reciprocity` | `corollary` | 5190 | Spectral reciprocity and palindromicity |
| `thm:holo-comp-fourier-transport` | `theorem` | 5276 | Fourier intertwining |
| `thm:holo-comp-weyl-sewing` | `theorem` | 5320 | Weyl associativity, PBW, and linear sewing |
| `thm:holo-comp-gaussian-composition` | `theorem` | 5397 | Gaussian composition via Schur complement |
| `thm:holo-comp-metaplectic-cocycle` | `theorem` | 5480 | Metaplectic $2$-cocycle and strictification |
| `cor:holo-comp-first-nonlinear-anomaly` | `corollary` | 5549 | First nonlinear holographic anomaly |
| `thm:critical-dimension` | `theorem` | 5655 | Critical dimension |
| `prop:non-critical-liouville` | `proposition` | 5824 | Non-critical complementarity and the Liouville sector |
| `cor:complementarity-discriminant-cancellation` | `corollary` | 5869 | Arity-$4$ discriminant cancellation |
...
| `comp:w3-obs-explicit` | `computation` | 4754 | Explicit genus-$1$ value of the $W_3$ obstruction |
| `thm:obstruction-nilpotent` | `theorem` | 4775 | Nilpotence of obstruction (\texorpdfstring{$g \leq 2$}{g <= 2}) |
| `thm:obstruction-nilpotent-all-genera` | `theorem` | 4804 | Nilpotence of obstruction (all genera) |
| `cor:mumford-multiplicative` | `corollary` | 4890 | Mumford multiplicative relations for obstruction classes |
| `thm:genus-universality` | `theorem` | 4991 | Genus universality |
| `prop:multi-generator-obstruction` | `proposition` | 5248 | Multi-generator edge universality |
| `prop:f2-quartic-dependence` | `proposition` | 5288 | Genus-$2$ quartic dependence |
| `cor:anomaly-ratio` | `corollary` | 5343 | Anomaly ratio identity |
| `cor:kappa-periodicity` | `corollary` | 5359 | \texorpdfstring{$\kappa$}{kappa}-periodicity under level shift |
| `cor:kappa-additivity` | `corollary` | 5384 | Additivity of the obstruction coefficient |
| `cor:kappa-sum-wn` | `corollary` | 5402 | Obstruction complementarity for \texorpdfstring{$\mathcal{W}_N$}{W(N)} |
| `cor:critical-level-universality` | `corollary` | 5425 | Universal genus-$1$ criticality criterion; scalar-lane collapse |
| `cor:tautological-class-map` | `corollary` | 5458 | Tautological class map on the scalar lane; universal genus-$1$ class |
| `prop:bar-tautological-filtration` | `proposition` | 5575 | Bar spectral sequence and tautological filtration |
| `thm:koszul-k0` | `theorem` | 5647 | Grothendieck group of Koszul chiral algebras |
| `thm:obs-def-pairing-explicit` | `theorem` | 5677 | Obstruction-deformation pairing |
| `prop:obstruction-lifting` | `proposition` | 5775 | Scalar obstruction lifting criterion |
| `prop:grr-bridge` | `proposition` | 5842 | Grothendieck--Riemann--Roch bridge on the proved uniform-weight scalar lane |
| `lem:stable-graph-d-squared` | `lemma` | 6015 | $\partial_{\mathcal{G}}^2 = 0$ |
| `prop:loop-filtration-compatible` | `proposition` | 6077 | Filtration compatibility |
| `thm:loop-order-spectral-sequence` | `theorem` | 6115 | Loop order spectral sequence |
| `prop:extremal-pages` | `proposition` | 6157 | Extremal pages |
| `thm:curvature-self-contraction` | `theorem` | 6246 | Curvature from loop contraction |
| `cor:anomaly-trace-standard` | `corollary` | 6334 | Anomaly = trace for standard families |
| `thm:loop-order-collapse` | `theorem` | 6403 | Loop order collapse |
| `cor:loop-decomposition-bar` | `corollary` | 6437 | Loop order decomposition of bar cohomology |
| `cor:feynman-duality-qch` | `corollary` | 6478 | Duality of quantum chiral homology |
| `thm:virtual-euler-char` | `theorem` | 6535 | Graph-sum formula for the virtual Euler characteristic |
| `cor:heisenberg-euler-char` | `corollary` | 6563 | Heisenberg Euler characteristic |
| `prop:weight-system-map` | `proposition` | 6613 | Weight system map |
...
| `thm:genus-internalization` | `theorem` | 2427 | Genus internalization of modular Koszul duality |
| `thm:modular-characteristic` | `theorem` | 2538 | Modular characteristic |
| `cor:free-energy-ahat-genus` | `corollary` | 2676 | Scalar free energy as $\hat{A}$-genus |
| `thm:spectral-characteristic` | `theorem` | 2759 | Spectral characteristic theorem |
| `thm:universal-theta` | `theorem` | 2792 | Universal modular Maurer--Cartan class |
| `prop:curvature-centrality-general` | `proposition` | 2927 | Centrality of higher-genus curvature |
| `thm:mc2-bar-intrinsic` | `theorem` | 2975 | Bar-intrinsic MC2 |
| `cor:shadow-extraction` | `corollary` | 3378 | Shadow extraction |
| `prop:mc2-functoriality` | `proposition` | 3493 | Functoriality of the bar-intrinsic MC element |
| `thm:bipartite-linfty-tree` | `theorem` | 3596 | Bipartite shadow as $L_\infty$ tree-level structure |
| `thm:explicit-theta` | `theorem` | 3722 | Explicit universal MC class |
| `cor:explicit-theta-specializations` | `corollary` | 3941 | Explicit modular package for all families |
| `prop:genus-completed-mc-framework` | `proposition` | 4357 | Genus-completed MC framework |
| `prop:cyclic-ce-identification` | `proposition` | 4436 | Cyclic CE cohomology identification |
| `cor:one-dim-obstruction` | `corollary` | 4549 | One-dimensional obstruction space |
| `prop:mc2-reduction-principle` | `proposition` | 4583 | MC2 reduction principle |
| `prop:geometric-modular-operadic-mc` | `proposition` | 4615 | Geometric modular-operadic MC framework |
| `prop:tautological-line-support-criterion` | `proposition` | 4816 | Tautological-line support criterion |
| `prop:one-channel-verdier-criterion` | `proposition` | 4892 | One-channel Verdier/Koszul criterion |
| `prop:one-channel-ptvv-criterion` | `proposition` | 4957 | One-channel PTVV / anti-involution criterion |
| `prop:one-channel-chain-model-criterion` | `proposition` | 5092 | One-channel chain-model criterion |
| `prop:one-channel-seed-criterion` | `proposition` | 5189 | One-channel bar-coderivation seed criterion |
| `prop:one-channel-minimal-seed-packet-criterion` | `proposition` | 5300 | One-channel minimal seed-packet criterion |
| `prop:one-channel-visible-lowarity-packet-criterion` | `proposition` | 5437 | One-channel visible low-arity seed-packet criterion |
| `prop:one-channel-canonical-transfer-criterion` | `proposition` | 5589 | One-channel canonical transfer-package criterion |
| `prop:one-channel-transfer-law-criterion` | `proposition` | 5763 | One-channel root-string transfer-law criterion |
| `prop:one-channel-root-string-chart-criterion` | `proposition` | 5913 | One-channel root-string chart criterion |
| `prop:one-channel-intrinsic-line-detection-criterion` | `proposition` | 6107 | One-channel intrinsic line-detection criterion |
| `prop:one-channel-automorphism-rigidity-criterion` | `proposition` | 6227 | One-channel automorphism-rigidity criterion |
| `prop:one-channel-support-graph-stabilizer-criterion` | `proposition` | 6326 | One-channel support-graph stabilizer criterion |
| `prop:one-channel-incidence-orbit-criterion` | `proposition` | 6416 | One-channel incidence-matrix / orbit-count criterion |
| `prop:one-channel-visible-orbit-table-criterion` | `proposition` | 6528 | One-channel visible root-string orbit-table criterion |
| `prop:one-channel-canonical-universal-orbit-table-criterion` | `proposition` | 6600 | One-channel canonical universal orbit-table criterion |
| `prop:one-channel-universal-invariant-signature-criterion` | `proposition` | 6682 | One-channel universal invariant-signature criterion |
| `prop:one-channel-signed-seed-character-criterion` | `proposition` | 6760 | One-channel signed seed-character criterion |
| `prop:one-channel-two-sign-plus-normalization-scalar-criterion` | `proposition` | 6837 | One-channel two-sign plus normalization-scalar criterion |
| `prop:one-channel-parity-sign-plus-normalization-scalar-criterion` | `proposition` | 6913 | One-channel parity-sign plus normalization-scalar criterion |
| `prop:one-channel-parity-forcing-criterion` | `proposition` | 6988 | One-channel parity-forcing criterion |
| `prop:one-channel-normalization-criterion` | `proposition` | 7054 | One-channel normalization criterion |
| `thm:mc2-conditional-completion` | `theorem` | 7134 | MC2 completion under explicit hypotheses |
| `thm:mc2-full-resolution` | `theorem` | 7220 | MC2 comparison completion on the proved scalar lane |
| `lem:mk67-from-mc2` | `lemma` | 7273 | Bar-intrinsic MC2 identifies MK6--MK7 |
| `cor:scalar-saturation` | `corollary` | 7316 | One-channel line concentration of the minimal MC class |
| `thm:km-strictification` | `theorem` | 7387 | KM strictification of the universal class |
| `prop:w-algebra-scalar-saturation` | `proposition` | 7475 | One-channel line concentration for \texorpdfstring{$\mathcal{W}$}{W}-algebras |
| `cor:winfty-scalar-saturation` | `corollary` | 7522 | One-dimensional cyclic line persists in the \texorpdfstring{$\mathcal{W}_\infty$}{W-infinity} limit |
| `prop:ds-package-functoriality` | `proposition` | 7583 | DS functoriality of the characteristic package |
| `prop:nonprincipal-scalar-saturation` | `proposition` | 7733 | One-channel line concentration for non-principal \texorpdfstring{$\mathcal{W}$}{W}-algebras |
| `prop:saturation-equivalence` | `proposition` | 7836 | Cyclic rigidity and level-direction concentration |
| `prop:saturation-functorial` | `proposition` | 8027 | Functorial behavior of one-channel line concentration |
| `cor:effective-quadruple` | `corollary` | 8194 | Effective \texorpdfstring{$\Gamma$}{Gamma}-quadruple for the standard landscape |
| `thm:cyclic-rigidity-generic` | `theorem` | 8285 | Cyclic rigidity at generic level |
| `thm:algebraic-family-rigidity` | `theorem` | 8454 | Algebraic-family rigidity |
| `cor:saturation-algebraic-families` | `corollary` | 8566 | Level-direction concentration at all non-critical levels for algebraic families |
| `thm:conformal-bootstrap-rigidity` | `theorem` | 8635 | $L_0$-bootstrap rigidity |
| `cor:one-channel-no-lie` | `corollary` | 8742 | One-channel criterion without Lie symmetry |
| `thm:tautological-line-support` | `theorem` | 9000 | Tautological line support from genus universality |
| `cor:mc2-single-hypothesis` | `corollary` | 9112 | MC2 comparison gauntlet collapses on the proved scalar lane |
| `thm:convolution-dg-lie-structure` | `theorem` | 9302 | dg~Lie structure from the modular operad |
| `thm:modular-quantum-linfty` | `theorem` | 9544 | Full homotopy upgrade: quantum $L_\infty$ structure |
| `thm:modular-homotopy-convolution` | `theorem` | 9994 | Modular homotopy convolution |
| `prop:modular-homotopy-type-structure` | `proposition` | 10078 | Structure of the modular homotopy type |
| `cor:strictification-comparison` | `corollary` | 10125 | Strictification comparison |
| `cor:vol1-theta-log-fm-twisting-data` | `corollary` | 10501 | $\Theta_\cA$ as universal modular twisting morphism |
| `prop:vol1-first-two-weights-log-fm` | `proposition` | 10755 | First two weights |
| `comp:vol1-low-genus-log-fm-chart` | `computation` | 10830 | Low-genus amplitudes |
| `lem:shadow-bracket-well-defined` | `lemma` | 11442 | Well-definedness of the descended bracket |
| `prop:shadow-algebra-linfty` | `proposition` | 11464 | Transferred $L_\infty$ structure on the shadow algebra |
...
| `thm:logfm-modular-cocomposition` | `theorem` | 12249 | Log-FM modular cocomposition |
| `thm:stable-graph-pronilpotent-completion` | `theorem` | 12291 | Stable-graph pronilpotent completion |
| `thm:finite-rank-spectral-reduction` | `theorem` | 12342 | Finite-rank spectral reduction |
| `thm:primitive-to-global-reconstruction` | `theorem` | 12407 | Primitive-to-global reconstruction |
| `prop:primitive-shell-equations` | `proposition` | 12542 | Primitive shell equations |
| `prop:branch-master-equation` | `proposition` | 12680 | Branch quantum master equation |
| `cor:metaplectic-square-root` | `corollary` | 12733 | Determinantal half-density |
| `thm:primitive-flat-descent` | `theorem` | 12924 | Descent to the flat modular connection |
| `thm:conformal-block-reconstruction` | `theorem` | 13003 | Scalar free-energy and determinant reconstruction from the primitive kernel on the proved uniform-weight scalar lane |
| `thm:deformation-quantization-ope` | `theorem` | 13098 | Genus expansion from the OPE |
| `thm:ran-coherent-bar-cobar` | `theorem` | 13299 | Ran-coherent bar-cobar equivalence |
| `thm:shadow-channel-decomposition` | `theorem` | 13359 | Shadow channel decomposition |
| `cor:shadow-cauchy-schwarz` | `corollary` | 13439 | Shadow Cauchy--Schwarz inequality |
| `prop:critical-locus-complementarity` | `proposition` | 13491 | Critical-locus form of complementarity |
| `thm:theta-direct-derivation` | `theorem` | 13617 | Direct derivation on the proved scalar lane |
...
| `thm:shadow-archetype-classification` | `theorem` | 15214 | Shadow archetype classification |
| `cor:shadow-depth-koszul-invariance` | `corollary` | 15411 | Shadow depth under Koszul duality |
| `thm:riccati-algebraicity` | `theorem` | 15484 | Riccati algebraicity: the shadow generating function is algebraic of degree~$2$ |
| `prop:hankel-extraction` | `proposition` | 15617 | Hankel extraction of the quartic contact invariant |
| `cor:signed-shadow-measure` | `corollary` | 15768 | Universal signed measure |
| `thm:shadow-epstein-zeta` | `theorem` | 15850 | The Epstein zeta function of the shadow metric |
| `prop:pole-purity` | `proposition` | 16188 | Pole purity |
| `prop:intrinsic-quartic` | `proposition` | 16206 | Intrinsic quartic principle |
| `thm:single-line-dichotomy` | `theorem` | 16241 | Single-line dichotomy |
| `thm:shadow-connection` | `theorem` | 16378 | Shadow connection |
| `cor:discriminant-atlas` | `corollary` | 16549 | The discriminant atlas |
| `thm:shadow-separation` | `theorem` | 16752 | Shadow separation and completeness |
| `thm:propagator-variance` | `proposition` | 16857 | Propagator variance inequality |
| `prop:t-line-autonomy` | `proposition` | 16967 | T-line autonomy |
| `prop:interchannel-coupling` | `proposition` | 17024 | Inter-channel coupling on sublines |
| `thm:shadow-radius` | `theorem` | 17169 | Shadow growth rate: structure and asymptotics |
| `cor:virasoro-shadow-radius` | `corollary` | 17275 | Virasoro shadow growth rate |
| `prop:critical-cubic-convergence` | `proposition` | 17467 | Critical cubic convergence threshold |
| `prop:virasoro-bottleneck` | `proposition` | 17556 | Virasoro bottleneck |
| `thm:koszul-exchange-regimes` | `theorem` | 17783 | Koszul exchange of shadow regimes |
| `prop:koszul-conductor-wn` | `proposition` | 17860 | Koszul conductor of \texorpdfstring{$\cW_N$}{WN} |
| `prop:propagator-universality` | `proposition` | 17918 | Propagator universality |
| `thm:hamilton-jacobi-shadow` | `theorem` | 18261 | Hamilton--Jacobi master equation on deformation spaces |
| `thm:shadow-finite-determination` | `theorem` | 18470 | Shadow finite determination |
| `cor:w3-reconstruction` | `corollary` | 18557 | $\cW_3$: seven parameters determine the full 2D tower |
| `thm:shadow-tautological-ring` | `theorem` | 18763 | Shadow classes in the tautological ring |
| `cor:analytic-shadow-realization` | `corollary` | 18906 | Analytic shadow realization |
| `thm:shadow-cohft` | `theorem` | 18992 | Shadow cohomological field theory |
| `thm:shadow-tautological-relations` | `theorem` | 19263 | Shadow tautological decomposition and conditional vanishing |
| `thm:mc-tautological-descent` | `theorem` | 19354 | MC descent to tautological relations |
| `prop:self-loop-vanishing` | `proposition` | 19829 | Self-loop parity vanishing |
| `cor:shadow-visibility-genus` | `corollary` | 19865 | Shadow visibility genus |
| `prop:ell2-genus1-mc` | `proposition` | 19984 | Genus-$1$ two-point function from MC |
| `prop:wdvv-from-mc` | `proposition` | 20016 | WDVV from MC at genus~$0$ |
| `prop:mumford-from-mc` | `proposition` | 20049 | Mumford relation from MC at arity~$2$ |
| `thm:planted-forest-structure` | `theorem` | 20081 | Planted-forest structure theorem |
| `thm:cohft-reconstruction` | `theorem` | 20202 | Reconstruction from the MC tangent complex |
| `prop:dressed-propagator-resolution` | `proposition` | 20294 | Dressed propagator coefficient and symmetry |
| `cor:topological-recursion-mc-shadow` | `corollary` | 20433 | Topological recursion as MC shadow |
| `thm:pixton-mc-genus2` | `theorem` | 20613 | Pixton--MC bridge at genus~$2$ |
| `thm:pixton-mc-genus3` | `theorem` | 20676 | Pixton--MC bridge at genus~$3$ |
| `prop:mumford-from-mc-explicit` | `proposition` | 20750 | Mumford formula from MC |
| `thm:spectral-curve-from-shadow` | `theorem` | 20804 | Spectral curve from shadow metric |
| `thm:tr-shadow-free-energies` | `theorem` | 20838 | TR--shadow free energy identification |
| `thm:genus4-stable-graph-census` | `theorem` | 20877 | Genus-$4$ stable graph census |
| `thm:genus4-free-energy` | `theorem` | 20906 | Genus-$4$ free energy |
...
| `thm:shadow-double-convergence` | `theorem` | 21134 | Double convergence of the shadow partition function |
| `prop:shadow-genus-closed-form` | `proposition` | 21250 | Closed form and meromorphic continuation |
| `thm:shadow-borel-genus` | `theorem` | 21329 | Borel transform of the genus series |
| `prop:shadow-stokes-multipliers` | `proposition` | 21390 | Stokes multipliers of the genus expansion |
| `thm:shadow-transseries` | `theorem` | 21418 | Trans-series and instanton sectors |
| `prop:shadow-schwarzian` | `proposition` | 21541 | Spectral Schr\"odinger potential |
| `cor:shadow-schrodinger-singularities` | `corollary` | 21578 | Singularity classification |
| `prop:shadow-wkb` | `proposition` | 21650 | WKB expansion |
| `prop:shadow-voros-classical` | `proposition` | 21720 | Classical Voros period |
| `prop:shadow-gue-bridge` | `proposition` | 21763 | Shadow--GUE bridge |
| `prop:shadow-genus-constraints` | `proposition` | 21833 | Shadow genus constraints |
| `prop:winfinity-not-cyclically-admissible` | `proposition` | 21990 | $\mathcal{W}_{1+\infty}$ is not cyclically admissible |
| `prop:finite-jet-rigidity` | `proposition` | 22071 | Finite-jet rigidity |
| `prop:polynomial-level-dependence` | `proposition` | 22094 | Polynomial level dependence |
| `prop:gaussian-collapse-abelian` | `proposition` | 22130 | Gaussian collapse for abelian input |
| `thm:cubic-gauge-triviality` | `theorem` | 22214 | Cubic gauge triviality and canonical quartic class |
...
| `conj:tropical-koszulness` | `theorem` | 22871 | Tropical Koszulness |
| `cor:tropical-cohen-macaulay` | `corollary` | 22962 | Tropical Koszulness as the Cohen--Macaulay property |
| `prop:genus0-curve-independence` | `proposition` | 23009 | Genus-$0$ curve-independence |
...
| `prop:ordered-log-fm-construction` | `proposition` | 24686 | Ordered log-FM construction |
| `cor:e1-ambient-d-squared-zero` | `corollary` | 24764 | $E_1$ ambient $D^2 = 0$ |
| `prop:coefficient-algebras-well-defined` | `proposition` | 24809 | Square-zero property of the ambient differential |
| `thm:convolution-d-squared-zero` | `theorem` | 24842 | Square-zero: convolution level |
| `conj:differential-square-zero` | `theorem` | 24856 | Square-zero: ambient level |
| `thm:inductive-genus-determination` | `theorem` | 25043 | Inductive genus determination |
| `cor:genus-base-cases` | `corollary` | 25111 | Base cases |
| `rem:genus2-shell-activation` | `theorem` | 25148 | Genus-$2$ shell activation as depth diagnostic |
| `comp:vol1-genus-three-stable-graph-census` | `computation` | 25339 | Genus-$3$ stable graph census |
| `prop:2d-convergence` | `proposition` | 25618 | Two-dimensional convergence |
| `thm:analytic-algebraic-comparison` | `theorem` | 25674 | Analytic = algebraic |
| `thm:determinantal-branch-formula` | `theorem` | 25809 | Determinantal branch formula |
| `thm:transport-lifted-covers` | `theorem` | 25845 | Transport of lifted covers |
| `thm:common-sheet-law` | `theorem` | 25876 | Common-sheet multiplication law |
| `thm:spectral-hierarchy` | `theorem` | 25940 | Hierarchy of spectral invariants |
| `cor:frontier-is-cubic` | `corollary` | 25976 | The frontier is cubic |
...
| Label | Env | Line | Title |
|---|---|---:|---|
| `thm:central-charge-complementarity` | `theorem` | 1342 | Central charge complementarity |
| `thm:ahat-universality-intro` | `theorem` | 1716 | $\hat{A}$-genus universality |
| `prop:modular-homotopy-classification` | `proposition` | 3071 | Classification by modular homotopy type |
| `prop:shadow-massey-identification` | `proposition` | 3141 | Genus-$0$ shadow obstructions $=$ $A_\infty$ Massey products |
| `prop:chirAss-self-dual` | `proposition` | 4597 | \texorpdfstring{$\chirAss$}{Ass-ch} self-duality |
...
| `thm:opposite` | `theorem` | 782 | Opposite-duality for ordered bar coalgebras |
| `cor:anti` | `corollary` | 823 | Anti-involutions survive duality |
| `lem:closure` | `lemma` | 837 | Closure of admissibility under opposite and enveloping constructions |
| `cor:enveloping` | `corollary` | 848 | Enveloping duality |
| `lem:Kbi-dg` | `lemma` | 911 | — |
| `prop:one-defect` | `proposition` | 938 | — |
| `thm:tangent=K` | `theorem` | 960 | Tangent identification |
| `cor:infdual` | `corollary` | 997 | Infinitesimal dual coalgebra |
| `prop:infann` | `proposition` | 1020 | Infinitesimal annular variation |
| `thm:bimod-bicomod` | `theorem` | 1072 | PBW-complete bimodule/bicomodule equivalence |
| `thm:diagonal` | `theorem` | 1105 | Diagonal correspondence |
| `cor:unit` | `corollary` | 1153 | The diagonal is the unit for composition |
| `cor:tensor-cotensor` | `corollary` | 1171 | Tensor--cotensor gluing |
| `thm:HH-coHH-homology` | `theorem` | 1200 | Associative chiral Hochschild/coHochschild homology |
| `thm:HH-coHH-cohomology` | `theorem` | 1232 | Associative chiral Hochschild/coHochschild cohomology |
| `cor:annulus` | `corollary` | 1258 | The annulus as self-cotrace |
| `cor:cap` | `corollary` | 1278 | Cap action |
| `thm:pair-of-pants` | `theorem` | 1333 | Ordered pair-of-pants algebra |
| `thm:ordered-open` | `theorem` | 1371 | Ordered genus-zero open trace formalism |
| `thm:CY` | `theorem` | 1425 | Shifted ordered Frobenius structure |
| `cor:cardy` | `corollary` | 1474 | Cardy operator on the coalgebra side |
| `thm:master` | `theorem` | 1498 | Master theorem |
| `prop:ordered-real-config-topology` | `proposition` | 1622 | Topology of ordered real configurations |
| `thm:heisenberg-ordered-bar` | `theorem` | 2030 | The Heisenberg ordered bar complex |
| `thm:heisenberg-rmatrix` | `theorem` | 2128 | Collision residue and $R$-matrix |
| `thm:heisenberg-yangian` | `theorem` | 2199 | Open-colour Koszul dual: the abelian Yangian |
| `thm:heisenberg-formality` | `theorem` | 2258 | Formality: class~G, shadow depth~$2$ |
| `thm:drinfeld-yangian-sl2` | `theorem` | 2396 | Drinfeld presentation of $Y_\hbar(\mathfrak{sl}_2)$ |
| `prop:gauss-decomposition-sl2` | `proposition` | 2486 | Gauss decomposition |
| `thm:twisted-coproduct-sl2` | `theorem` | 2522 | Twisted coproduct |
| `thm:PBW-yangian-sl2` | `theorem` | 2574 | PBW theorem for $Y_\hbar(\mathfrak{sl}_2)$ |
| `thm:classical-limit-sl2` | `theorem` | 2615 | Classical limit |
| `thm:central-extension-invisible` | `theorem` | 2701 | Central extension is invisible to the open-colour double bar |
| `thm:two-colour-double-kd` | `theorem` | 2767 | Two-colour double Koszul duality is involutive |
| `cor:two-colours-non-redundant` | `corollary` | 2793 | Non-redundancy of the two colours |
| `prop:vir-collision-residue` | `proposition` | 2859 | Virasoro collision residue |
| `prop:vir-CYBE-ordered` | `proposition` | 2889 | Virasoro CYBE |
| `thm:grav-yangian-collapse` | `theorem` | 2916 | Gravitational Yangian collapse |
| `thm:vir-non-formality` | `theorem` | 2983 | Virasoro non-formality |
| `prop:grav-yangian-curvature` | `proposition` | 3029 | Gravitational Yangian curvature |
| `cor:gauge-gravity-dichotomy-ordered` | `corollary` | 3064 | Gauge-gravity complexity dichotomy |
| `thm:km-yangian` | `theorem` | 3182 | Universal Kac--Moody Yangian theorem |
| `thm:root-space-one-dim-v1` | `theorem` | 3501 | Root-space one-dimensionality |
| `lem:jacobi-collapse-v1` | `lemma` | 3550 | Jacobi collapse for star sectors |
| `thm:dynkin-beta-integral` | `theorem` | 3616 | Dynkin coefficient via the beta integral |
| `thm:complete-strictification-v1` | `theorem` | 3697 | Complete strictification for all simple Lie algebras |
| `thm:sl3-triangle-coefficient` | `theorem` | 3927 | Triangle coefficient for $\mathfrak{sl}_3$ |
| `prop:sl3-serre` | `proposition` | 4011 | Serre relations from root-space vanishing |
| `thm:sl3-rtt` | `theorem` | 4062 | RTT presentation for $Y_\hbar(\mathfrak{sl}_3)$ from the ordered bar complex |
| `thm:sl3-strictification` | `theorem` | 4134 | Vanishing of the spectral Drinfeld class for $\mathfrak{sl}_3$ |
| `thm:sl4-quadrilateral` | `theorem` | 4207 | Quadrilateral coefficient for $\mathfrak{sl}_4$ |
| `thm:B2-ordered-bar` | `theorem` | 4294 | Ordered bar complexes and Yangian $R$-matrices for rank-$2$ non-$A$ types |
| `thm:annular-bar-differential` | `theorem` | 4502 | Annular bar differential |
| `thm:annular-HH` | `theorem` | 4595 | Annular bar complex computes chiral Hochschild homology |
| `thm:curvature-braiding-dichotomy` | `theorem` | 4695 | Curvature--braiding dichotomy at genus~$1$ |
| `thm:b-cycle-quantum-group` | `theorem` | 5017 | Quantum group from $B$-cycle monodromy |
| `thm:drinfeld-kohno` | `theorem` | 5139 | Drinfeld--Kohno; {} for the affine lineage |
| `thm:yangian-quantum-group` | `theorem` | 5218 | Yangian--quantum group deformation for the affine lineage |
| `cor:sl2-root-of-unity` | `corollary` | 5289 | $U_q(\mathfrak{sl}_2)$ at roots of unity from affine $\mathfrak{sl}_2$ |
| `thm:jones-genus1` | `theorem` | 5330 | Jones polynomial from genus-$1$ bar-complex monodromy |
| `thm:ordered-depth-spectrum` | `theorem` | 5493 | Ordered depth spectrum |
| `thm:ordered-AOS` | `theorem` | 5545 | Ordered AOS reduction |
| `prop:averaging-surplus` | `proposition` | 5615 | Averaging and surplus |
| `thm:elliptic-spectral-dichotomy` | `theorem` | 5753 | Elliptic spectral dichotomy --- genus-$1$ specialisation |
| `thm:bg-ordered-bar` | `theorem` | 5964 | Free-field ordered bar complexes |
| `thm:wakimoto-ordered-bar` | `theorem` | 6036 | Wakimoto bar complex descent |
| `thm:lattice-symmetric-ordered-bar` | `theorem` | 6139 | Ordered bar complex with symmetric cocycle |
| `thm:lattice-nonsymmetric-ordered-bar` | `theorem` | 6205 | Ordered bar complex with non-symmetric cocycle |
| `thm:lattice-ordered-koszul-dual` | `theorem` | 6265 | Ordered Koszul dual of lattice algebras |
| `comp:sl2-eval` | `computation` | 6419 | $\mathfrak{sl}_2$ evaluation module |
| `thm:sl2-R-matrix` | `theorem` | 6463 | $R$-matrix on $V_a\otimes V_b$ for $\mathfrak{sl}_2$ |
| `cor:sl2-clebsch-gordan` | `corollary` | 6511 | Clebsch--Gordan decomposition and non-semisimplicity |
| `comp:sl3-eval-fundamental` | `computation` | 6553 | $\mathfrak{sl}_3$ fundamental evaluation module |
| `comp:sl3-eval-adjoint` | `computation` | 6588 | $\mathfrak{sl}_3$ adjoint evaluation module |
| `prop:eval-drinfeld` | `proposition` | 6640 | Evaluation modules as single-root Drinfeld polynomials |
| `thm:line-category` | `theorem` | 6707 | Line category as Yangian modules |
| `thm:eval-braiding` | `theorem` | 6768 | Braiding from the $R$-matrix |
| `prop:r-matrix-eigenvalue` | `proposition` | 6875 | Eigenvalue decomposition |
| `thm:yang-r-sl2` | `theorem` | 6891 | Yang $R$-matrix for $\mathfrak{sl}_N$ |
| `thm:e1-ordered-bar-landscape` | `theorem` | 6989 | $\mathsf{E}_1$ ordered bar landscape |
| `thm:w3-ordered-bar` | `theorem` | 7525 | Ordered bar complex of $\mathcal{W}_3$ via DS transport |
| `thm:class-m-ds-transport` | `theorem` | 7674 | Class~M persistence under DS transport |
| `thm:unshifted-identification` | `theorem` | 7904 | Unshifted identification |
| `thm:factorisation-identification` | `theorem` | 7948 | Factorisation identification on the Koszul locus |
| `prop:r-matrix-stable-envelope` | `proposition` | 7993 | $R$-matrix comparison |
...
| `prop:betagamma-obstruction-coefficient` | `proposition` | 1104 | Obstruction coefficient |
| `prop:betagamma-E1-page` | `proposition` | 1245 | \texorpdfstring{$E_1$}{E1} page |
| `prop:betagamma-ss-collapse` | `proposition` | 1329 | Spectral sequence collapse |
...
| `prop:betagamma-ell3-vanishing` | `proposition` | 2295 | $\ell_3^{\mathrm{tr}}(\eta,\eta,\eta) = 0$ |
| `cor:betagamma-mu-vanishing` | `corollary` | 2405 | Vanishing of the quartic contact invariant |
| `thm:betagamma-rank-one-rigidity` | `theorem` | 2447 | Rank-one abelian rigidity |
| `cor:betagamma-pure-contact-boundary` | `corollary` | 2477 | Pure contact boundary law |
| `prop:betagamma-translation-coproduct` | `proposition` | 2640 | Translation and coproduct |
...
| `thm:heisenberg-level-inversion` | `theorem` | 3781 | Heisenberg level inversion: curved duality |
| `thm:fermion-genus1-partition` | `theorem` | 3930 | Free fermion genus-1 partition functions |
| `thm:fermion-F1-shadow` | `theorem` | 4062 | Free fermion genus-1 free energy |
| `thm:fermion-genus-g` | `theorem` | 4139 | Free fermion at genus $g$ |
| `thm:virasoro-moduli` | `theorem` | 4484 | Critical Virasoro descent at $c = 26$ |
| `prop:moduli-degeneration` | `proposition` | 4582 | Boundary-residue differential on moduli forms |
| `thm:algebraic-string-dictionary` | `theorem` | 4711 | Algebraic bar/BRST genus dictionary |
| `thm:genus-g-chiral-homology` | `theorem` | 4818 | Genus-\texorpdfstring{$g$}{g} chiral homology from bar complex |
| `thm:genus-deformation-exact` | `theorem` | 4929 | Genus expansion as curved deformation |
| `thm:bar-string-integrand` | `theorem` | 5009 | Bar classes on moduli and boundary factorization |
| `thm:modular-invariance` | `theorem` | 5137 | Modular invariance of bar complex |
| `thm:modular-anomaly-km-w` | `theorem` | 5174 | Modular anomaly for affine Kac--Moody algebras |
| `thm:wakimoto-bar` | `theorem` | 5294 | Wakimoto bar complex |
| `prop:wakimoto-graph` | `proposition` | 5307 | Graphical interpretation |
| `thm:w-algebra-ainfty` | `theorem` | 5312 | \texorpdfstring{$A_\infty$}{A-infinity} structure on \texorpdfstring{$\mathcal{W}$}{W}-algebras |
| `thm:w-integrability` | `theorem` | 5339 | Higher \texorpdfstring{$A_\infty$}{A-infinity} corrections in quantum \texorpdfstring{$\mathcal{W}$}{W}-algebras |
| `comp:heisenberg-five-theorems` | `computation` | 5390 | Five projections of $\Theta_{\cH_k}$ |
| `comp:fermion-five-theorems` | `computation` | 5433 | Five projections of $\Theta_{\mathcal{F}}$ |
| `comp:betagamma-five-theorems` | `computation` | 5475 | Five projections of $\Theta_{\beta\gamma}$ |
| `comp:bc-five-theorems` | `computation` | 5530 | Five projections of $\Theta_{bc}$ |
| `comp:lattice-five-theorems` | `computation` | 5577 | Five projections of $\Theta_{V_\Lambda}$ |
| `thm:filtered-bar-complex` | `theorem` | 5658 | Filtered bar complex |
...
| `thm:sl2-all-genera` | `theorem` | 470 | \texorpdfstring{$\widehat{\mathfrak{sl}}_2$}{sl-hat_2} free energy at all genera |
| `prop:sl2-complementarity-all-genera` | `proposition` | 619 | \texorpdfstring{$\widehat{\mathfrak{sl}}_2$}{sl2-hat} complementarity |
| `prop:bivariate-gf` | `proposition` | 760 | Bivariate generating function |
| `prop:km-genus2-propagator` | `proposition` | 802 | Non-abelian genus-2 propagator |
| `thm:sl2-genus2-bar-differential` | `theorem` | 856 | Genus-2 bar differential for \texorpdfstring{$\widehat{\mathfrak{sl}}_2$}{sl-hat_2} |
| `thm:sl2-genus2-curvature` | `theorem` | 967 | Genus-2 curvature for \texorpdfstring{$\widehat{\mathfrak{sl}}_2$}{sl-hat_2} |
| `prop:sl2-genus2-relation` | `proposition` | 1077 | Genus-2 relation for \texorpdfstring{$\widehat{\mathfrak{sl}}_2$}{sl-hat_2} |
| `thm:virasoro-genus2-bar` | `theorem` | 1217 | Genus-2 bar differential for \texorpdfstring{$\mathrm{Vir}_c$}{Vir_c} |
| `cor:virasoro-genus2-curvature` | `corollary` | 1284 | Genus-2 Virasoro curvature |
| `comp:genus2-complementarity-table` | `computation` | 1440 | Genus-2 complementarity dimensions |
| `prop:genus-expansion-convergence` | `proposition` | 1572 | Convergence of the genus expansion |
| `thm:bernoulli-universality` | `theorem` | 1602 | Bernoulli universality |
| `prop:complementarity-genus-series` | `proposition` | 1620 | Central charge genus series |
| `thm:universal-generating-function` | `theorem` | 1655 | Universal generating function |
| `prop:bar-verlinde-asymptotics` | `proposition` | 1729 | Bar free energy and Verlinde asymptotics |
| `thm:vir-all-genera` | `theorem` | 1857 | Virasoro free energy |
| `prop:vir-complementarity` | `proposition` | 1899 | Virasoro complementarity |
| `prop:sl3-complementarity-all-genera` | `proposition` | 1978 | \texorpdfstring{$\widehat{\mathfrak{sl}}_3$}{sl3-hat} complementarity |
| `thm:fermion-all-genera` | `theorem` | 2127 | Free fermion free energy at all genera |
| `prop:fermion-complementarity` | `proposition` | 2192 | \texorpdfstring{$bc$}{bc}--\texorpdfstring{$\beta\gamma$}{beta-gamma} complementarity |
| `prop:universal-fe-ratios` | `proposition` | 2437 | Universal free-energy ratios |
| `prop:complementarity-classification` | `proposition` | 2767 | Classification of complementarity types |
| `thm:complementarity-root-datum` | `theorem` | 2821 | Complementarity sum as root datum invariant |
| `prop:universal-growth-rate` | `proposition` | 3116 | Universal growth rate |
| `prop:multiplicative-genus` | `proposition` | 3217 | Koszul duality determines a multiplicative genus |
| `cor:complementary-genera` | `corollary` | 3233 | Koszul complementarity of genera |
| `prop:koszul-genus-involution` | `proposition` | 3258 | Koszul duality as genus involution |
| `thm:genus-determines-pair` | `theorem` | 3290 | Genus duality determines the Koszul pair |
| `prop:loop-expansion-knots` | `proposition` | 3385 | Loop expansion interpretation |
| `thm:boundary-characters-bar-hilbert` | `theorem` | 3556 | Boundary characters as bar Hilbert series |
...
| `thm:w-universal-gravitational-cubic` | `theorem` | 3534 | Universal gravitational cubic tensor |
| `thm:w-virasoro-mixed-shadow` | `theorem` | 3589 | Virasoro mixed shadow |
| `thm:w-virasoro-quartic-explicit` | `theorem` | 3626 | Explicit Virasoro quartic contact coefficient |
| `prop:w-virasoro-lee-yang-degeneration` | `proposition` | 3713 | Lee--Yang degeneration of the quartic shadow |
| `thm:w-resonance-reorganization` | `theorem` | 3783 | Resonance reorganization |
| `cor:w-complementarity-potential-poles` | `corollary` | 3920 | Pole structure of the complementarity potential |
| `prop:virasoro-primitive-kernel` | `proposition` | 3975 | Virasoro primitive kernel |
| `prop:virasoro-primitive-shell` | `proposition` | 4027 | Virasoro primitive shell equations |
| `thm:w-w3-mixed-shadow` | `theorem` | 4184 | $\mathcal{W}_3$ mixed-shadow normal form |
| `prop:w3-two-dim-hessian-cubic` | `proposition` | 4246 | Two-dimensional Hessian and universal cubic |
| `thm:w3-quartic-channel-decomposition` | `theorem` | 4274 | $\mathcal{W}_3$ quartic channel decomposition |
| `prop:w3-denominator-filtration` | `proposition` | 4335 | Denominator filtration by $W$-charge |
| `thm:w3-quintic-nonvanishing` | `theorem` | 4363 | $\mathcal{W}_3$ quintic nonvanishing |
| `prop:ds-shadow-cascade` | `proposition` | 4408 | DS shadow cascade for $V_k(\mathfrak{sl}_N) \to \mathcal{W}_N$ |
| `prop:rho-decreasing-with-N` | `proposition` | 4465 | Shadow growth rate decreases with $N$ |
| `prop:w-w3-weight6-resonance` | `proposition` | 4546 | Weight-$6$ Gram determinant and visible resonance divisor |
| `thm:w-principal-wn-hessian-cubic` | `theorem` | 4617 | Diagonal Hessian and universal cubic for principal $\mathcal{W}_N$ |
| `thm:w-principal-wn-contact-nonvanishing` | `theorem` | 4643 | Nonvanishing of contact quartics for $\mathcal{W}_N$ |
| `thm:w-archetype-trichotomy` | `theorem` | 4732 | Archetype trichotomy |
| `thm:w-virasoro-quintic-forced` | `theorem` | 4799 | Virasoro quintic forced |
...
| `thm:w-finite-arity-polynomial-pva` | `theorem` | 5906 | Finite-arity theorem for polynomial PVAs |
| `cor:w-semistrictity-classical-w3` | `corollary` | 5944 | Semistrictity of the classical $\mathcal{W}_3$ bulk |
| `prop:w-semistrict-tree-identity` | `proposition` | 5986 | Tree identity for semistrict cyclic theories |
| `prop:w-semistrict-stable-graph` | `proposition` | 6013 | Stable-graph identity for semistrict modular theories |
| `prop:w-semistrict-admissibility` | `proposition` | 6089 | Admissibility of the weight filtration |
| `thm:w-cubic-weight-recursion` | `theorem` | 6114 | Cubic weight recursion |
| `cor:w-cubic-obstruction-classes` | `corollary` | 6148 | Cubic obstruction classes |
| `prop:w-boundary-model-well-defined` | `proposition` | 6186 | Well-definedness |
| `thm:w-semistrict-package` | `theorem` | 6206 | The $\mathcal{W}_3$ semistrict modular higher-spin package |
| `prop:miura-arity-sharp` | `proposition` | 6290 | Miura arity bound is sharp |
| `thm:w-pbw-slodowy-collapse` | `theorem` | 6439 | PBW--Slodowy collapse |
| `cor:w-principal-completed-koszul` | `corollary` | 6500 | Principal $W$-algebras are completed Koszul |
| `thm:w-canonical-arity-detection` | `theorem` | 6608 | Canonical arity detection |
| `thm:w-bp-strict` | `theorem` | 6634 | Bershadsky--Polyakov is strict |
| `thm:w-w4-cubic` | `theorem` | 6684 | $\mathcal{W}_4^{(2)}$ has canonical arity~$3$ |
| `thm:w-full-raw-coefficient-packet` | `theorem` | 6743 | Full raw coefficient packet |
| `thm:w-subregular-appell` | `theorem` | 6802 | Subregular Appell formula |
| `thm:w-unbounded-canonical-arity` | `theorem` | 6840 | Unbounded canonical arity |
| `cor:w-subregular-arity-staircase` | `corollary` | 6869 | The subregular arity staircase |
| `thm:w-subregular-classification` | `theorem` | 6911 | Subregular classification |
| `prop:sl3-nilpotent-shadow-data` | `proposition` | 6995 | $\mathfrak{sl}_3$ nilpotent orbits: shadow data |
| `prop:sl4-hook-shadow-data` | `proposition` | 7060 | $\mathfrak{sl}_4$ hook-type shadow data |
| `thm:ds-shadow-functor-arity2` | `theorem` | 7101 | DS shadow functor at arity~$2$ |
...
| `thm:shadow-mzv-dictionary` | `theorem` | 2452 | Shadow--MZV dictionary |
| `thm:drinfeld-associator-bar-transport` | `theorem` | 2531 | Drinfeld associator as bar transport |
| `thm:partition-modular-classification` | `theorem` | 2634 | Partition function modular classification |
| `prop:quasi-modular-propagator` | `proposition` | 2694 | Quasi-modular content from the genus-$1$ propagator |
| `prop:hecke-eigenvalue-extraction` | `proposition` | 2769 | Hecke eigenvalues from partition data |
| `thm:spectral-curve` | `theorem` | 2816 | Algebraic shadow generating function |
...
| `sec:shadow-moduli-resolution` | `theorem` | 3437 | Shadow-moduli resolution |
| `thm:universality-of-G` | `theorem` | 3527 | Universality of $G$ |
| `prop:mc-bracket-determines-atoms` | `proposition` | 3595 | MC bracket determines spectral atoms |
| `rem:mc-ramanujan-bridge` | `remark` | 3645 | The bridge to the Ramanujan bound |
| `prop:heisenberg-koszul-epstein` | `proposition` | 3896 | Degenerate case: Heisenberg |
| `comp:virasoro-c1-koszul-epstein` | `computation` | 3948 | Virasoro at $c = 1$: numerical Koszul--Epstein value |
| `comp:fe-minimal-models` | `computation` | 3973 | Functional equation for all unitary minimal models |
| `thm:spectral-continuation-bridge` | `theorem` | 4053 | Hecke-equivariant MC element |
| `thm:schur-complement-quartic` | `theorem` | 4192 | — |
| `prop:virasoro-quartic-determinant` | `proposition` | 4251 | — |
| `prop:on-off-line-distinction` | `proposition` | 4328 | — |
| `prop:li-criterion-failure` | `proposition` | 4739 | Structural failure of the Li criterion for the sewing lift |
| `prop:pure-spin-s-schur` | `proposition` | 4889 | — |
| `prop:prime-side-defect-formula` | `proposition` | 4997 | — |
| `thm:finite-miura-defect` | `theorem` | 5067 | Finite Miura defect at genus one |
| `prop:modularity-constraint` | `proposition` | 5641 | Modularity constraint on the spectral measure |
| `sec:bracket-hodge-index` | `proposition` | 5684 | Bracket positivity and the Hodge index |
| `sec:proved-regime-ramanujan` | `proposition` | 5810 | Ramanujan bound for lattice spectral measures |
| `sec:symmetric-power-route` | `proposition` | 5853 | Shadow--symmetric power identification |
| `thm:petersson-identification` | `theorem` | 6001 | Petersson identification |
| `prop:modularity-constraint-atoms` | `proposition` | 6087 | Modularity constraint on atoms |
| `prop:rigidity-threshold` | `proposition` | 6124 | Rigidity threshold |
| `prop:lattice-ramanujan-rigidity` | `proposition` | 6222 | Lattice Ramanujan from rigidity |
| `prop:stieltjes-signed-universal` | `proposition` | 6424 | Universal signed Stieltjes measure |
| `prop:rational-cft-multiplicativity-failure` | `proposition` | 6457 | Multiplicativity failure for rational CFT |
| `prop:shadow-arithmetic-trichotomy` | `proposition` | 6521 | Shadow arithmetic trichotomy |
| `prop:genus1-weight-bound` | `proposition` | 6596 | Weight bound for genus-$1$ shadow projections |
| `thm:mc-recursion-moment` | `theorem` | 6729 | MC recursion on moment $L$-functions |
| `prop:shadow-chiral-graph` | `proposition` | 6798 | Shadow amplitudes as chiral graph integrals |
| `thm:hecke-newton-lattice` | `theorem` | 6871 | Hecke--Newton closure for lattice VOAs |
| `cor:unconditional-lattice` | `corollary` | 6934 | Unconditional operadic RS for lattice VOAs |
| `thm:non-lattice-ramanujan` | `theorem` | 6963 | Non-lattice Ramanujan bound |
| `prop:mc-constraint-counting` | `proposition` | 7483 | MC constraint counting |
| `thm:route-c-propagation` | `theorem` | 7548 | Route~C: MC rigidity forces character-level prime-locality |
| `cor:route-c-standard-landscape` | `corollary` | 7671 | Route~C for the standard landscape |
| `thm:hecke-verdier-commutation` | `theorem` | 7716 | Verdier--Hecke commutation at genus~$1$ |
| `thm:self-dual-factorization` | `theorem` | 7755 | Self-dual factorisation |
| `prop:theta-bridge-rational` | `proposition` | 7830 | Theta decomposition bridge |
| `prop:newton-shadow-hecke` | `proposition` | 7893 | Newton--shadow--Hecke correspondence |
| `prop:sewing-spectral-bridge` | `proposition` | 8011 | Sewing--spectral determinant bridge |
| `prop:rs-analytic-continuation` | `proposition` | 8116 | Meromorphic continuation of the RS integral |
| `prop:scattering-residue` | `proposition` | 8163 | Holomorphy at scattering poles |
| `prop:arith-geom-decomposition` | `proposition` | 8257 | Arithmetic--geometric decomposition |
| `prop:genus-one-saddle-triviality` | `proposition` | 8432 | Genus-one saddle triviality |
| `cor:first-scattering-pole` | `corollary` | 8632 | Nonvanishing at the first scattering pole |
| `thm:scattering-coupling-factorization` | `theorem` | 8734 | Scattering coupling factorization |
| `thm:structural-separation` | `theorem` | 8817 | Structural separation of algebraic and arithmetic content |
| `prop:hecke-defect-equivalences` | `proposition` | 8943 | Equivalent characterizations; \textup{(i)--(iii)} ; \textup{(iv)} |
| `prop:hecke-defect-lattice` | `proposition` | 8994 | Hecke defect vanishes for lattice VOAs |
| `prop:hecke-defect-families` | `proposition` | 9072 | Hecke defect for standard families; \textup{(i)} ; \textup{(ii)} ; \textup{(iii)} |
| `thm:rigidity-inheritance` | `theorem` | 9191 | Rigidity inheritance |
| `thm:packet-connection-flatness` | `theorem` | 9498 | Flatness and divisor independence |
| `cor:lattice-packet-diagonal` | `corollary` | 9565 | Lattice transparency |
| `prop:gauge-criterion-scattering` | `proposition` | 9631 | Gauge criterion for scattering access |
| `rem:arithmetic-comparison-sharpening` | `remark` | 9741 | Sharpening of the arithmetic comparison conjecture |
| `prop:miura-packet-splitting` | `proposition` | 9815 | — |
| `prop:genus2-non-diagonal` | `proposition` | 10181 | Genus-$2$ sewing non-diagonality |
| `thm:genus2-non-collapse` | `theorem` | 10225 | Genus-$2$ sewing--Hecke non-collapse |
| `prop:leech-cusp-nonvanishing` | `proposition` | 10357 | Lattice cusp-form non-vanishing at genus~$2$ |
| `thm:bocherer-bridge` | `theorem` | 10389 | B\"ocherer bridge |
| `rem:genus2-definitive-scope` | `remark` | 10514 | Definitive scope of genus-$2$ arithmetic access |
| `rem:leech-all-sk` | `remark` | 10569 | Leech: all genus-$2$ cusp forms are Saito--Kurokawa lifts |
| `thm:leech-chi12-projection` | `theorem` | 10590 | Leech $\chi_{12}$-projection and Waldspurger consequence |
| `prop:prime-locality-proved-cases` | `proposition` | 10809 | Settled cases |
| `thm:prime-locality-obstructions` | `theorem` | 10850 | Precise obstructions to prime-locality; {} where indicated |
| `thm:riccati-determinacy-assessment` | `theorem` | 11052 | Riccati determinacy |

#### `chapters/connections/bv_brst.tex` (6)

| Label | Env | Line | Title |
|---|---|---:|---|
| `thm:log-form-ghost-law` | `theorem` | 290 | Ghost transformation law for log forms |
| `thm:brst-bar-genus0` | `theorem` | 393 | Genus-\texorpdfstring{$0$}{0} BRST-bar quasi-isomorphism |
| `cor:anomaly-physical-genus0` | `corollary` | 544 | Physical anomaly cancellation at genus \texorpdfstring{$0$}{0} |
| `thm:bar-semi-infinite-km` | `theorem` | 640 | Bar complex = semi-infinite complex for KM |
| `cor:anomaly-duality-km` | `corollary` | 744 | Anomaly duality for Kac--Moody pairs |
| `cor:anomaly-duality-w` | `corollary` | 902 | Curvature complementarity for principal \texorpdfstring{$\mathcal{W}$}{W}-algebra pairs |

#### `chapters/connections/concordance.tex` (18)

| Label | Env | Line | Title |
|---|---|---:|---|
| `prop:glz-special-case` | `proposition` | 426 | GLZ as special case |
| `thm:fg-from-assch` | `theorem` | 440 | FG duality from \texorpdfstring{$\chirAss$}{Ass-ch} self-duality |
| `prop:finite-jet-rigidity` | `proposition` | 731 | Finite-jet rigidity |
| `prop:polynomial-level-dependence` | `proposition` | 755 | Polynomial level dependence |
| `prop:gaussian-collapse-abelian` | `proposition` | 792 | Gaussian collapse for abelian input |
| `prop:five-theorems-mc-projections` | `proposition` | 2214 | Five main theorems as MC projections |
| `thm:operadic-complexity-concordance` | `theorem` | 2381 | Operadic complexity |
| `prop:vol2-relative-holographic-bridge` | `proposition` | 4032 | Relative holographic deformation bridge |
| `prop:vol2-ribbon-thooft-bridge` | `proposition` | 4053 | Ribbon/'t~Hooft bridge |
| `thm:lagrangian-complementarity` | `theorem` | 4378 | Lagrangian complementarity |
| `thm:universal-MC` | `theorem` | 4651 | Universal MC class |
| `thm:discriminant-spectral-verified` | `theorem` | 5002 | Discriminant as spectral determinant, verified cases |
| `thm:discriminant-spectral` | `theorem` | 5047 | Spectral discriminant, general case |
| `comp:spectral-discriminants-standard` | `computation` | 5273 | Spectral discriminants of standard families |
| `thm:family-index` | `theorem` | 5338 | Family index theorem for genus expansions |
| `rem:programme-vi-verification` | `remark` | 6550 | Programme VI: systematic verification of (H1)--(H4) |
| `rem:four-test-interface` | `remark` | 6729 | The four-test interface |
| `prop:descent-fan` | `proposition` | 8656 | Descent fan structure |
...
| `prop:dirichlet-weight-formula` | `theorem` | 1858 | — |
| `cor:virasoro-mode-removal` | `corollary` | 1916 | — |
| `prop:euler-koszul-criterion` | `theorem` | 1975 | — |
| `comp:euler-koszul-defect-table` | `computation` | 2012 | Euler--Koszul defect table for the standard landscape |
| `prop:zeta-zeros-defect-derivative` | `proposition` | 2104 | — |
| `thm:li-closed-form` | `theorem` | 2142 | — |
| `prop:li-asymptotics` | `theorem` | 2175 | — |
| `prop:surface-moment-positivity` | `theorem` | 2303 | Gram positivity |
| `cor:virasoro-gram-ratio` | `corollary` | 2326 | — |
| `thm:sewing-rkhs` | `theorem` | 2361 | Sewing RKHS |
| `prop:collapse-permanence` | `proposition` | 2428 | Collapse permanence |
| `rem:benjamin-chang-bridge` | `proposition` | 2467 | — |
| `thm:shadow-euler-independence` | `theorem` | 2493 | — |
| `rem:two-faces-theta` | `corollary` | 2550 | — |
| `thm:euler-koszul-tier-classification` | `theorem` | 2632 | — |
| `thm:sewing-hecke-reciprocity` | `theorem` | 2713 | Sewing--Hecke reciprocity |
...
| `thm:hc-census` | `theorem` | 684 | Standard landscape code census |
...
| Label | Env | Line | Title |
|---|---|---:|---|
| `conj:thqg-intro-operadic-complexity` | `theorem` | 861 | Operadic complexity; ; Theorem~\ref{thm:operadic-complexity} |
...
| `thm:thqg-oc-quartic-vanishing` | `theorem` | 1140 | Vanishing and nonvanishing of $\mathfrak{R}^{\mathrm{oc}}_{4}$ |
...
| `prop:thqg-VI-polynomial-growth` | `proposition` | 1797 | Polynomial growth of soft factors |
...
| `thm:completed-bar-cobar` | `theorem` | 189 | Completed bar-cobar duality |
| `thm:koszul-dual-characterization` | `theorem` | 249 | Characterization of Koszul duals |
| `thm:stabilized-completion-positive` | `theorem` | 559 | Stabilized completion for positive towers |
| `thm:resonance-filtered-bar-cobar` | `theorem` | 670 | Resonance-filtered completed bar/cobar |
