...
Auto-generated on 2026-03-22 from the structured claim extractor in `scripts/generate_metadata.py`.
...
| Metric | Value |
|---|---:|
| ProvedHere claims | 2222 |
| Total tagged claims | 2841 |
...
| Frame | 14 |
| Part I: Theory | 799 |
| Part II: Examples | 548 |
| Part III: Connections | 576 |
| Appendices | 285 |
...
|---|---:|
| `chapters/theory/higher_genus_modular_koszul.tex` | 170 |
...
| `chapters/examples/kac_moody.tex` | 49 |
...
| `thm:central-implies-strict` | `theorem` | 5190 | Centrality implies strict nilpotence |
| `thm:mc-deformations-DISABLED` | `theorem` | 5531 | MC elements as quantum deformations |
| `thm:mc-periods-DISABLED` | `theorem` | 5567 | MC elements via period integrals |
| `thm:genus-zero-strict` | `theorem` | 5628 | Strict nilpotence at genus zero |
| `thm:genus-induction-strict` | `theorem` | 5640 | Strict nilpotence at all genera |
| `thm:bar-modular-operad` | `theorem` | 5748 | Modular operad structure of the bar complex |
| `cor:genus-expansion-converges` | `corollary` | 6034 | Genus expansion convergence |
| `thm:bar-functorial-grothendieck` | `theorem` | 6094 | Functoriality of bar construction |
| `thm:reconstruction-vs-duality` | `theorem` | 6203 | Reconstruction versus duality |
| `thm:recognition-koszul-pairs` | `theorem` | 6265 | Recognition theorem for finite chiral Koszul pairs |
| `thm:mixed-boundary-sseq` | `theorem` | 6320 | Mixed-boundary spectral sequence |
| `thm:pbw-regular-tensor` | `theorem` | 6344 | PBW-regular tensor theorem |
| `thm:universal-sugawara-d1` | `theorem` | 6392 | Universal first mixed Sugawara differential |
| `cor:sugawara-universality` | `corollary` | 6421 | Universality |
| `prop:sugawara-contraction` | `proposition` | 6429 | Contractibility on positive current weight |
| `thm:sugawara-casimir-transgression` | `theorem` | 6494 | Sugawara Casimir transgression |
| `thm:casimir-transgression-homology` | `theorem` | 6510 | Homology of the minimal Casimir-transgression complex |
| `thm:casimir-quadric-rigidity` | `theorem` | 6556 | Quadric rigidity: no higher $A_\infty$~corrections |
| `thm:ci-transgression-principle` | `theorem` | 6605 | Complete-intersection transgression principle |
| `thm:gko-transgression` | `theorem` | 6649 | Diagonal GKO transgression |
...
| `prop:counit-qi` | `proposition` | 1997 | Counit is quasi-isomorphism |
| `thm:bar-cobar-inversion-functorial` | `theorem` | 2009 | Functoriality |
| `cor:derived-equivalence-bar-cobar` | `corollary` | 2044 | Derived equivalence |
| `lem:complete-filtered-comparison` | `lemma` | 2132 | Complete filtered comparison lemma |
| `cor:completed-derived-equivalence` | `corollary` | 2233 | Completed derived equivalence |
| `thm:barr-beck-lurie-koszulness` | `theorem` | 2335 | Barr--Beck--Lurie characterization of chiral Koszulness |
| `thm:fh-concentration-koszulness` | `theorem` | 2401 | Factorization homology concentration |
| `thm:fm-boundary-acyclicity` | `theorem` | 2461 | FM boundary acyclicity |
| `prop:bar-fh` | `proposition` | 2834 | Bar construction as factorization homology |
| `prop:cobar-fh` | `proposition` | 2912 | Cobar as factorization cohomology |
| `prop:subexponential-growth-automatic` | `proposition` | 3459 | Sub-exponential growth is automatic |
| `thm:ks-centrality` | `theorem` | 3673 | Kodaira--Spencer centrality |
| `lem:two-eta-vanishing` | `lemma` | 3716 | Two-$\eta$ vanishing |
| `prop:square-zero-insertion` | `proposition` | 3767 | Square-zero insertion differential |
| `cor:two-step-scalar-sseq` | `corollary` | 3802 | Two-step scalar spectral sequence |
| `thm:quadratic-frontier` | `theorem` | 3848 | Quadratic frontier |
| `prop:eta-hessian-transfer` | `proposition` | 3942 | Homotopy-transfer construction of the $\eta$-Hessian |
| `lem:shifted-symmetry-H` | `lemma` | 3978 | Shifted symmetry on degree-two primitives |
| `thm:admissible-scalar-rigidity` | `theorem` | 4023 | Admissible scalar rigidity |
| `cor:ds-not-first-frontier` | `corollary` | 4056 | Drinfeld--Sokolov reductions remain scalar-rigid |
| `thm:classification-scalar-genera` | `theorem` | 4098 | Classification of scalar genera |
| `thm:platonic-hierarchy-log` | `theorem` | 4165 | Five-step hierarchy of the categorical logarithm |
| `prop:cech-two-element-strict` | `proposition` | 4680 | Two-element covers are strict |
| `thm:divisor-core-calculus-inv` | `theorem` | 5007 | Divisor-core calculus |
| `cor:divisors-classify-submodules-inv` | `corollary` | 5067 | Divisors classify submodules |
| `thm:hom-equals-gcd-inv` | `theorem` | 5099 | \texorpdfstring{$\operatorname{Hom} = \gcd$}{Hom = gcd} |
| `thm:factorization-through-common-core-inv` | `theorem` | 5121 | Universal factorization through the common core |
| `thm:minimal-intrinsic-realization-inv` | `theorem` | 5219 | Minimal intrinsic realization |
| `thm:sector-determinant-inv` | `theorem` | 5267 | Sector determinant |
| `thm:casimir-moment-reconstruction-inv` | `theorem` | 5287 | Casimir moment reconstruction |
| `thm:primary-jordan-filtration-inv` | `theorem` | 5332 | Primary Jordan filtration |
| `cor:repeated-roots-extension-data` | `corollary` | 5363 | Repeated roots encode extension data |
| `thm:common-core-exact-sequences-inv` | `theorem` | 5395 | Common-core exact sequences |
| `prop:transport-factors-inv` | `proposition` | 5423 | Transport factors through the common core |
| `prop:sl3-w3-defect-inv` | `proposition` | 5490 | Exact defect decomposition |
| `prop:sl3-w3-projectors` | `proposition` | 5512 | Explicit coprime-locus projectors |
...
| `thm:koszul-equivalences-meta` | `theorem` | 1291 | Equivalences of chiral Koszulness |
| `prop:koszulness-formality-equivalence` | `proposition` | 1580 | Koszulness as formality of the convolution algebra |
| `prop:cumulant-window-inversion` | `proposition` | 1815 | Cumulant-to-window inversion |
| `thm:bar-cobar-isomorphism-main` | `theorem` | 1871 | Geometric bar--cobar duality |
| `thm:yangian-self-dual` | `theorem` | 2048 | Yangian quadratic dual |
| `prop:yangian-koszul-general` | `proposition` | 2108 | Yangian Koszulness for all simple \texorpdfstring{$\mathfrak{g}$}{g} |
| `thm:coalgebra-axioms-verified` | `theorem` | 2262 | Coalgebra structure on \texorpdfstring{$\mathcal{A}_2^!$}{A2-dual} |
| `thm:bar-computes-koszul-dual-complete` | `theorem` | 2356 | Bar computes Koszul dual — complete statement |
| `lem:completion-convergence` | `lemma` | 2444 | Completion convergence |
| `cor:circularity-free-koszul` | `corollary` | 2493 | Circularity-free Koszul duality |
| `thm:e1-chiral-koszul-duality` | `theorem` | 3050 | \texorpdfstring{$\Eone$}{E1}-chiral Koszul duality |
| `cor:e1-self-duality` | `corollary` | 3268 | \texorpdfstring{$\Eone$}{E1}--\texorpdfstring{$\Eone$}{E1} Self-Duality |
| `thm:module-category-equivalence` | `theorem` | 3333 | Module category equivalence |
| `thm:e1-module-koszul-duality` | `theorem` | 3394 | \texorpdfstring{$\Eone$}{E1}-module category Koszul duality |
| `thm:structure-exchange` | `theorem` | 3517 | Structure exchange |
| `thm:ainfty-duality-exchange` | `theorem` | 3559 | \texorpdfstring{$A_\infty$}{A-infinity} duality |
| `prop:ff-involution-uniqueness` | `proposition` | 3613 | Uniqueness of the Feigin--Frenkel involution |
| `thm:curved-koszul-pairs` | `theorem` | 3648 | Curved Koszul pairs |
| `prop:koszul-dual-tensor-product` | `proposition` | 3843 | Koszul dual of tensor products in the quadratic case |
...
| `lem:free-chiral-module-structure` | `lemma` | 2449 | Structure of free chiral modules |
| `thm:bar-resolution-acyclic` | `theorem` | 2484 | Bar resolution is acyclic |
| `thm:geometric-bar-module` | `theorem` | 2523 | Geometric bar complex |
| `thm:character-acyclic-resolution` | `theorem` | 2540 | Character via acyclic resolution |
| `thm:koszul-resolution-module` | `theorem` | 2580 | Koszul pairs simplify resolutions |
| `cor:character-koszul` | `corollary` | 2602 | Character formula for Koszul case |
| `thm:bgg-from-bar` | `theorem` | 2752 | BGG resolution from bar complex |
| `comp:bgg-sl2-pipeline` | `computation` | 2859 | BGG pipeline for \texorpdfstring{$\widehat{\mathfrak{sl}}_2$}{sl2-hat} at generic level |
| `thm:weyl-kac-geometric` | `theorem` | 2973 | Weyl--Kac character formula |
| `prop:weyl-kac-sl2-bar` | `proposition` | 3053 | Character from bar resolution |
| `prop:ext-sl2-level2` | `proposition` | 3207 | \texorpdfstring{$\mathrm{Ext}$}{Ext} groups at level~\texorpdfstring{$2$}{2} |
| `prop:ext-koszul-dual-level` | `proposition` | 3238 | \texorpdfstring{$\mathrm{Ext}$}{Ext} complementarity at dual levels |
| `prop:character-koszul-duality` | `proposition` | 3290 | Characters under level-shifting Koszul duality |
| `prop:vacuum-verma-koszul` | `proposition` | 3369 | Vacuum Verma under Koszul duality |
| `prop:shapovalov-koszul` | `proposition` | 3455 | Shapovalov form under Koszul duality |
| `prop:nonvacuum-verma-koszul` | `proposition` | 3514 | Non-vacuum Verma modules under Koszul duality |
| `cor:singular-vector-symmetry` | `corollary` | 3590 | Singular vector locus symmetry |
| `prop:virasoro-verma-koszul` | `proposition` | 3667 | Virasoro Verma module under the same-family involution |
| `prop:virasoro-kac-koszul` | `proposition` | 3717 | Virasoro Kac determinant under Koszul duality |
| `thm:character-homological-corrections` | `theorem` | 3810 | Character with homological corrections |
| `thm:deformation-acyclicity` | `theorem` | 3864 | Deformation of acyclicity |
| `__unlabeled_chapters/theory/chiral_modules.tex:3930` | `calculation` | 3930 | Boson vacuum module |
| `__unlabeled_chapters/theory/chiral_modules.tex:3957` | `calculation` | 3957 | Fermion vacuum |
| `__unlabeled_chapters/theory/chiral_modules.tex:3988` | `calculation` | 3988 | W-algebra at critical level |
| `prop:bar-localization` | `proposition` | 4106 | Bar complex as localization |
| `prop:bar-singular-support` | `proposition` | 4231 | Bar complex and singular support |
| `thm:ds-koszul-intertwine` | `theorem` | 4288 | DS reduction intertwines with Koszul duality |
| `cor:ds-character-compatibility` | `corollary` | 4378 | Characters under DS reduction |
| `cor:ds-bar-level-shift` | `corollary` | 4420 | \texorpdfstring{$\mathcal{W}$}{W}-algebra cobar from KM bar |
| `thm:module-genus-tower` | `theorem` | 4475 | Module tower from bar complex with insertions |
| `prop:genus-module-koszul` | `proposition` | 4517 | Koszul duality of genus-graded modules |
| `prop:ext-bar-resolution` | `proposition` | 4647 | Ext via bar resolution |
| `thm:fusion-bar-cobar` | `theorem` | 4786 | Fusion product preservation |
| `prop:heisenberg-fusion-splitting` | `proposition` | 4896 | Heisenberg fusion splitting |
...
| Label | Env | Line | Title |
|---|---|---:|---|
| `prop:fourier-propagator-properties` | `proposition` | 64 | Three properties of the propagator |
| `prop:fourier-genus1-propagator` | `proposition` | 121 | Genus-\texorpdfstring{$1$}{1} propagator |
| `prop:fourier-com-lie-duality` | `proposition` | 230 | — |
| `comp:fourier-heisenberg-n2` | `computation` | 276 | \texorpdfstring{$n = 2$}{n = 2} |
| `comp:fourier-heisenberg-n3` | `computation` | 324 | \texorpdfstring{$n = 3$}{n = 3} |
| `thm:fourier-heisenberg-bar` | `theorem` | 353 | — |
| `comp:fourier-heisenberg-elliptic` | `computation` | 415 | Heisenberg on \texorpdfstring{$E_\tau$}{E-tau} |
| `prop:fourier-total-diff-nilpotent` | `proposition` | 442 | — |
| `prop:fourier-propagator-degeneration` | `proposition` | 499 | Degeneration of the propagator |
| `prop:fourier-poincare-degeneration` | `proposition` | 557 | Degeneration of the Poincar\'e line bundle |
| `thm:fourier-recovery` | `theorem` | 637 | Recovery of the Fourier transform |
| `comp:fourier-km-bar` | `computation` | 807 | Kac--Moody bar |
| `thm:fourier-km-bar` | `theorem` | 828 | — |
| `thm:fourier-specialization` | `theorem` | 863 | Specialization |
| `thm:fourier-four-properties` | `theorem` | 918 | The four properties of the Fourier transform |
| `rem:fourier-genus-preview` | `remark` | 1018 | Ref.\ Theorem~\ref{thm:mc2-full-resolution} |
...
| `lem:higher-genus-boundary-qi` | `lemma` | 3696 | Boundary-stratum compatibility of \texorpdfstring{$\psi_g$}{psi-g} |
| `lem:extension-across-boundary-qi` | `lemma` | 3722 | Extension across boundary |
| `thm:higher-genus-inversion` | `theorem` | 3738 | Higher genus inversion |
| `lem:e2-collapse-higher-genus` | `lemma` | 3843 | \texorpdfstring{$E_2$}{E2} collapse at higher genus |
| `prop:pants-excision` | `proposition` | 3919 | Pants decomposition as excision |
| `prop:genus-induction-excision` | `proposition` | 3967 | Genus induction is iterated excision |
| `prop:e2-collapse-formality` | `proposition` | 4056 | \texorpdfstring{$E_2$}{E2}-collapse as formality |
| `thm:ambient-complementarity-tangent` | `theorem` | 4231 | Ambient complementarity in tangent form |
| `thm:ambient-complementarity-fmp` | `theorem` | 4274 | Ambient complementarity as shifted symplectic formal moduli problem |
| `thm:shifted-cotangent-normal-form` | `theorem` | 4532 | Shifted cotangent normal form |
| `prop:legendre-duality-potentials` | `proposition` | 4581 | Legendre duality of the two potentials |
| `prop:legendre-duality-cubic` | `proposition` | 4596 | Legendre duality of cubic tensors |
| `thm:derived-critical-locus` | `theorem` | 4626 | Derived critical locus of self-dual deformations |
| `prop:fake-complementarity-criterion` | `proposition` | 4650 | Criterion for fake complementarity |
| `thm:holo-comp-bulk-reconstruction` | `theorem` | 4846 | Protected bulk reconstruction |
| `thm:holo-comp-cotangent-realization` | `theorem` | 4896 | Shifted cotangent realization |
| `cor:holo-comp-spectral-reciprocity` | `corollary` | 4923 | Spectral reciprocity and palindromicity |
| `thm:holo-comp-fourier-transport` | `theorem` | 5009 | Fourier intertwining |
| `thm:holo-comp-weyl-sewing` | `theorem` | 5053 | Weyl associativity, PBW, and linear sewing |
| `thm:holo-comp-gaussian-composition` | `theorem` | 5130 | Gaussian composition via Schur complement |
| `thm:holo-comp-metaplectic-cocycle` | `theorem` | 5213 | Metaplectic $2$-cocycle and strictification |
| `cor:holo-comp-first-nonlinear-anomaly` | `corollary` | 5282 | First nonlinear holographic anomaly |
| `thm:critical-dimension` | `theorem` | 5386 | Critical dimension |
| `prop:non-critical-liouville` | `proposition` | 5502 | Non-critical complementarity and the Liouville sector |
| `cor:complementarity-discriminant-cancellation` | `corollary` | 5547 | Arity-$4$ discriminant cancellation |
...
| `thm:loop-order-collapse` | `theorem` | 5498 | Loop order collapse |
| `cor:loop-decomposition-bar` | `corollary` | 5532 | Loop order decomposition of bar cohomology |
| `cor:feynman-duality-qch` | `corollary` | 5573 | Duality of quantum chiral homology |
| `thm:virtual-euler-char` | `theorem` | 5630 | Graph-sum formula for the virtual Euler characteristic |
| `cor:heisenberg-euler-char` | `corollary` | 5658 | Heisenberg Euler characteristic |
| `prop:weight-system-map` | `proposition` | 5708 | Weight system map |
...
| `lem:e2-higher-genus` | `lemma` | 2127 | $E_2$ collapse at higher genus |
| `thm:genus-internalization` | `theorem` | 2254 | Genus internalization of modular Koszul duality |
| `thm:modular-characteristic` | `theorem` | 2364 | Modular characteristic |
| `cor:free-energy-ahat-genus` | `corollary` | 2482 | Scalar free energy as $\hat{A}$-genus |
| `thm:spectral-characteristic` | `theorem` | 2565 | Spectral characteristic theorem |
| `thm:universal-theta` | `theorem` | 2598 | Universal modular Maurer--Cartan class |
| `thm:mc2-bar-intrinsic` | `theorem` | 2736 | Bar-intrinsic MC2 |
| `cor:shadow-extraction` | `corollary` | 2895 | Shadow extraction |
| `thm:bipartite-linfty-tree` | `theorem` | 3029 | Bipartite shadow as $L_\infty$ tree-level structure |
| `thm:explicit-theta` | `theorem` | 3155 | Explicit universal MC class |
| `cor:explicit-theta-specializations` | `corollary` | 3376 | Explicit modular package for all families |
| `prop:genus-completed-mc-framework` | `proposition` | 3790 | Genus-completed MC framework |
| `prop:cyclic-ce-identification` | `proposition` | 3869 | Cyclic CE cohomology identification |
| `cor:one-dim-obstruction` | `corollary` | 3982 | One-dimensional obstruction space |
| `prop:mc2-reduction-principle` | `proposition` | 4016 | MC2 reduction principle |
| `prop:geometric-modular-operadic-mc` | `proposition` | 4048 | Geometric modular-operadic MC framework |
| `prop:tautological-line-support-criterion` | `proposition` | 4244 | Tautological-line support criterion |
| `prop:one-channel-verdier-criterion` | `proposition` | 4320 | One-channel Verdier/Koszul criterion |
| `prop:one-channel-ptvv-criterion` | `proposition` | 4385 | One-channel PTVV / anti-involution criterion |
| `prop:one-channel-chain-model-criterion` | `proposition` | 4520 | One-channel chain-model criterion |
| `prop:one-channel-seed-criterion` | `proposition` | 4617 | One-channel bar-coderivation seed criterion |
| `prop:one-channel-minimal-seed-packet-criterion` | `proposition` | 4728 | One-channel minimal seed-packet criterion |
| `prop:one-channel-visible-lowarity-packet-criterion` | `proposition` | 4865 | One-channel visible low-arity seed-packet criterion |
| `prop:one-channel-canonical-transfer-criterion` | `proposition` | 5017 | One-channel canonical transfer-package criterion |
| `prop:one-channel-transfer-law-criterion` | `proposition` | 5191 | One-channel root-string transfer-law criterion |
| `prop:one-channel-root-string-chart-criterion` | `proposition` | 5341 | One-channel root-string chart criterion |
| `prop:one-channel-intrinsic-line-detection-criterion` | `proposition` | 5535 | One-channel intrinsic line-detection criterion |
| `prop:one-channel-automorphism-rigidity-criterion` | `proposition` | 5655 | One-channel automorphism-rigidity criterion |
| `prop:one-channel-support-graph-stabilizer-criterion` | `proposition` | 5754 | One-channel support-graph stabilizer criterion |
| `prop:one-channel-incidence-orbit-criterion` | `proposition` | 5844 | One-channel incidence-matrix / orbit-count criterion |
| `prop:one-channel-visible-orbit-table-criterion` | `proposition` | 5956 | One-channel visible root-string orbit-table criterion |
| `prop:one-channel-canonical-universal-orbit-table-criterion` | `proposition` | 6028 | One-channel canonical universal orbit-table criterion |
| `prop:one-channel-universal-invariant-signature-criterion` | `proposition` | 6110 | One-channel universal invariant-signature criterion |
| `prop:one-channel-signed-seed-character-criterion` | `proposition` | 6188 | One-channel signed seed-character criterion |
| `prop:one-channel-two-sign-plus-normalization-scalar-criterion` | `proposition` | 6265 | One-channel two-sign plus normalization-scalar criterion |
| `prop:one-channel-parity-sign-plus-normalization-scalar-criterion` | `proposition` | 6341 | One-channel parity-sign plus normalization-scalar criterion |
| `prop:one-channel-parity-forcing-criterion` | `proposition` | 6416 | One-channel parity-forcing criterion |
| `prop:one-channel-normalization-criterion` | `proposition` | 6482 | One-channel normalization criterion |
| `thm:mc2-conditional-completion` | `theorem` | 6560 | MC2 conditional completion |
| `thm:mc2-full-resolution` | `theorem` | 6635 | MC2 full resolution |
| `lem:mk67-from-mc2` | `lemma` | 6682 | MC2 full resolution identifies MK6--MK7 |
| `cor:scalar-saturation` | `corollary` | 6724 | Scalar saturation of the universal MC class |
| `thm:km-strictification` | `theorem` | 6783 | KM strictification of the universal class |
| `prop:one-channel-gauge-rigidity` | `proposition` | 6837 | One-channel gauge rigidity |
| `prop:w-algebra-scalar-saturation` | `proposition` | 6870 | Scalar saturation for \texorpdfstring{$\mathcal{W}$}{W}-algebras |
| `cor:winfty-scalar-saturation` | `corollary` | 6908 | Scalar saturation persists in the \texorpdfstring{$\mathcal{W}_\infty$}{W-infinity} limit |
| `prop:ds-package-functoriality` | `proposition` | 6961 | DS functoriality of the characteristic package |
| `prop:nonprincipal-scalar-saturation` | `proposition` | 7033 | Scalar saturation for non-principal \texorpdfstring{$\mathcal{W}$}{W}-algebras |
| `prop:saturation-equivalence` | `proposition` | 7115 | Saturation equivalence criterion |
| `prop:saturation-functorial` | `proposition` | 7287 | Functorial stability of scalar saturation |
| `cor:effective-quadruple` | `corollary` | 7450 | Effective quadruple for the standard landscape |
| `thm:cyclic-rigidity-generic` | `theorem` | 7533 | Cyclic rigidity at generic level |
| `thm:algebraic-family-rigidity` | `theorem` | 7693 | Algebraic-family rigidity |
| `cor:saturation-algebraic-families` | `corollary` | 7799 | Saturation at all non-critical levels for algebraic families |
| `thm:conformal-bootstrap-rigidity` | `theorem` | 7860 | $L_0$-bootstrap rigidity |
| `cor:one-channel-no-lie` | `corollary` | 7967 | One-channel criterion without Lie symmetry |
| `thm:tautological-line-support` | `theorem` | 8195 | Tautological line support |
| `cor:mc2-single-hypothesis` | `corollary` | 8297 | MC2 reduced to cyclic model |
| `thm:convolution-dg-lie-structure` | `theorem` | 8451 | dg~Lie structure from the modular operad |
| `thm:modular-quantum-linfty` | `theorem` | 8516 | Full homotopy upgrade: quantum $L_\infty$ structure |
| `thm:modular-homotopy-convolution` | `theorem` | 8880 | Modular homotopy convolution |
| `prop:modular-homotopy-type-structure` | `proposition` | 8964 | Structure of the modular homotopy type |
| `cor:strictification-comparison` | `corollary` | 9011 | Strictification comparison |
| `cor:vol1-theta-log-fm-twisting-data` | `corollary` | 9334 | $\Theta_\cA$ as universal modular twisting morphism |
| `prop:vol1-first-two-weights-log-fm` | `proposition` | 9588 | First two weights |
| `comp:vol1-low-genus-log-fm-chart` | `computation` | 9663 | Low-genus amplitudes |
| `prop:master-equation-from-mc` | `proposition` | 10075 | All-arity master equation from MC |
| `thm:ds-complementarity-tower-main` | `theorem` | 10128 | DS complementarity tower |
| `thm:recursive-existence` | `theorem` | 10243 | Recursive existence |
| `thm:modular-propagator-existence` | `theorem` | 10381 | Modular propagator existence |
| `thm:logfm-modular-cocomposition` | `theorem` | 10415 | Log-FM modular cocomposition |
| `thm:stable-graph-pronilpotent-completion` | `theorem` | 10457 | Stable-graph pronilpotent completion |
| `thm:finite-rank-spectral-reduction` | `theorem` | 10508 | Finite-rank spectral reduction |
| `thm:primitive-to-global-reconstruction` | `theorem` | 10573 | Primitive-to-global reconstruction |
| `prop:primitive-shell-equations` | `proposition` | 10708 | Primitive shell equations |
| `prop:branch-master-equation` | `proposition` | 10846 | Branch quantum master equation |
| `cor:metaplectic-square-root` | `corollary` | 10899 | Determinantal half-density |
| `thm:primitive-flat-descent` | `theorem` | 11090 | Descent to the conformal block connection |
| `thm:conformal-block-reconstruction` | `theorem` | 11168 | Conformal block reconstruction from the primitive kernel |
| `thm:deformation-quantization-ope` | `theorem` | 11257 | Genus expansion from the OPE |
| `thm:ran-coherent-bar-cobar` | `theorem` | 11453 | Ran-coherent bar-cobar equivalence |
| `thm:shadow-channel-decomposition` | `theorem` | 11513 | Shadow channel decomposition |
| `cor:shadow-cauchy-schwarz` | `corollary` | 11593 | Shadow Cauchy--Schwarz inequality |
| `prop:critical-locus-complementarity` | `proposition` | 11643 | Critical-locus form of complementarity |
| `thm:theta-direct-derivation` | `theorem` | 11766 | The explicit formula: direct derivation |
| `lem:graph-sum-truncation` | `lemma` | 12053 | Graph-sum truncation criterion |
| `conj:operadic-complexity-detailed` | `theorem` | 12128 | Operadic complexity |
| `prop:shadow-formality-low-arity` | `proposition` | 12247 | Shadow--formality identification at low arity |
| `thm:shadow-formality-identification` | `theorem` | 12318 | Shadow tower as formality obstruction tower |
| `thm:shadow-archetype-classification` | `theorem` | 12655 | Shadow archetype classification |
| `cor:shadow-depth-koszul-invariance` | `corollary` | 12760 | Shadow depth under Koszul duality |
| `thm:riccati-algebraicity` | `theorem` | 12820 | Riccati algebraicity |
| `prop:pole-purity` | `proposition` | 12956 | Pole purity |
| `prop:intrinsic-quartic` | `proposition` | 12974 | Intrinsic quartic principle |
| `thm:single-line-dichotomy` | `theorem` | 13009 | Single-line dichotomy |
| `thm:shadow-connection` | `theorem` | 13146 | Shadow connection |
| `thm:shadow-separation` | `theorem` | 13428 | Shadow separation and completeness |
| `thm:propagator-variance` | `proposition` | 13533 | Propagator variance inequality |
| `prop:t-line-autonomy` | `proposition` | 13643 | T-line autonomy |
| `prop:interchannel-coupling` | `proposition` | 13700 | Inter-channel coupling on sublines |
| `thm:shadow-radius` | `theorem` | 13827 | Shadow radius and asymptotic transfer |
| `thm:vieta-shadow-growth` | `theorem` | 13995 | Vieta structure of the shadow growth rate |
| `prop:virasoro-bottleneck` | `proposition` | 14098 | Virasoro bottleneck |
| `thm:koszul-exchange-regimes` | `theorem` | 14232 | Koszul exchange of shadow regimes |
| `prop:propagator-universality` | `proposition` | 14298 | Propagator universality |
| `thm:hamilton-jacobi-shadow` | `theorem` | 14523 | Hamilton--Jacobi master equation on deformation spaces |
| `thm:shadow-finite-determination` | `theorem` | 14714 | Shadow finite determination |
| `cor:w3-reconstruction` | `corollary` | 14801 | $\cW_3$: seven parameters determine the full 2D tower |
| `thm:shadow-tautological-ring` | `theorem` | 14927 | Shadow classes in the tautological ring |
| `cor:analytic-shadow-realization` | `corollary` | 15070 | Analytic shadow realization |
| `thm:shadow-cohft` | `theorem` | 15156 | Shadow cohomological field theory |
| `thm:mc-tautological-descent` | `theorem` | 15327 | MC descent to tautological relations |
| `prop:wdvv-from-mc` | `proposition` | 15430 | WDVV from MC at genus~$0$ |
| `prop:mumford-from-mc` | `proposition` | 15463 | Mumford relation from MC at arity~$2$ |
| `thm:cohft-reconstruction` | `theorem` | 15495 | Reconstruction from the MC tangent complex |
| `cor:topological-recursion-mc-shadow` | `corollary` | 15606 | Topological recursion as MC shadow |
| `prop:winfinity-not-cyclically-admissible` | `proposition` | 15807 | $\mathcal{W}_{1+\infty}$ is not cyclically admissible |
| `prop:finite-jet-rigidity` | `proposition` | 15888 | Finite-jet rigidity |
| `prop:polynomial-level-dependence` | `proposition` | 15911 | Polynomial level dependence |
| `prop:gaussian-collapse-abelian` | `proposition` | 15947 | Gaussian collapse for abelian input |
| `thm:cubic-gauge-triviality` | `theorem` | 16029 | Cubic gauge triviality and canonical quartic class |
| `prop:independent-sum-factorization` | `proposition` | 16101 | Independent sum factorization |
| `thm:platonic-adjunction` | `theorem` | 16173 | The platonic adjunction |
| `cor:envelope-universal-mc` | `corollary` | 16306 | The envelope carries the universal MC class |
| `prop:envelope-construction-strategies` | `proposition` | 16364 | Construction strategies for the modular envelope |
| `conj:shadow-depth-invariant` | `theorem` | 16436 | Shadow depth is a homotopy invariant |
| `conj:tropical-koszulness` | `theorem` | 16480 | Tropical Koszulness |
| `cor:tropical-cohen-macaulay` | `corollary` | 16572 | Tropical Koszulness as the Cohen--Macaulay property |
| `prop:genus0-curve-independence` | `proposition` | 16619 | Genus-$0$ curve-independence |
| `thm:open-stratum-curve-independence` | `theorem` | 16638 | Open-stratum curve-independence at higher genus |
| `prop:saddle-point-mc` | `proposition` | 16929 | MC element as saddle point |
| `thm:five-from-theta` | `theorem` | 17200 | Five main theorems from the master MC element |
| `thm:obstruction-recursion` | `theorem` | 17422 | Obstruction recursion for the shadow Postnikov tower |
| `thm:rectification-meta` | `theorem` | 17519 | Rectification meta-theorem |
| `thm:platonic-recovery` | `theorem` | 17614 | Recovery of the platonic package from $\Theta_\cA$ |
| `prop:chriss-ginzburg-structure` | `proposition` | 17838 | MC structure principle |
| `prop:planar-forest-coinvariant` | `proposition` | 18217 | Planar forests map to unordered forests |
| `thm:planar-forest-tropicalization` | `theorem` | 18250 | Planar tropicalization |
| `prop:ordered-log-fm-construction` | `proposition` | 18295 | Ordered log-FM construction |
| `cor:e1-ambient-d-squared-zero` | `corollary` | 18373 | $E_1$ ambient $D^2 = 0$ |
| `prop:coefficient-algebras-well-defined` | `proposition` | 18418 | Square-zero property of the ambient differential |
| `thm:convolution-d-squared-zero` | `theorem` | 18451 | Square-zero: convolution level |
| `conj:differential-square-zero` | `theorem` | 18465 | Square-zero: ambient level |
| `thm:inductive-genus-determination` | `theorem` | 18614 | Inductive genus determination |
| `cor:genus-base-cases` | `corollary` | 18682 | Base cases |
| `rem:genus2-shell-activation` | `theorem` | 18719 | Genus-$2$ shell activation as depth diagnostic |
| `comp:vol1-genus-three-stable-graph-census` | `computation` | 18823 | Genus-$3$ stable graph census |
| `prop:2d-convergence` | `proposition` | 19007 | Two-dimensional convergence |
| `thm:analytic-algebraic-comparison` | `theorem` | 19063 | Analytic = algebraic |
| `thm:determinantal-branch-formula` | `theorem` | 19198 | Determinantal branch formula |
| `thm:transport-lifted-covers` | `theorem` | 19234 | Transport of lifted covers |
| `thm:common-sheet-law` | `theorem` | 19265 | Common-sheet multiplication law |
| `thm:spectral-hierarchy` | `theorem` | 19329 | Hierarchy of spectral invariants |
| `cor:frontier-is-cubic` | `corollary` | 19365 | The frontier is cubic |
...
| Label | Env | Line | Title |
|---|---|---:|---|
| `thm:central-charge-complementarity` | `theorem` | 709 | Central charge complementarity |
| `thm:modular-koszul-duality-main` | `theorem` | 811 | Modular Koszul duality |
| `cor:shadow-separation-intro` | `corollary` | 912 | Shadow separation; ; Theorem~\textup{\ref{thm:shadow-separation}} |
| `thm:rectification-bridge` | `theorem` | 1314 | Rectification bridge |
| `prop:modular-homotopy-classification` | `proposition` | 1467 | Classification by modular homotopy type |
| `prop:shadow-massey-identification` | `proposition` | 1537 | Genus-$0$ shadow obstructions $=$ $A_\infty$ Massey products |
| `prop:chirAss-self-dual` | `proposition` | 2923 | \texorpdfstring{$\chirAss$}{Ass-ch} self-duality |
...
| `thm:heisenberg-not-self-dual` | `theorem` | 1776 | Heisenberg is not self-dual |
| `prop:bar-bv-free-fields` | `proposition` | 1881 | Bar complex as BV complex |
| `thm:heisenberg-genus-g` | `theorem` | 1912 | Quantum complementarity for Heisenberg |
| `prop:abelian-bar-factorization` | `proposition` | 2171 | Abelian factorization of the bar differential |
| `prop:nonabelian-kernel-nonfactorization` | `proposition` | 2285 | Non-abelian kernel non-factorization |
| `prop:en-fourier-hierarchy` | `proposition` | 2558 | \texorpdfstring{$\En$}{En} Fourier hierarchy |
| `thm:heisenberg-bar-complete` | `theorem` | 2707 | Heisenberg bar complex: complete calculation |
| `lem:bar-dims-partitions` | `lemma` | 2754 | Bar dimensions as partition numbers |
| `thm:heisenberg-level-inversion` | `theorem` | 2813 | Heisenberg level inversion: curved duality |
| `thm:virasoro-moduli` | `theorem` | 2873 | Virasoro-moduli correspondence |
| `prop:moduli-degeneration` | `proposition` | 2956 | Geometric interpretation |
| `thm:virasoro-string` | `theorem` | 3035 | Virasoro-string duality |
| `thm:algebraic-string-dictionary` | `theorem` | 3071 | Algebraic string theory dictionary |
| `cor:string-amplitude-genus0` | `corollary` | 3123 | Genus-\texorpdfstring{$0$}{0} string amplitudes from bar complex |
| `thm:genus-g-chiral-homology` | `theorem` | 3165 | Genus-\texorpdfstring{$g$}{g} chiral homology from bar complex |
| `thm:genus-deformation-exact` | `theorem` | 3274 | Genus expansion as curved deformation |
| `thm:bar-string-integrand` | `theorem` | 3354 | Bar complex computes genus-\texorpdfstring{$g$}{g} string integrands |
| `thm:modular-invariance` | `theorem` | 3492 | Modular invariance of bar complex |
| `thm:modular-anomaly-km-w` | `theorem` | 3529 | Modular anomaly for KM and \texorpdfstring{$\mathcal{W}$}{W}-algebras |
| `thm:wakimoto-bar` | `theorem` | 3638 | Wakimoto bar complex |
| `prop:wakimoto-graph` | `proposition` | 3651 | Graphical interpretation |
| `thm:w-algebra-ainfty` | `theorem` | 3656 | \texorpdfstring{$A_\infty$}{A-infinity} structure on \texorpdfstring{$\mathcal{W}$}{W}-algebras |
| `thm:w-integrability` | `theorem` | 3683 | Quantum integrability via \texorpdfstring{$A_\infty$}{A-infinity} |
| `thm:filtered-bar-complex` | `theorem` | 3743 | Filtered bar complex |
...
| `comp:sl2-collision-residue-kz` | `computation` | 1321 | Collision residue and the KZ $r$-matrix for $\widehat{\mathfrak{sl}}_{2,k}$ |
| `thm:km-quantum-groups` | `theorem` | 1614 | Connection to quantum groups |
| `prop:bar-admissible` | `proposition` | 1940 | Bar complex at admissible level |
| `cor:bar-admissible-finiteness` | `corollary` | 2010 | Bar complex finiteness at non-degenerate admissible levels |
| `thm:kw-bar-spectral` | `theorem` | 2098 | Kac--Wakimoto formula via bar spectral sequence |
| `thm:kw-bar-general-rank` | `theorem` | 2210 | KW formula via bar complex: general simple \texorpdfstring{$\mathfrak{g}$}{g} |
| `prop:admissible-verlinde-bar` | `proposition` | 2280 | Admissible fusion rules from bar complex |
| `prop:bar-whittaker` | `proposition` | 2519 | Bar complex via Whittaker resolution |
| `thm:sl2-genus1-curvature` | `theorem` | 2600 | Genus-1 curvature for \texorpdfstring{$\widehat{\mathfrak{sl}}_{2,k}$}{sl-hat_2,k} |
| `thm:sl2-genus1-inversion` | `theorem` | 2665 | Genus-1 bar-cobar inversion for \texorpdfstring{$\widehat{\mathfrak{sl}}_{2,k}$}{sl-hat_2,k} |
| `thm:sl2-genus1-complementarity` | `theorem` | 2717 | Genus-1 complementarity for \texorpdfstring{$\widehat{\mathfrak{sl}}_{2,k}$}{sl-hat_2,k} at generic level |
| `prop:sl2-genus1-partition` | `proposition` | 2783 | Partition function via complementarity |
| `thm:sl3-genus1-curvature` | `theorem` | 2846 | Genus-1 curvature for \texorpdfstring{$\widehat{\mathfrak{sl}}_{3,k}$}{sl-hat_3,k} |
| `thm:sl3-genus1-inversion` | `theorem` | 2892 | Genus-1 bar-cobar inversion for \texorpdfstring{$\widehat{\mathfrak{sl}}_{3,k}$}{sl-hat_3,k} |
| `thm:sl3-genus1-complementarity` | `theorem` | 2931 | Genus-1 complementarity for \texorpdfstring{$\widehat{\mathfrak{sl}}_{3,k}$}{sl-hat_3,k} |
| `prop:sl3-genus1-partition` | `proposition` | 2968 | Partition function for \texorpdfstring{$\widehat{\mathfrak{sl}}_{3,k}$}{sl-hat_3,k} at genus 1 |
| `thm:oper-bar-h0` | `theorem` | 3147 | Oper space from bar complex at \texorpdfstring{$H^0$}{H0} |
| `prop:oper-bar-h1` | `proposition` | 3177 | \texorpdfstring{$H^1$}{H1} at critical level |
| `thm:oper-bar` | `theorem` | 3207 | Full derived oper identification |
| `thm:affine-cubic-normal-form` | `theorem` | 3457 | Affine cubic normal form |
| `cor:affine-postnikov-termination` | `corollary` | 3493 | Affine shadow Postnikov tower: finite termination at arity~$3$ |
| `prop:affine-primitive-kernel` | `proposition` | 3531 | Affine primitive kernel |
| `prop:affine-primitive-shell` | `proposition` | 3573 | Affine primitive shell equations |
| `prop:affine-cyclic-slice-data` | `proposition` | 3643 | Affine cyclic slice data |
| `prop:affine-cubic-ad-invariance` | `proposition` | 3691 | Cubic shadow via ad-invariance |
| `prop:affine-jacobi-quartic-vanishing` | `proposition` | 3748 | Jacobi mechanism for quartic vanishing |
| `prop:affine-sl2-boundary-quartic` | `proposition` | 3825 | Explicit boundary quartic for $\mathfrak{sl}_2$ |
| `prop:affine-sl2-genus-loop` | `proposition` | 3911 | Genus loop for $\mathfrak{sl}_2$ |
| `cor:affine-boundary-quartic` | `corollary` | 3947 | Boundary-generated quartic nonlinearity |
| `thm:affine-genus-loop-weyl` | `theorem` | 4036 | Vanishing of the genus loop on the affine cubic |
| `cor:level-rank-bar-intertwining` | `corollary` | 4254 | Bar-complex intertwining |
| `prop:kappa-anti-symmetry-ff` | `proposition` | 4282 | Kappa anti-symmetry under Feigin--Frenkel involution |
...
| `cor:paired-standard-mc4-closure` | `corollary` | 502 | Minimal closure conditions for the standard-tower MC4 completion target |
| `cor:anomaly-ratio-ds` | `corollary` | 647 | Anomaly ratio and DS reduction |
| `cor:genus1-anomaly-ratio` | `corollary` | 657 | Genus-\texorpdfstring{$1$}{1} free energy and anomaly ratio |
| `prop:bar-dimensions` | `proposition` | 864 | Koszul dual Hilbert functions |
| `cor:subexp-free-field` | `corollary` | 1095 | Sub-exponential growth characterizes free fields |
| `cor:algebraicity-koszul` | `corollary` | 1105 | Algebraicity of bar generating functions for interacting algebras |
| `thm:ds-bar-gf-discriminant` | `theorem` | 1122 | DS reduction and bar cohomology generating functions |
| `thm:ds-spectral-branch-preservation` | `theorem` | 1281 | DS preservation of the sub-discriminant |
| `prop:ds-invariant-discriminant` | `proposition` | 1435 | DS-invariant discriminant subfactor |
| `prop:hred-sl2` | `proposition` | 1479 | Construction of \texorpdfstring{$H^{\mathrm{red}}_1$}{Hred_1} for \texorpdfstring{$\mathfrak{sl}_2$}{sl_2} |
| `prop:discriminant-characteristic` | `proposition` | 1673 | Discriminant as first characteristic invariant |
| `thm:discriminant-linear-dependence` | `theorem` | 1764 | Linear dependence in the discriminant family |
| `prop:linear-relation-functorial` | `proposition` | 1861 | Functorial origin of the linear relation |
| `prop:pole-singularity-type` | `proposition` | 1927 | Pole decomposition and singularity type |
| `lem:bar-deg2-symmetric-square` | `lemma` | 1982 | Degree-\texorpdfstring{$2$}{2} bar cohomology at lowest weight |
| `cor:growth-rate-dimg` | `corollary` | 2033 | Exponential growth rate from Lie algebra dimension |
| `thm:dominant-branch-point` | `theorem` | 2048 | Dominant branch point for Kac--Moody algebras |
| `thm:motzkin-path-model` | `theorem` | 2137 | Motzkin path model for Virasoro bar cohomology |
| `cor:betagamma-inverse-discriminant` | `corollary` | 2326 | {\texorpdfstring{$\beta\gamma$}{beta-gamma} generating function via discriminant} |
| `prop:spectral-collapse-summary` | `proposition` | 2632 | Spectral sequence collapse |
...
| `thm:lattice:e1-vs-einf` | `theorem` | 558 | \texorpdfstring{$\Eone$}{E1} vs.\ \texorpdfstring{$\Einf$}{E-infinity} classification |
| `thm:lattice:bar-structure` | `theorem` | 777 | Lattice bar complex structure |
| `prop:lattice:bar-D4` | `proposition` | 874 | \texorpdfstring{$D_4$}{D4} bar complex and triality |
| `prop:lattice:bar-E8` | `proposition` | 897 | \texorpdfstring{$E_8$}{E8} bar complex and self-duality |
| `thm:lattice:unimodular-self-dual` | `theorem` | 931 | Unimodular lattice self-duality |
| `thm:lattice:koszul-dual` | `theorem` | 965 | Koszul dual of lattice vertex algebra |
| `thm:lattice:koszul-morphism` | `theorem` | 1010 | Koszul morphism for lattice algebras |
| `thm:lattice:direct-sum` | `theorem` | 1096 | Tensor product from direct sum |
| `prop:lattice:sublattice` | `proposition` | 1141 | Sublattice maps |
| `thm:lattice:hochschild` | `theorem` | 1346 | Lattice Hochschild cohomology |
| `cor:lattice:hochschild-unimodular` | `corollary` | 1391 | Unimodular case |
| `prop:lattice:genus-1` | `proposition` | 1433 | Genus-1 partition function |
| `thm:lattice:modular-invariance` | `theorem` | 1456 | Modular invariance |
| `prop:lattice:self-dual-criterion` | `proposition` | 1580 | Koszul self-duality criterion |
| `prop:lattice:D4-triality` | `proposition` | 1597 | \texorpdfstring{$D_4$}{D4} and triality |
| `prop:lattice-module-koszul` | `proposition` | 1622 | Lattice VOA modules under Koszul duality |
| `prop:lattice:deformation-properties` | `proposition` | 1824 | Deformation properties |
| `prop:lattice:ordering-cycle-phase` | `proposition` | 2008 | Phase dependence of the ordering cycle |
| `thm:quantum-lattice-structure` | `theorem` | 2633 | Quantum lattice algebra: structural properties |
| `thm:lattice:e1-bar-cohomology` | `theorem` | 2701 | \texorpdfstring{$\Eone$}{E1} bar cohomology |
| `thm:e1-inversion-principle` | `theorem` | 2775 | \texorpdfstring{$\Eone$}{E1} inversion principle |
| `prop:lattice:screening-structure` | `proposition` | 2934 | Screening current structure |
| `prop:lattice:factorization-decomposition` | `proposition` | 3236 | Lattice factorization decomposition |
| `thm:lattice:factorization-koszul` | `theorem` | 3317 | Lattice factorization Koszul pair |
| `cor:lattice:factorization-dk-level1` | `corollary` | 3490 | Factorization DK at level \texorpdfstring{$1$}{1} |
| `prop:lattice:sectorwise-compactness` | `proposition` | 3687 | Sectorwise compactness |
| `thm:lattice:homotopy-factorization-dk` | `theorem` | 3730 | Homotopy-level lattice factorization DK |
| `prop:lattice:level-k-factorization` | `proposition` | 3888 | Level-\texorpdfstring{$k$}{k} lattice factorization bar-cobar |
| `thm:lattice:level-k-dk` | `theorem` | 3935 | Level-\texorpdfstring{$k$}{k} factorization DK for KM algebras |
| `thm:lattice:quantum-factorization-dk` | `theorem` | 4021 | Quantum lattice factorization DK |
| `prop:lattice:yangian-bridge-level1` | `proposition` | 4102 | Lattice--Yangian DK bridge at level \texorpdfstring{$1$}{1} |
| `prop:lattice:genus1-simple-pole` | `proposition` | 4288 | Simple-pole residues unchanged at genus~$1$ |
| `thm:lattice:curvature-braiding-orthogonal` | `theorem` | 4305 | Curvature-braiding orthogonality for quantum lattice VOAs |
| `cor:lattice-postnikov-termination` | `corollary` | 4402 | Lattice shadow Postnikov tower: termination at weight~$2$ |
...
| `prop:virasoro-primitive-kernel` | `proposition` | 3311 | Virasoro primitive kernel |
| `prop:virasoro-primitive-shell` | `proposition` | 3363 | Virasoro primitive shell equations |
| `thm:w-w3-mixed-shadow` | `theorem` | 3517 | $\mathcal{W}_3$ mixed-shadow normal form |
| `prop:w3-two-dim-hessian-cubic` | `proposition` | 3582 | Two-dimensional Hessian and universal cubic |
| `thm:w3-quartic-channel-decomposition` | `theorem` | 3610 | $\mathcal{W}_3$ quartic channel decomposition |
| `prop:w3-denominator-filtration` | `proposition` | 3673 | Denominator filtration by $W$-charge |
| `thm:w3-quintic-nonvanishing` | `theorem` | 3701 | $\mathcal{W}_3$ quintic nonvanishing |
| `prop:w-w3-weight6-resonance` | `proposition` | 3804 | Weight-$6$ Gram determinant and visible resonance divisor |
| `thm:w-principal-wn-hessian-cubic` | `theorem` | 3875 | Diagonal Hessian and universal cubic for principal $\mathcal{W}_N$ |
| `thm:w-principal-wn-contact-nonvanishing` | `theorem` | 3901 | Nonvanishing of contact quartics for $\mathcal{W}_N$ |
| `thm:w-archetype-trichotomy` | `theorem` | 3977 | Archetype trichotomy |
| `thm:w-virasoro-quintic-forced` | `theorem` | 4044 | Virasoro quintic forced |
| `cor:virasoro-quintic-shadow-explicit` | `corollary` | 4100 | Explicit quintic shadow for Virasoro |
| `thm:virasoro-shadow-generating-function` | `theorem` | 4152 | Virasoro shadow metric |
| `thm:w-finite-termination` | `theorem` | 4337 | Finite termination for primitive archetypes |
| `cor:virasoro-postnikov-nontermination` | `corollary` | 4414 | Virasoro/$\mathcal{W}_N$ shadow Postnikov tower: infinite |
| `thm:w-virasoro-genus1-hessian` | `theorem` | 4452 | Genus-$1$ Hessian correction for Virasoro |
| `prop:w-w3-quintic-obstruction` | `proposition` | 4619 | $\mathcal{W}_3$ quintic obstruction |
| `thm:w-finite-arity-polynomial-pva` | `theorem` | 4941 | Finite-arity theorem for polynomial PVAs |
| `cor:w-semistrictity-classical-w3` | `corollary` | 4979 | Semistrictity of the classical $\mathcal{W}_3$ bulk |
| `prop:w-semistrict-tree-identity` | `proposition` | 5021 | Tree identity for semistrict cyclic theories |
| `prop:w-semistrict-stable-graph` | `proposition` | 5048 | Stable-graph identity for semistrict modular theories |
| `prop:w-semistrict-admissibility` | `proposition` | 5124 | Admissibility of the weight filtration |
| `thm:w-cubic-weight-recursion` | `theorem` | 5149 | Cubic weight recursion |
| `cor:w-cubic-obstruction-classes` | `corollary` | 5183 | Cubic obstruction classes |
| `prop:w-boundary-model-well-defined` | `proposition` | 5221 | Well-definedness |
| `thm:w-semistrict-package` | `theorem` | 5241 | The $\mathcal{W}_3$ semistrict modular higher-spin package |
| `prop:miura-arity-sharp` | `proposition` | 5325 | Miura arity bound is sharp |
| `thm:w-pbw-slodowy-collapse` | `theorem` | 5477 | PBW--Slodowy collapse |
| `cor:w-principal-completed-koszul` | `corollary` | 5538 | Principal $W$-algebras are completed Koszul |
| `thm:w-canonical-arity-detection` | `theorem` | 5604 | Canonical arity detection |
| `thm:w-bp-strict` | `theorem` | 5630 | Bershadsky--Polyakov is strict |
| `thm:w-w4-cubic` | `theorem` | 5680 | $\mathcal{W}_4^{(2)}$ has canonical arity~$3$ |
| `thm:w-full-raw-coefficient-packet` | `theorem` | 5739 | Full raw coefficient packet |
| `thm:w-subregular-appell` | `theorem` | 5798 | Subregular Appell formula |
| `thm:w-unbounded-canonical-arity` | `theorem` | 5836 | Unbounded canonical arity |
| `cor:w-subregular-arity-staircase` | `corollary` | 5865 | The subregular arity staircase |
| `thm:w-subregular-classification` | `theorem` | 5907 | Subregular classification |
...
| `thm:winfty-factorization-kd` | `theorem` | 924 | Factorization Koszul dual of \texorpdfstring{$\mathcal{W}_\infty$}{W_infinity} via DS--sectorwise convergence |
| `prop:w3-deg3-vacuum` | `proposition` | 1433 | \texorpdfstring{$\mathcal{W}_3$}{W_3} degree-3 vacuum cancellation |
| `prop:ds-koszul-hierarchy` | `proposition` | 1643 | DS hierarchy and Koszul duality: proved cases |
| `prop:ds-bar-formality` | `proposition` | 1724 | DS--bar commutation via filtration formality |
| `thm:transport-closure-type-a` | `theorem` | 1795 | Transport-closure in type $A$ |
| `prop:partition-dependent-complementarity` | `proposition` | 1859 | Partition-dependent complementarity constant |
| `thm:ds-platonic-functor` | `theorem` | 1901 | DS reduction as a functor on platonic packages |
| `cor:ds-theta-descent` | `corollary` | 2117 | DS descent of the universal MC element |
| `comp:wn-stabilization-windows` | `computation` | 2217 | Coefficient stabilization windows for $\mathcal{W}_N$ |
| `prop:abelian-locus-type-a` | `proposition` | 2287 | Abelian locus in type~$A$ |
| `prop:abelianity-complementarity-independence` | `proposition` | 2329 | Independence of abelianity and complementarity |
| `prop:bfn-slodowy-dimensions` | `proposition` | 2397 | BFN--Slodowy dimension matching |
| `prop:ghost-constant-monotonicity` | `proposition` | 2470 | Ghost constant monotonicity |
| `thm:winfty-scalar` | `theorem` | 2618 | Scalar saturation of $\mathcal{W}_\infty$: the shadow tower collapses |
| `prop:gram-wt4` | `proposition` | 2769 | Weight-$4$ Gram matrix |
| `cor:lambda-qp` | `corollary` | 2834 | Quasi-primary at weight~$4$ |
| `thm:c334` | `theorem` | 2877 | Structure constant of the $\mathcal{W}_4$ algebra |
| `prop:virasoro-primitive` | `proposition` | 3060 | Virasoro primitive series |
| `prop:virasoro-bar-window` | `proposition` | 3121 | Virasoro bar windows |
| `prop:virasoro-entropy` | `proposition` | 3162 | Virasoro Koszul entropy |
| `prop:w3-basis-weight3` | `proposition` | 3265 | $\Walg_3$ exact bar basis at reduced weight~$3$ |
| `prop:w3-entropy` | `proposition` | 3298 | $\Walg_3$ Koszul entropy |
| `prop:wn-character-primitive` | `proposition` | 3319 | $\Walg_N$ character and primitive series |
| `prop:wn-entropy-ladder` | `proposition` | 3351 | $\Walg_N$ entropy ladder |
| `prop:winfty-macmahon` | `proposition` | 3457 | $\Walg_\infty$ character and MacMahon factorization |
| `prop:winfty-bar-window` | `proposition` | 3493 | $\Walg_\infty$ bar-window series and Koszul entropy |

#### `chapters/examples/yangians_computations.tex` (41)

| Label | Env | Line | Title |
|---|---|---:|---|
| `prop:yangian-rank-dependence` | `proposition` | 521 | Rank dependence of Yangian bar complex |
| `prop:eval-module-bar` | `proposition` | 658 | Evaluation module bar complex |
| `thm:yangian-bgg` | `theorem` | 747 | Yangian BGG resolution |
| `cor:yangian-ext-exchange` | `corollary` | 803 | Ext exchange for Yangian modules |
| `prop:yangian-dk2-thick-generation` | `proposition` | 853 | DK-2 reduction to thick generation in category~\texorpdfstring{$\mathcal{O}$}{O} |
| `prop:dk2-thick-generation-typeA` | `proposition` | 905 | Thick generation by evaluation modules in type~\texorpdfstring{$A$}{A} |
| `lem:composition-thick-generation` | `lemma` | 999 | Thick generation from finite composition series |
| `thm:catO-thick-generation` | `theorem` | 1030 | Thick generation of category~\texorpdfstring{$\mathcal{O}$}{O} by evaluation modules, type~\texorpdfstring{$A$}{A} |
| `prop:bar-cobar-kazhdan-candidate` | `proposition` | 1114 | Bar-cobar as factorization Kazhdan candidate |
| `lem:monoidal-thick-extension` | `lemma` | 1216 | Monoidal extension to thick closures |
| `thm:dk-fd-typeA` | `theorem` | 1238 | Finite-dimensional factorization Drinfeld--Kohno, type~\texorpdfstring{$A$}{A} |
| `cor:dk-partial-conj` | `corollary` | 1313 | Partial resolution of Conjecture~\textup{\ref{conj:full-derived-dk}} |
| `cor:dk-poly-catO` | `corollary` | 1332 | Factorization DK for polynomial category~\texorpdfstring{$\mathcal{O}$}{O}, type~\texorpdfstring{$A$}{A} |
| `lem:fd-thick-closure` | `lemma` | 1404 | Finite-dimensional thick-closure constraint |
| `prop:yangian-bar-loop-weight` | `proposition` | 1490 | Loop-weight filtration of the Yangian bar complex |
| `prop:thick-gen-projective` | `proposition` | 1741 | Thick generation via projective resolutions |
| `prop:bgg-criterion` | `proposition` | 1871 | BGG resolution criterion for thick generation |
| `prop:heart-capture-criterion` | `proposition` | 2029 | Heart-capture criterion |
| `prop:standard-capture-criterion` | `proposition` | 2049 | Standard-capture criterion |
| `cor:sectorwise-localizing-generation` | `corollary` | 2074 | Sectorwise localizing generation |
| `thm:eval-core-identification` | `theorem` | 2247 | Evaluation-generated core identification, type~\texorpdfstring{$A$}{A} |
| `thm:baxter-exact-triangles-opoly` | `theorem` | 2309 | Baxter exact triangles on \texorpdfstring{$\mathcal{O}_{\mathrm{poly}}$}{Opoly} |
| `prop:baxter-yangian-equivariance` | `proposition` | 2391 | Yangian equivariance of the Baxter singular vector |
| `cor:baxter-naturality-opoly` | `corollary` | 2465 | Naturality on $\mathcal{O}_{\mathrm{poly}}$ |
| `thm:shifted-prefundamental-generation` | `theorem` | 2510 | $E_1$-chiral thick generation for $Y(\mathfrak{sl}_N)$ |
| `prop:prefundamental-clebsch-gordan` | `proposition` | 2736 | Universal prefundamental Clebsch--Gordan |
| `cor:universal-character-containment` | `corollary` | 2776 | Universal character containment |
| `cor:k0-generation-OY` | `corollary` | 2789 | $K_0$ generation for all simple types |
| `thm:mc3-type-a-resolution` | `theorem` | 3085 | MC3 resolution in type $A$ |
| `prop:mc3-automatic-generalization` | `proposition` | 3190 | Automatic generalization of MC3 proof steps |
| `prop:e8-root-uniformity` | `proposition` | 3233 | $E_8$ relevant-root uniformity |
| `prop:character-cg-all-types` | `proposition` | 3243 | Character-level Clebsch--Gordan for all simple types |
| `thm:yangian-vector-seed-propagation` | `theorem` | 3587 | Propagation from the vector seed |
| `cor:compact-core-rigidity` | `corollary` | 3617 | Compact-core rigidity |
| `prop:yangian-failure-unweighted` | `proposition` | 3640 | Failure of unweighted stabilization |
| `thm:yangian-weightwise-MC4` | `theorem` | 3655 | Weightwise MC4 for the principal RTT tower |
| `thm:yangian-baxter-rees-algebraicity` | `theorem` | 3706 | Algebraicity of the Baxter--Rees family |
| `thm:yangian-generic-boundary-fibers` | `theorem` | 3731 | Generic and boundary fibers |
| `prop:baxter-rees-derived-realization` | `proposition` | 3758 | Derived realization of the Baxter--Rees family |
| `thm:yangian-H2-reduction` | `theorem` | 3825 | $H^2$-reduction to the three-leg sector |
| `prop:yangian-baxter-KS-cocycle` | `proposition` | 3902 | Concrete cocycle |
...
| `thm:sectorwise-spectral-convergence` | `theorem` | 612 | Sectorwise spectral convergence |
| `thm:h-level-factorization-kd` | `theorem` | 661 | \texorpdfstring{$\infty$}{infinity}-categorical factorization Koszul duality via sectorwise convergence |
| `cor:dk23-all-types` | `corollary` | 798 | DK-2/3 for all simple types via sectorwise convergence |
| `prop:yangian-canonical-hlevel-target` | `proposition` | 986 | Canonical Yangian H-level dg target from factorization formal moduli |
| `prop:yangian-canonical-envelope` | `proposition` | 1027 | Canonical associative dg model of the Yangian formal-moduli target |
| `thm:factorization-positselski` | `theorem` | 1297 | Factorization Positselski equivalence |
| `thm:ind-completed-extension` | `theorem` | 1418 | Ind-completed factorization DK equivalence |
| `prop:finite-stage-tangent` | `proposition` | 1620 | Finite-stage tangent Lie algebras |
| `thm:rtt-mittag-leffler` | `theorem` | 1727 | Mittag-Leffler for the RTT bar cohomology tower |
| `cor:completed-bar-cobar-yangian` | `corollary` | 1825 | Completed bar-cobar equivalence for Yangians |
| `prop:dg-shifted-quotient-criterion` | `proposition` | 2043 | Formal quotient criterion for dg-shifted Yangians |
| `prop:yangian-dk-mc4-reduction` | `proposition` | 2126 | Formal reduction principle from DK-3 to DK-4/DK-5 |
| `thm:bridge-criterion` | `theorem` | 2293 | Bridge Criterion Theorem |
| `prop:yangian-dk4-typea-frontier` | `proposition` | 2445 | DK-4 reduction to the fundamental residue packet in standard type~A |
| `prop:yangian-dk5-compact-generators` | `proposition` | 2562 | DK-5 reduction to compact-generator comparison |
| `prop:yangian-dk5-fundamental-packet` | `proposition` | 2621 | Compact-core comparison reduces to the completed fundamental packet |
| `prop:yangian-dk5-ind-extension` | `proposition` | 2704 | DK-5 comparison functor is the ind-extension of the compact core |
| `cor:yangian-dk5-compact-core` | `corollary` | 2785 | DK-5 reduces to the compact-core equivalence |
| `cor:yangian-dk5-fundamental-packet` | `corollary` | 2816 | DK-5 reduces to compact generation plus completed fundamental-packet transport |
| `prop:yangian-dk5-core-realization` | `proposition` | 2853 | Compact-core DK-5 functors from realization of the proved finite-dimensional factorization DK core |
| `lem:yangian-fd-fundamental-generation` | `lemma` | 2920 | Finite-dimensional Yangian factorization core is generated by fundamental evaluation objects |
| `lem:quantum-fd-fundamental-generation` | `lemma` | 2950 | Finite-dimensional quantum-group factorization core is generated by fundamental evaluation objects |
| `prop:yangian-dk5-spectral-realization-formal` | `proposition` | 2981 | Spectral compact-core realization is formal from generator transport |
| `prop:yangian-dk5-spectral-fundamental-packet` | `proposition` | 3040 | On the spectral side, ordered tensor-generator transport is forced by the completed fundamental packet |
| `lem:quantum-fd-vector-fundamental-generation` | `lemma` | 3119 | Type-\texorpdfstring{$A$}{A} quantum-group fundamental packet is generated by the vector evaluation line |
| `prop:yangian-dk5-spectral-vector-packet` | `proposition` | 3148 | On the spectral side, the completed fundamental packet is forced by the completed vector packet |
| `prop:yangian-dk5-spectral-vector-line` | `proposition` | 3215 | On the spectral side, ordered vector-packet transport is forced by the completed vector line |
| `prop:quantum-fd-vector-seed-shifts` | `proposition` | 3247 | Standard quantum-loop vector seed and additive log-spectral shifts |
| `lem:quantum-fd-vector-seed-schur` | `lemma` | 3285 | Quantum-loop vector seed is Schur-simple |
| `prop:yangian-dk5-spectral-vector-seed` | `proposition` | 3300 | On the spectral side, the completed vector line is forced by one completed vector seed together with spectral shifts |
| `prop:yangian-dk5-spectral-seed-shift-construction` | `proposition` | 3350 | On the realized spectral vector-line locus, the completed vector seed and spectral shifts are canonical |
| `prop:yangian-dk5-spectral-core-shifts` | `proposition` | 3407 | On the realized spectral vector-line locus, loop rotation descends to the full spectral compact core |
| `prop:yangian-dk5-spectral-factorization-shifts` | `proposition` | 3454 | Factorization-locus specializations: \texorpdfstring{$\rho_a$}{rho\_a} pullback, core from vector line, seed-line forcing |
| `cor:yangian-dk5-spectral-seed-realization` | `corollary` | 3545 | One-seed closure: four variants |
| `cor:yangian-dk5-spectral-factorization-schur-seed-line` | `corollary` | 3645 | Schur-simple ambient seed criterion for the multiplicative spectral vector line |
| `cor:yangian-dk5-spectral-factorization-ambient-one-seed` | `corollary` | 3685 | One ambient multiplicative vector seed closes the spectral DK-5 side |
| `cor:yangian-dk5-spectral-factorization-ambient-schur-seed` | `corollary` | 3721 | One Schur-simple ambient multiplicative vector seed closes the spectral DK-5 side |
| `prop:yangian-dk5-spectral-factorization-seed-mono` | `theorem` | 3748 | Spectral DK-5 seed-pair reduction hierarchy |
| `cor:yangian-dk5-spectral-packet-ind` | `corollary` | 3891 | On the realized spectral packet locus, the ambient spectral category is the ind-completion of the spectral compact core |
| `prop:yangian-dg-fundamental-packet-realization` | `proposition` | 3923 | Canonical completed dg fundamental packet from the theorematic finite RTT quotients |
| `prop:yangian-dk5-dg-extension-existence` | `proposition` | 3973 | Canonical exact braided-monoidal extension of the dg packet |
| `prop:yangian-dk5-dg-realization-formal` | `proposition` | 4011 | dg compact-core realization is formal from extension of the completed fundamental packet |
| `cor:yangian-dk5-dg-packet-ind` | `corollary` | 4038 | Compact generation of the completed dg module category identifies the ambient dg side with the ind-completion of the dg compact core |
| `cor:yangian-dk5-dg-half-only` | `corollary` | 4071 | Given dg compact-core realization, the remaining DK-5 input is spectral vector seed-and-shift realization |
| `cor:yangian-dk5-core-realization` | `corollary` | 4109 | DK-5 closes once the compact cores realize the proved finite-dimensional factorization DK core |
| `cor:yangian-typea-mc4-closure-criterion` | `corollary` | 4135 | Type-\texorpdfstring{$A$}{A} MC4 reduction chain: five closure criteria |
| `prop:yangian-tower-mc4-criterion` | `proposition` | 4331 | Yangian tower criterion from finite RTT stages |
| `cor:yangian-weight-cutoff` | `corollary` | 4394 | Standard RTT cutoff for Yangian towers |
| `prop:yangian-rtt-completion-identification` | `proposition` | 4429 | Inverse-limit identification of the standard RTT completion |
| `cor:yangian-standard-mc4-package` | `corollary` | 4483 | Standard RTT tower satisfies the M-level MC4 package |
| `cor:yangian-hlevel-comparison-criterion` | `corollary` | 4516 | H-level comparison criterion for dg-shifted Yangians |
| `prop:yangian-typea-realization-criterion` | `proposition` | 4575 | Standard type-\texorpdfstring{$A$}{A} realization criterion from shared bar seed and finite RTT quotients |
| `thm:yangian-dk45-closure-variants` | `theorem` | 4650 | Standard type-\texorpdfstring{$A$}{A} Yangian DK-4/DK-5 closure: seven variant hypotheses |
| `cor:yangian-typea-realization-plus-compacts-orig` | `corollary` | 4806 | Standard type-\texorpdfstring{$A$}{A} DK-4/DK-5 closure from realization and compact core |
| `cor:yangian-typea-realization-plus-fundamental-packet-orig` | `corollary` | 4835 | Standard type-\texorpdfstring{$A$}{A} DK-4/DK-5 closure from realization and completed fundamental packet |
| `cor:yangian-typea-realization-plus-core-realization-orig` | `corollary` | 4868 | Standard type-\texorpdfstring{$A$}{A} DK-4/DK-5 closure from dg-shifted realization and compact-core realization of the proved finite-dimensional factorization DK core |
| `cor:yangian-formal-moduli-plus-core-realization-orig` | `corollary` | 4899 | Canonical formal-moduli Yangian target closes DK-4/DK-5 once the compact cores realize the proved finite-dimensional DK core |
| `cor:yangian-typea-realization-plus-dg-packet-orig` | `corollary` | 4950 | Standard type-\texorpdfstring{$A$}{A} DK-4/DK-5 closure from spectral vector-line realization |
| `cor:yangian-canonical-realization-to-spectral-seed` | `corollary` | 5057 | Canonical formal-moduli Yangian target: exact remaining input after RTT-adapted realization |
| `cor:yangian-canonical-realization-to-single-line` | `corollary` | 5156 | Canonical formal-moduli Yangian target: the local spectral packet contracts to one mixed-tensor line on the equivariant multiplicative locus |
| `cor:yangian-canonical-realization-to-exchange` | `corollary` | 5217 | Canonical formal-moduli Yangian target: the local spectral packet contracts to one exchange coefficient family on the equivariant multiplicative locus |
| `cor:yangian-canonical-realization-to-exchange-mult` | `corollary` | 5267 | Canonical formal-moduli Yangian target: the local spectral packet descends to one multiplicative-ratio scalar family |
| `cor:yangian-canonical-realization-to-alt-mult` | `corollary` | 5326 | Canonical formal-moduli Yangian target: the local spectral packet is the antisymmetric-channel character on the multiplicative spectral line |
| `cor:yangian-canonical-realization-plus-one-seed-orig` | `corollary` | 5369 | Canonical formal-moduli Yangian target closes DK-4/DK-5 from one canonical spectral seed on the equivariant multiplicative locus |
| `cor:yangian-canonical-realization-plus-vector-line-orig` | `corollary` | 5402 | Canonical formal-moduli Yangian target closes DK-4/DK-5 from spectral vector-line realization |
| `prop:free-propagator-matching` | `proposition` | 6082 | Free/$\beta\gamma$ propagator matching |
| `prop:affine-propagator-matching` | `proposition` | 6128 | Affine $\hat{\mathfrak{sl}}_2$ propagator matching |
| `thm:spectral-derived-additive-kz` | `theorem` | 6296 | Derived additive KZ connection |
| `thm:spectral-boundary-residue` | `theorem` | 6347 | Boundary residue theorem |
| `thm:spectral-transfer-flat` | `theorem` | 6399 | Transfer of flat spectral connections |
| `thm:spectral-quasi-factorization` | `theorem` | 6473 | Quasi-factorization theorem |
| `thm:spectral-strictification-cohomology` | `theorem` | 6557 | Strictification by spectral cohomology |
| `thm:spectral-triangle-localization` | `theorem` | 6615 | Triangle localization |
| `thm:spectral-quadrilateral-localization` | `theorem` | 6657 | Quadrilateral localization |
| `lem:class3-bch-spectral` | `lemma` | 6692 | Class-$3$ ordered BCH coefficient |
| `thm:spectral-cartan-diagonal-exact` | `theorem` | 6747 | Cartan-diagonal Drinfeld class is exact |
| `thm:spectral-abelian-strictification` | `theorem` | 6819 | Abelian strictification |
| `thm:spectral-residue-bounded-completion` | `theorem` | 6843 | Residue-bounded completion |
| `prop:spectral-exact-free-transport` | `proposition` | 6884 | Exact free transport |
| `thm:spectral-conditional-strictification` | `theorem` | 6918 | Conditional strictification criterion |
...
| `cor:conformal-vector-infinite-depth` | `corollary` | 1029 | Conformal vector implies infinite depth |
| `thm:shadow-tower-asymptotics` | `theorem` | 1052 | Shadow tower leading asymptotics |
| `cor:rigorous-infinite-depth` | `corollary` | 1084 | Rigorous infinite depth |
| `prop:bg-primary-counting` | `proposition` | 1119 | $\beta\gamma$ primary-counting function |
| `thm:refined-shadow-spectral` | `theorem` | 1132 | Refined shadow--spectral correspondence |
| `prop:ising-d-arith` | `proposition` | 1162 | Ising model: $d_{\mathrm{arith}} = 0$ |
| `rem:non-unimodular` | `remark` | 1211 | Non-unimodular lattices |
| `thm:depth-decomposition` | `theorem` | 1280 | Depth decomposition |
| `thm:ainfty-formality-depth` | `theorem` | 1377 | $A_\infty$ formality criterion |
| `thm:interacting-gram-positivity` | `theorem` | 1435 | Interacting Gram positivity |
| `cor:virasoro-interacting-gram` | `corollary` | 1475 | — |
| `thm:shadow-resonance-locus` | `theorem` | 1488 | — |
| `prop:shadow-spectral-measure` | `theorem` | 1526 | Shadow spectral measure |
| `prop:carleman-virasoro` | `proposition` | 1592 | Carleman rigidity |
| `prop:shadow-periods` | `proposition` | 1629 | Shadow amplitudes are periods |
| `thm:spectral-curve` | `theorem` | 1773 | Algebraic shadow generating function |
| `prop:moment-matrix-negativity` | `proposition` | 1815 | Eisenstein moment minor |
| `thm:shadow-higgs-field` | `theorem` | 1848 | Shadow Higgs field |
| `thm:general-nahc` | `theorem` | 1929 | General shadow triple |
| `thm:shadow-bps` | `theorem` | 2096 | The shadow tower as BPS spectrum |
| `thm:general-bps` | `theorem` | 2175 | General BPS spectrum of the shadow tower |
| `thm:sewing-shadow-intertwining` | `theorem` | 2220 | Sewing--shadow intertwining at genus~$1$ |
| `cor:shadow-fredholm` | `corollary` | 2295 | Shadow Fredholm determinant |
| `cor:spectral-measure-identification` | `corollary` | 2332 | Spectral measure identification |
| `sec:shadow-moduli-resolution` | `theorem` | 2386 | Shadow-moduli resolution |
| `thm:universality-of-G` | `theorem` | 2476 | Universality of $G$ |
| `prop:mc-bracket-determines-atoms` | `proposition` | 2544 | MC bracket determines spectral atoms |
| `rem:mc-ramanujan-bridge` | `remark` | 2594 | The bridge to the Ramanujan bound |
| `thm:spectral-continuation-bridge` | `theorem` | 2639 | Hecke-equivariant MC element |
| `thm:schur-complement-quartic` | `theorem` | 2778 | — |
| `prop:virasoro-quartic-determinant` | `proposition` | 2837 | — |
| `prop:on-off-line-distinction` | `proposition` | 2914 | — |
| `prop:pure-spin-s-schur` | `proposition` | 3174 | — |
| `prop:modularity-constraint` | `proposition` | 3256 | Modularity constraint on the spectral measure |
| `sec:bracket-hodge-index` | `proposition` | 3299 | Bracket positivity and the Hodge index |
| `sec:proved-regime-ramanujan` | `proposition` | 3425 | Ramanujan bound for lattice spectral measures |
| `sec:symmetric-power-route` | `proposition` | 3468 | Shadow--symmetric power identification |
| `thm:petersson-identification` | `theorem` | 3616 | Petersson identification |
| `prop:modularity-constraint-atoms` | `proposition` | 3689 | Modularity constraint on atoms |
| `prop:rigidity-threshold` | `proposition` | 3726 | Rigidity threshold |
| `prop:lattice-ramanujan-rigidity` | `proposition` | 3765 | Lattice Ramanujan from rigidity |
| `thm:cps-from-mc` | `theorem` | 3814 | CPS hypotheses from MC $+$ HS-sewing |
| `cor:moment-automorphy` | `corollary` | 3861 | Automorphy of moment $L$-functions |
...
| `thm:hecke-verdier-commutation` | `theorem` | 4696 | Verdier--Hecke commutation at genus~$1$ |
| `thm:self-dual-factorization` | `theorem` | 4735 | Self-dual factorisation |
| `prop:theta-bridge-rational` | `proposition` | 4810 | Theta decomposition bridge |
| `prop:newton-shadow-hecke` | `proposition` | 4873 | Newton--shadow--Hecke correspondence |
| `prop:sewing-spectral-bridge` | `proposition` | 4991 | Sewing--spectral determinant bridge |
| `prop:rs-analytic-continuation` | `proposition` | 5096 | Meromorphic continuation of the RS integral |
| `prop:scattering-residue` | `proposition` | 5143 | Holomorphy at scattering poles |
| `prop:arith-geom-decomposition` | `proposition` | 5201 | Arithmetic--geometric decomposition |
| `prop:genus-one-saddle-triviality` | `proposition` | 5377 | Genus-one saddle triviality |
| `cor:first-scattering-pole` | `corollary` | 5577 | Nonvanishing at the first scattering pole |
...
| `prop:finite-jet-rigidity` | `proposition` | 581 | Finite-jet rigidity |
| `prop:polynomial-level-dependence` | `proposition` | 605 | Polynomial level dependence |
| `prop:gaussian-collapse-abelian` | `proposition` | 642 | Gaussian collapse for abelian input |
| `prop:five-theorems-mc-projections` | `proposition` | 1669 | Five main theorems as MC projections |
| `thm:operadic-complexity` | `theorem` | 1810 | Operadic complexity |
| `thm:lagrangian-complementarity` | `theorem` | 3216 | Lagrangian complementarity |
| `thm:universal-MC` | `theorem` | 3481 | Universal MC class |
| `thm:discriminant-spectral-verified` | `theorem` | 3818 | Discriminant as spectral determinant --- verified cases |
| `thm:discriminant-spectral` | `theorem` | 3863 | Spectral discriminant --- general case |
| `comp:spectral-discriminants-standard` | `computation` | 4087 | Spectral discriminants of standard families |
| `thm:family-index` | `theorem` | 4152 | Family index theorem for genus expansions |
| `rem:programme-vi-verification` | `remark` | 4978 | Programme VI: systematic verification of (H1)--(H4) |
...
| `thm:full-modular-invariant-hierarchy` | `theorem` | 1194 | The full modular invariant hierarchy |
| `prop:hs-trace-class` | `proposition` | 1355 | Closed amplitudes are trace class |
| `thm:general-hs-sewing` | `theorem` | 1370 | General HS-sewing criterion |
| `cor:hs-sewing-standard-landscape` | `corollary` | 1402 | Standard landscape |
| `cor:hs-implies-gram` | `corollary` | 1440 | — |
| `thm:heisenberg-one-particle-sewing` | `theorem` | 1459 | Heisenberg: one-particle sewing |
| `prop:analytic-conilpotency` | `proposition` | 1535 | Positive grading implies conilpotency |
| `prop:dirichlet-weight-formula` | `theorem` | 1837 | — |
| `cor:virasoro-mode-removal` | `corollary` | 1895 | — |
| `prop:euler-koszul-criterion` | `theorem` | 1954 | — |
| `comp:euler-koszul-defect-table` | `computation` | 1991 | Euler--Koszul defect table for the standard landscape |
| `prop:zeta-zeros-defect-derivative` | `proposition` | 2083 | — |
| `thm:li-closed-form` | `theorem` | 2121 | — |
| `prop:li-asymptotics` | `theorem` | 2154 | — |
| `prop:surface-moment-positivity` | `theorem` | 2282 | Gram positivity |
| `cor:virasoro-gram-ratio` | `corollary` | 2305 | — |
| `thm:sewing-rkhs` | `theorem` | 2340 | Sewing RKHS |
| `rem:benjamin-chang-bridge` | `proposition` | 2407 | — |
| `thm:shadow-euler-independence` | `theorem` | 2433 | — |
| `rem:two-faces-theta` | `corollary` | 2490 | — |
| `thm:euler-koszul-tier-classification` | `theorem` | 2572 | — |
| `thm:sewing-hecke-reciprocity` | `theorem` | 2653 | Sewing--Hecke reciprocity |
...
| `prop:virasoro-shadow-coefficients` | `proposition` | 1321 | Virasoro shadow coefficients |
| `cor:shadow-asymptotic-decay` | `corollary` | 1374 | Asymptotic shadow decay |
| `comp:virasoro-shadow-table` | `computation` | 1419 | Virasoro shadow coefficients through arity~$10$ |
| `prop:wn-class-m` | `proposition` | 1538 | $\Walg_N$ is class~\textbf{M} for $N \geq 2$ |
| `prop:postnikov-filtration-structure` | `proposition` | 1599 | Structure of the Postnikov filtration |
| `prop:mc-formal-moduli` | `proposition` | 1644 | The MC moduli as a formal moduli problem |
| `thm:holographic-reconstruction` | `theorem` | 1689 | Holographic reconstruction theorem |
| `prop:shapovalov-shadow-singularities` | `proposition` | 1818 | Shapovalov singularities of the shadow tower |
| `prop:pole-structure-shadow-series` | `proposition` | 1855 | Pole structure of the full shadow series |
| `comp:shapovalov-zeros-shadow` | `computation` | 1910 | Shapovalov zeros and shadow singularities |
| `thm:complexity-hierarchy` | `theorem` | 1992 | Complexity hierarchy |
...
| `prop:polyakov-chern-weil` | `proposition` | 1730 | Polyakov formula as Chern--Weil image of the arity-$2$ shadow |
| `prop:thqg-I-pole-structure` | `proposition` | 1772 | Pole structure of the meromorphic continuation |
| `prop:thqg-I-tensor-product` | `proposition` | 1878 | Finiteness for tensor-product theories |
| `comp:thqg-I-fp-detailed` | `computation` | 1933 | Faber--Pandharipande coefficients through genus $15$ |
| `prop:thqg-I-asymptotic-precision` | `proposition` | 1968 | Asymptotic precision |
| `prop:thqg-I-fp-monotone` | `proposition` | 1984 | Monotonicity of the FP coefficients |
...
| Label | Env | Line | Title |
|---|---|---:|---|
| `__unlabeled_appendices/casimir_divisor_core_transport.tex:70` | `proposition` | 70 | Universal property |
| `thm:divisor-core-calculus` | `theorem` | 113 | Divisor-core calculus |
| `__unlabeled_appendices/casimir_divisor_core_transport.tex:194` | `corollary` | 194 | Divisors classify submodules |
| `thm:hom-equals-gcd` | `theorem` | 216 | Hom \(=\) gcd |
| `thm:factorization-through-common-core` | `theorem` | 278 | Universal factorization through the maximal common core |
| `cor:spectral-defects` | `corollary` | 315 | Spectral defects |
| `thm:primary-jordan-filtration` | `theorem` | 354 | Primary Jordan filtration |
| `__unlabeled_appendices/casimir_divisor_core_transport.tex:391` | `corollary` | 391 | Repeated roots are extension data |
| `thm:squarefree-sheet` | `theorem` | 415 | Squarefree spectral sheet theorem |
| `prop:coprime-functional-calculus` | `proposition` | 442 | Coprime-locus functional calculus |
| `prop:no-projector` | `proposition` | 471 | No universal polynomial projector off the coprime locus |
| `thm:minimal-intrinsic-realization` | `theorem` | 544 | Minimal intrinsic realization |
| `lem:generic-separator` | `lemma` | 592 | Generic Casimir separator |
| `thm:casimir-moment-reconstruction` | `theorem` | 618 | Casimir moment reconstruction |
| `cor:finite-scalar-probes` | `corollary` | 669 | Finite scalar probes suffice |
| `thm:pbw-recurrence` | `theorem` | 749 | PBW recurrence theorem |
| `thm:growth-mode-factorization` | `theorem` | 872 | Growth-mode factorization |
| `cor:growth-ds-divisor-cores` | `corollary` | 935 | Divisor-core interpretation of the factorization |
| `thm:sector-determinant` | `theorem` | 1014 | Characteristic polynomial of a sector |
| `thm:common-core-exact-sequences` | `theorem` | 1063 | Common-core exact sequences |
| `prop:transport-factors-through-common-core` | `proposition` | 1087 | Shift-compatible transport factors through the common core |
| `__unlabeled_appendices/casimir_divisor_core_transport.tex:1110` | `corollary` | 1110 | Corrected transport principle |
| `prop:squarefree-common-sector` | `proposition` | 1120 | Squarefree common-sector rigidity |
| `prop:sl3-w3-defect` | `proposition` | 1202 | Exact defect decomposition for \(\widehat{\mathfrak{sl}}_3/W_3\) |
| `__unlabeled_appendices/casimir_divisor_core_transport.tex:1224` | `corollary` | 1224 | All transport maps factor through the quadratic core |
| `prop:explicit-sl3-projectors` | `proposition` | 1243 | Explicit coprime-locus projectors |
| `__unlabeled_appendices/casimir_divisor_core_transport.tex:1323` | `proposition` | 1323 | The \(L_1\)--\(L_2\) package on the one-channel squarefree locus |
...
| Label | Env | Line | Title |
|---|---|---:|---|
| `thm:derived-additive-kz` | `theorem` | 146 | Derived additive KZ connection |
| `__unlabeled_appendices/dg_shifted_factorization_bridge.tex:202` | `corollary` | 202 | Derived Drinfeld--Kohno shadow |
| `thm:boundary-residue` | `theorem` | 212 | Boundary residue theorem |
| `thm:transfer-flat-spectral` | `theorem` | 254 | Transfer of flat spectral connections |
| `thm:quasi-factorization` | `theorem` | 321 | Quasi-factorization theorem |
| `thm:strictification-spectral-cohomology` | `theorem` | 380 | Strictification by spectral cohomology |
| `__unlabeled_appendices/dg_shifted_factorization_bridge.tex:425` | `proposition` | 425 | Quadratic hexagon obstruction |
| `__unlabeled_appendices/dg_shifted_factorization_bridge.tex:454` | `proposition` | 454 | Three-particle obstruction identity |
| `thm:abelian-strictification` | `theorem` | 492 | Abelian strictification theorem |
| `thm:residue-bounded-completion` | `theorem` | 512 | Residue-bounded completion theorem |
| `prop:cartan-shift-cocycle` | `proposition` | 565 | Cartan shift cocycle identities |
| `thm:cartan-gauge-twist` | `theorem` | 583 | Cartan gauge-twist theorem |
| `thm:cartan-diagonal-defect-exact` | `theorem` | 626 | Cartan-diagonal shift defect is exact |
| `thm:triangle-localization` | `theorem` | 698 | Triangle localization formula |
| `thm:adjacent-root-rigidity` | `theorem` | 760 | Adjacent-root rigidity |
| `__unlabeled_appendices/dg_shifted_factorization_bridge.tex:779` | `corollary` | 779 | Normalized rational triangle coefficient |
| `prop:triangle-shift-transport` | `proposition` | 824 | Triangle shift transport law |
| `lem:free-closed-generating-kernel` | `lemma` | 875 | Closed generating kernel |
| `thm:exact-free-transport` | `theorem` | 905 | Exact free two-body transport |
| `lem:class3-ordered-bch` | `lemma` | 979 | Class-$3$ ordered BCH coefficient |
| `thm:quadrilateral-localization` | `theorem` | 1014 | Quadrilateral localization formula |
| `thm:quadrilateral-rigidity` | `theorem` | 1106 | Quadrilateral rigidity |
| `cor:quadrilateral-normalized-rational` | `corollary` | 1134 | Normalized rational quadrilateral coefficient |
| `prop:quadrilateral-shift-transport` | `proposition` | 1170 | Quadrilateral shift transport law |
| `cor:no-new-filtration3-shift-obstruction` | `corollary` | 1200 | No new independent shift obstruction in filtration $3$ |
| `__unlabeled_appendices/dg_shifted_factorization_bridge.tex:1235` | `theorem` | 1235 | Conditional strictification criterion |
...
| `thm:nms-affine-cubic-normal-form` | `theorem` | 977 | Affine cubic normal form |
| `cor:nms-affine-boundary-tree` | `corollary` | 1001 | Boundary-generated quartic nonlinearity |
| `thm:nms-betagamma-quartic-birth` | `theorem` | 1068 | \texorpdfstring{$\beta\gamma$}{betagamma} quartic birth |
| `cor:nms-betagamma-mu-vanishing` | `corollary` | 1092 | Vanishing of the quartic contact invariant |
| `cor:nms-betagamma-boundary-law` | `corollary` | 1116 | Pure contact boundary law |
| `thm:nms-archetype-trichotomy` | `theorem` | 1133 | Primitive nonlinear archetype trichotomy |
...
| `thm:nms-beyond-ahat` | `theorem` | 2250 | The modular invariant hierarchy beyond $\hat{A}$ |
| `thm:nms-unified-summary` | `theorem` | 2284 | Ambient complementarity and nonlinear modular shadows |
| `conj:nms-all-arity-resonance-boundary` | `theorem` | 2453 | All-arity boundary law for the resonance tower |
| `prop:nms-nonlinear-phase-standard` | `proposition` | 2564 | Nonlinear phase of the standard families |
| `thm:nms-bipartite-complementarity` | `theorem` | 2653 | Bipartite complementarity principle |
| `thm:nms-bipartite-vanishing` | `theorem` | 2758 | Bipartite vanishing theorem |
| `prop:nms-basis-independence-specialization-restated` | `proposition` | 3045 | Basis independence and specialization |
| `thm:nms-clutching-law-modular-resonance-restated` | `theorem` | 3073 | Clutching law for the modular quartic resonance class |
| `cor:nms-family-boundary-behaviour` | `corollary` | 3103 | Family-by-family boundary behaviour |
| `thm:nms-genus-loop-model-families-restated` | `theorem` | 3229 | Genus loop operator on the model families |
| `thm:nms-beyond-ahat-restated` | `theorem` | 3297 | The modular invariant hierarchy beyond $\hat{A}$ |
| `thm:nms-unified-summary-restated` | `theorem` | 3329 | Ambient complementarity and nonlinear modular shadows |
| `thm:reduced-weight-finiteness` | `theorem` | 3532 | Reduced-weight finiteness |
| `thm:window-locality` | `theorem` | 3620 | Window locality |
| `cor:exact-stabilization` | `corollary` | 3642 | Exact stabilization |
| `lem:nms-euler-inversion` | `lemma` | 3818 | Euler inversion |
| `prop:kac-shadow-singularity` | `proposition` | 3905 | Kac-shadow singularity principle |
| `thm:ds-shadow-depth-increase` | `theorem` | 4016 | DS shadow depth increase |
| `thm:shadow-subalgebra-autonomy` | `theorem` | 4143 | Shadow subalgebra autonomy |
| `cor:w-line-alternating-vanishing` | `corollary` | 4219 | $W$-line alternating vanishing |
| `thm:nms-shadow-mc-potential` | `theorem` | 4248 | Shadow tower as cyclic $L_\infty$ MC potential |
| `prop:nms-shadow-convergence` | `proposition` | 4312 | Shadow potential convergence |
| `thm:nms-mc-moduli-curve-structure` | `theorem` | 4414 | MC moduli curve structure |
| `thm:nms-hadamard-mc-potential` | `theorem` | 4477 | Hadamard factorization of the MC potential |
| `cor:nms-mc-solution-counting` | `corollary` | 4524 | MC solution counting |

#### `appendices/ordered_associative_chiral_kd.tex` (24)

| Label | Env | Line | Title |
|---|---|---:|---|
| `lem:bicom-e` | `lemma` | 215 | Bicomodules as comodules over the enveloping coalgebra |
| `thm:shuffle` | `theorem` | 298 | Ordered chiral shuffle theorem |
| `thm:opposite` | `theorem` | 403 | Opposite-duality for ordered bar coalgebras |
| `cor:anti` | `corollary` | 444 | Anti-involutions survive duality |
| `lem:closure` | `lemma` | 458 | Closure of admissibility under opposite and enveloping constructions |
| `cor:enveloping` | `corollary` | 469 | Enveloping duality |
| `lem:Kbi-dg` | `lemma` | 532 | — |
| `prop:one-defect` | `proposition` | 559 | — |
| `thm:tangent=K` | `theorem` | 581 | Tangent identification |
| `cor:infdual` | `corollary` | 618 | Infinitesimal dual coalgebra |
| `prop:infann` | `proposition` | 641 | Infinitesimal annular variation |
| `thm:bimod-bicomod` | `theorem` | 693 | PBW-complete bimodule/bicomodule equivalence |
| `thm:diagonal` | `theorem` | 726 | Diagonal correspondence |
| `cor:unit` | `corollary` | 774 | The diagonal is the unit for composition |
| `cor:tensor-cotensor` | `corollary` | 792 | Tensor--cotensor gluing |
| `thm:HH-coHH-homology` | `theorem` | 821 | Associative chiral Hochschild/coHochschild homology |
| `thm:HH-coHH-cohomology` | `theorem` | 853 | Associative chiral Hochschild/coHochschild cohomology |
| `cor:annulus` | `corollary` | 879 | The annulus as self-cotrace |
| `cor:cap` | `corollary` | 899 | Cap action |
| `thm:pair-of-pants` | `theorem` | 954 | Ordered pair-of-pants algebra |
| `thm:ordered-open` | `theorem` | 992 | Ordered genus-zero open trace formalism |
| `thm:CY` | `theorem` | 1046 | Shifted ordered Frobenius structure |
| `cor:cardy` | `corollary` | 1095 | Cardy operator on the coalgebra side |
| `thm:master` | `theorem` | 1119 | Master theorem |
...
| `thm:hook-transport-corridor` | `theorem` | 229 | Hook-type transport corridor |
| `prop:transport-propagation` | `proposition` | 255 | Transport propagation lemma |
| `prop:hook-ghost-constant` | `proposition` | 329 | Hook ghost constant |
| `prop:ds-bar-hook-commutation` | `proposition` | 380 | DS--bar commutation for hook-type |
| `thm:canonical-arity-detection` | `theorem` | 472 | Generator-degree detection of canonical arity |
| `thm:full-raw-coefficient-packet` | `theorem` | 620 | Exact Bell recursion for the full singular packet |
| `thm:miura-product-formula` | `theorem` | 778 | Subregular Miura product formula |
| `thm:subregular-appell-formula` | `theorem` | 815 | Subregular Appell formula |
| `thm:bp-strict` | `theorem` | 887 | Bershadsky--Polyakov is strict in canonical normal form |
| `thm:w4-cubic` | `theorem` | 934 | \texorpdfstring{$\mathcal W_4^{(2)}$}{W4(2)} has canonical arity $3$ |
| `thm:unbounded-canonical-arity` | `theorem` | 1065 | Unbounded canonical arity in the subregular line |
| `thm:triangular-primary-renormalization` | `theorem` | 1119 | Triangular primary-renormalization theorem |
