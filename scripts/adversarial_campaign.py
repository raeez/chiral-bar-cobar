...
THEOREMS = [
    ...
    ("T07_thm_H", "Theorem H: ChirHoch*(A) has amplitude [0,2] and Hilbert polynomial in t. Check: (a) is this really for ALL families? (b) what is the Hilbert polynomial? (c) is amplitude [0,2] proved or just computed? (d) is this amplitude or occupation/virtual dimension (AP134)?"),
