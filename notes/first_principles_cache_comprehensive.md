...
| 181 | Thm H Step 3 of prop:fm-tower-collapse: H^{>0}(FM_m(C)) is d_1-exact "by bar-concentration (Theorem bar-concentration)" | The FM tower collapses at E_2 on the Koszul locus | RESOLVED: `prop:fm-tower-collapse` no longer invokes `thm:bar-concentration` inside the proposition or proof. Step 3 now proves the fibrewise killing of positive Arnold classes directly from the Shelton--Yuzvinsky quadratic Koszulness of the braid Orlik--Solomon algebra, PBW-Koszulness, and the chiral-quadratic transfer lemma. | The survivor is now described as the full-collision stratum after the Arnold--Koszul fibre contraction, not after bar-concentration. The later `rem:pbw-parallel-consequences` records the logical relation: PBW is the common source of bar concentration and FM-tower collapse; neither is used as a proof step for the other. | closed 2026-06-09 | `chapters/theory/chiral_hochschild_koszul.tex` |
