...
- **Verification**: `cd compute && .venv/bin/python -m pytest tests/test_w_infinity_dual_candidate.py tests/test_w_infinity_ope.py tests/test_smoke.py -q` passes `49/49` with `61` deselected.
