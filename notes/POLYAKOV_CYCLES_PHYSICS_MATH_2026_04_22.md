...
maps *canonical witnesses* to *physical field types* bijectively. The Open-row shadow depths are $r_{\max}\in\{2,3,4,\infty\}$ for $\mathsf G/\mathsf L/\mathsf C/\mathsf M$, while the $\mathsf B$ crown enters through the CY recognition gate with Vol I coordinate $r_{\max}=5$ (classical four-shadow quadrichotomy plus $\mathsf B$-ceiling).
