...
\ifannalsedition
  ...
  % sec:concordance-three-pillars now defined in guide_to_main_results.tex
  ...
  % chap:concordance now defined in guide_to_main_results.tex
  ...
  % rem:four-test-interface now defined in guide_to_main_results.tex
