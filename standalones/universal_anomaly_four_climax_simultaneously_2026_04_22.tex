...
\label{thm:climax-IV}
On the derived centre $Z^{\mathrm{der}}_{\mathrm{ch}}(A_X)$ of the chiral algebra $A_X = \Phi_3^{(\Sigma_2,C)}(X)$ for $X$ a smooth projective Calabi--Yau threefold with Mukai lattice $L$, and on the Koszul-admissible locus $\cU^{\mathrm{adm}}(X)$,
\[
