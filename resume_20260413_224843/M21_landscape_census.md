...
session id: 019d88cd-a28b-7c91-8ba2-f5ed3d88605c
--------
user
<task>
...
TARGET: chapters/examples/landscape_census.tex
SCOPE: Last 200 commits. Run: git log --oneline -200 -- chapters/examples/landscape_census.tex | head -20
The CENSUS. For EVERY family: verify kappa, r-matrix, class, depth, K against compute engines. This is the CANONICAL source. Any error here propagates everywhere.
