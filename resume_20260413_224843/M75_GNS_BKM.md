...
session id: 019d88d2-d8e9-79e2-bec8-3c0705192f21
--------
user
<task>
...
Gritsenko-Nikulin-Sarti BKM cross-check (Vol III). Verify: (a) our kappa_BKM = 5 for K3xE matches Phi_10 weight, (b) our Borcherds product matches GNS, (c) root multiplicities consistent.
