...
\noindent\emph{Involution structure.}
The Feigin--Frenkel involution acts as
$\lambda \mapsto -\lambda$ on the 't~Hooft coupling ($K = 0$);
the GG involution $\lambda \mapsto 1 - \lambda$ is its DS image
($K \neq 0$; Computation~\ref{comp:ff-thooft-involution}).
