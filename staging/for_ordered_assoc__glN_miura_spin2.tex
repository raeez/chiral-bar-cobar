...
everything at $N = 2$; see
Example~\ref{ex:gl2-chiral-qg-staging} in the full version
for the explicit $4 \times 4$ $R$-matrix, RTT commutation
relations, quantum determinant, and Drinfeld coproduct at
$N = 2$.
