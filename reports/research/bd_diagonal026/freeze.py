...
SOURCE = ROOT / 'research-candidates/bd_diagonal026'
...
record = {
    ...
    'include_order': source_manifest['include_order'],
    'checks': source_manifest['checks'],
    'mathematical_status': 'Constructed and frozen. Independent exact-source acceptance remains pending.',
    'residuals': [
        'Independent outer-pole domains retain the cubic obstruction with fixed mixed images.',
        'The nonzero-level Koszul state target is contractible and does not preserve Heisenberg diagonal state cohomology.',
        'State-translation relations on the original ordered symbols require a separate quotient-kernel proof.',
        'Ordered-surjection, deconcatenation, and four-input compatibility are not constructed.'],
