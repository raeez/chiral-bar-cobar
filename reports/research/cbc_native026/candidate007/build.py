...
kind=sys.argv[1]
source=root/'research-candidates/cbc_native026/candidate007'/('cbc' if kind=='native' else 'proof')
entry={'native':'main.tex','proof':'comparison_main.tex','subregular':'subregular_main.tex'}[kind]
stem=Path(entry).stem
out=root/'reports/research/cbc_native026/candidate007'/('build-'+kind)
