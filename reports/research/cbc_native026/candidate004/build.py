...
kind=sys.argv[1]
source=root/'research-candidates/cbc_native026/candidate004'/('cbc' if kind=='native' else 'proof')
entry='main.tex' if kind=='native' else 'comparison_main.tex'
stem=Path(entry).stem
out=root/'reports/research/cbc_native026/candidate004'/('build-'+kind)
