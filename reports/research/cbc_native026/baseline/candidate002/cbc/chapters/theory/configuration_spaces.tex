...
The propagators $\eta_{ij} = d\log(z_i - z_j)$ from the Heisenberg bar complex (Chapter~\ref{ch:heisenberg-frame}) live on Fulton--MacPherson compactifications; the Arnold relations among triple collisions force $d^2 = 0$.
