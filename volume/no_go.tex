...
Theorem~\ref{nogo:anomaly-types} shows that a tuple of scalars drawn from
these five carriers is not a single classifying invariant of a chiral
algebra.  Likewise, no trace identity among them follows without a named
comparison morphism.
