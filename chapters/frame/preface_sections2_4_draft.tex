...
Chapter~\ref{ch:k3-chiral-bialgebra-platonic}), and the preceding
...
any integer level $N$, per Wave 13 Kazhdan Cycle 2 retraction of the
"paramodular $K(1)$" claim). The Langlands dual of
...
The K3 chiral bialgebra $\mathbf{H}_{\Delta_5}$ of Vol~III
Chapter~\ref{ch:k3-chiral-bialgebra-platonic} globalises as a
...
$(7/2, 5/2)$ (tempered; correcting the Wave~12 $(17/2, 1/2)$ which
belongs to $\Delta_{10}$ not $\Delta_5$).
\end{theorem}

\begin{proof}[Proof (reference)]
Theorem is proved in Vol~III Chapter~\ref{ch:k3-chiral-bialgebra-platonic}
(and its companion compute module
\texttt{k3\_yangian\_wave14\_humbert\_monodromy\_8.py}) in tandem with
the super-Etingof--Kazhdan classification
(Theorem~\ref{thm:k3-structural-genesis}). The three-path verification
(Hecke, Heegner Chern-class, Lusztig specialisation) is the content of
Vol~I
...
The Wave 12 "paramodular $K(1)$ level" attribution for $\Delta_5$
...
$\mathbb{Z}/2$-central extension. See anti-pattern AP-CY-W13-Kaz-3.
\end{remark}

\section{Wave 13 DNA perspective}
\label{sec:pref24-wave13-DNA}

\begin{remark}[Preface \S2-\S4 draft as Wave~13 warm-up]
\label{rem:pref24-DNA-1}
The preface supplementary sections \S2-\S4 warm the reader to the
Wave~13 base point through the K3 $\{2,3,5,24\}$ spectrum and the
