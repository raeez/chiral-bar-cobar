...
envelope, are addressed: all five are proved.  MC3 is proved
for all simple types on the evaluation-generated core;
the residual DK-4/5 (extension beyond evaluation modules)
is downstream.  The full BV/BRST/bar identification at higher
