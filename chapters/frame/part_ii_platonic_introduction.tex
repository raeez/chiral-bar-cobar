...
tower, inscribed in
Appendix~\ref{app:nonlinear-modular-shadows}. We recall its
...
\begin{theorem}[Fingerprint is complete invariant of bar-complex
 structure; \ClaimStatusConditional]
...
Chapter~\ref{ch:shadow-tower-higher-coefficients}\textup{)} that
...
Cross-reference Chapter~\ref{V3-ch:k3-chiral-bialgebra-platonic}.
\end{theorem}
...
computed in
Chapter~\ref{ch:shadow-tower-higher-coefficients}, and the
