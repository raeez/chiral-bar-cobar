...
each chart algebra $A_b = \End_\cC(b)$, a bar coalgebra $B(A_b)$ whose
Koszul depth $\kappa(A_b)$ is the linear leading term of an entire
shadow-obstruction tower
$S_\bullet(A_b) = (S_2, S_3, S_4, S_5, \ldots)$. The Virasoro operator
product expansion
\begin{equation}
...
\end{equation}
emits the central charge $c$, recovered as
$\kappa(\Vir_c) = c/2 = S_2(\Vir_c)$. The classical narrative reads
off this scalar and stops: one chiral algebra, one shadow, one
coordinate.
