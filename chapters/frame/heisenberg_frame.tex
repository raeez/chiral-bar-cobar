...
\item The \emph{conjectural full homotopy completion}
  ...
  In this monograph, $\Theta_{\mathcal{H}_k}$ itself is not
  constructed; it is the principal open problem of the
  modular characteristic programme
...
$\Theta_{\mathcal{A}}$, is the conjectural non-scalar
completion (Conjecture~\ref{conj:universal-theta},
...
% ================================================================
\section{\texorpdfstring{What breaks for $\widehat{\mathfrak{sl}}_2$ --- preview of the non-abelian theory}{What breaks for affine sl2 --- preview of the non-abelian theory}}
...
% ================================================================
\section{\texorpdfstring{What breaks for Yangians --- preview of the $E_1$ world}{What breaks for Yangians --- preview of the E1 world}}
...
\item Curvature at genus~$1$: the fiberwise differential satisfies
  $\dfib^{\,2} = k \cdot \omega_1$, while the total corrected
  differential $\Dg{1}$ remains strict with $\Dg{1}^{\,2}=0$;
  this forces the passage to the coderived category
...
\item The genus-$1$ fiberwise curvature $\dfib^{\,2} = \kappa \cdot \omega_1$ forces
