...
$\mathrm{obs}_g=\kappa\lambda_g$ (Theorem~D), the chiral
...
the pair $(\cA,\cA^{!}_\infty)$ on the standard landscape is a
theorem (Proposition~\ref{prop:perfectness-standard-landscape})
rather than an imposed hypothesis. The shift is read off the
...
\phantomsection\label{thm:grt1-rigidity}%
