...
bounds the chiral Hochschild complex in degrees $\{0,1,2\}$ with total
dimension at most~$4$.  At critical level $k=-h^\vee$ the bound fails
...
degrees $\{0,1,2\}$ with total dimension~$\le 4$.  This is the
deformation ring of~$\cA$ at generic level, and the bound is
Koszul-functorial.  At critical level $k=-h^\vee$ the bound fails
...
D, H occupy Parts~I--II of the body.  Every theorem is a projection
