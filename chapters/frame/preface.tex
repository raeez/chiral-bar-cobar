...
homology} $\mathrm{THH}(\cA)$, which is factorisation homology
over~$S^1$ using only the $E_1$-structure. For $E_\infty$-algebras
(the entire standard landscape), the two theories agree; for
genuinely $E_1$-algebras they diverge, because the chiral theory
...
annulus gives
$\int_{S^1 \times [0,1]} \cA \simeq \mathrm{HH}_\bullet(\cA)$,
the topological Hochschild bimodule. The annulus is the geometric home of
the topological Hochschild complex: the two boundary circles are input and
