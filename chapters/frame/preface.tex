...
fingerprint completeness). The 2026-04-16 reconstitution closes four
former frontiers (periodic CDG admissible-level, curved-Dunn
$H^2=0$ at $g\ge 2$, Drinfeld--Sokolov--Hochschild in class~$M$,
chiral Deligne--Tamarkin), upgrading each theorem where the closure
applies.
...
$\kappa+\kappa^!=250/3$ for $\cW_3$; and
$\kappa+\kappa^!=98/3$ for Bershadsky--Polyakov.
\medskip
...
The 2026-04-16 reconstitution closes four formerly-deepest frontier
questions. \emph{Periodic CDG admissible-level}: closed via
