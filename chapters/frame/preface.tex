...
\subsection*{The chiral quantum group equivalence}

On the chirally Koszul locus, the $E_1$ data package into a
single structure: the chiral quantum group. Three structures on
$B^{\mathrm{ord}}(\cA)$ determine each other
...
brings the independent-verification independent-verification decorators to complete
