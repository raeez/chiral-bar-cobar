...
At each degree $r\ge 2$, $\Theta_\cA$ projects to a shadow
...
the Hochschild bimodule. The annulus is the geometric home of
the Hochschild complex: the two boundary circles are input and
...
Hochschild construction, not in the bar complex.
