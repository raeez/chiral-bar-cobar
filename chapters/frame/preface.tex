...
Volume~IV inscribes the HEAL and UPGRADE theorems and aligns the
...
inscribed in the body, at least two genuinely independent structural
verification lanes, and the scalar numerical clauses of Theorems~C
and~D are accompanied where inscribed by three or more family-level
...
Calabi--Yau-to-chiral source through $\Phicy$; Volume~IV inscribes
...
instances inscribed in the body, at least two genuinely
...
\kBKM(X)\;=\;\tfrac12\,K(A_X).
\]
The manuscript does not presently inscribe a primary-source-complete
...
% =====================================================================
% prop:perfectness-standard-landscape now a real label inscribed at
...
% second \label{chap:infinite-fingerprint-classification} inscribed at the
...
\phantomsection\label{chap:theorem-A-modular-family}% alias: this chapter is the CONDITIONAL modular-family extension of thm:A-infinity-2 (scope remark rem:A-infinity-2-modular-family-scope at theorem_A_infinity_2.tex:890); not separately inscribed pending GR17 + Mok25 inscription, see notes/true_frontier_2026_04_17.md%
...
% torsor content is inscribed as rem:chiral-qg-grt1-torsor in
...
%%% Wave 13 DNA weave - Vol I preface %%%

\bigskip

\noindent
\emph{Wave 13 architectural upgrade.} The four shadow archetypes
...
inscribes the platonic ideal; Volume~I is the lens through which the
$\kappa$-spectrum of this crown is read.

%%% end Wave 13 DNA weave %%%

\section{Wave 13 DNA perspective}
\label{sec:v1-preface-wave13-DNA}

\begin{remark}[Preface as the Wave~13 programmatic entry]
\label{rem:v1-preface-DNA-1}
The Wave~13 DNA enters Vol~I's preface via the bar-cobar-Koszul
programme's K3 base point: the central object is $\mathbf H_{\Delta_5}$,
...
H Hochschild concentration) at the Wave~13 base point becomes five
...
\label{rem:v1-preface-DNA-3}
The preface's factorisation thesis -- "chiral algebras live on
configuration spaces" -- refines at the Wave~13 base point to the
