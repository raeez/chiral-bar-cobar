...
Section~\ref{sec:topologization}) states:
\[
...
homology has dimension $n!$ at arity~$n$, while the
...
at arity~$\ge 3$ misses $A_\infty$ corrections.
...
open-to-closed is forbidden. An $\SCchtop$-operation of arity~$(k,m)$
lives on
