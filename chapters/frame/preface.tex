...
weight-completed ambient, where the inversion is restored
(Theorem~\ref{thm:mc5-class-m-chain-level-pro-ambient}). The bar
...
degrees $\{0,1,2\}$ and carries a universal $\Ethree$-algebra
...
gravity statement is available at weight-completed ambient only, in
parallel with Theorem~MC5, and remains conjectural at the uncompleted
direct-sum level. The alternative verification path is
...
ambient-conditional: it holds in the weight-completed chain complex
(Theorem~\ref{thm:mc5-class-m-chain-level-pro-ambient}), whereas the
