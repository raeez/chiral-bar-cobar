...
non-trivial projective Schur-multiplier phases in $H^2(M_{24}, \mathrm{U}(1)) \cong
\mathbb{Z}/12$. The Serre functor on $D^b\mathrm{Coh}(K3)$ under $\widetilde{M}_{24}$-
equivariance acquires an order-$6$ cocycle from this multiplier (Bridgeland--Maciocia
$2001$); the subregular hook frontier receives additional twist from the anomalous-class
