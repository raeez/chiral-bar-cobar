...
\;\neq\; 0
\]
\textup{(}AP24: the antisymmetric form
$\kappa + \kappa^! = 0$ holds for KM and free fields, not for
$\mathcal W$-algebras\textup{)}.  The shadow class of $\mathrm{BP}_k$
...
% Propagated to all compute engines and test files (AP5).
...
$K_{\mathrm{BP}} = 2$ is level-independent
