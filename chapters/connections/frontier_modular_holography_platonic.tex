...
\item \emph{Conformal anomalies.}
 ...
 gives $-12\cdot 107/6 = -2\cdot 107 = -214$; $107$ prime, so
 $-214 = -2\cdot 107$ admits no non-trivial integer factorisation;
 the intermediate Wave-14 value $(c_{4d}, c_{2d}) = (26, -312)$ is
 retracted per Vol~I
 Chapter~\ref{ch:thqg-open-closed-realization} line~1932\textup{)}.
...
and the $2\mathrm d$ central charge $c_{2\mathrm d} = -214$ are
related by the Beem--Rastelli ratio
$c_{2\mathrm d} = -12\,c_{4\mathrm d}$ at $c_{4\mathrm d} = 107/6$
of the Shapere--Tachikawa / Chacaltana--Distler datum.
