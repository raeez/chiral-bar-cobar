...
\begin{proof}
The degree constraint is~\cite[Proposition~3.1]{KhanZeng25}: the
action functional has form degree $d + k$ on
...
is~\cite[Theorem~5.2]{KhanZeng25}: the generator $T$ defines a
gauge transformation $\delta_T A = (d_t + \bar\partial)\varepsilon$
that makes holomorphic translation BRST-exact.  This matches
the chain-level statement of
Remark~\ref{rem:chiral-deligne-tamarkin-dimensional-jump}
in Volume~I.
\end{proof}
