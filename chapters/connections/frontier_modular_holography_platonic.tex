...
The Chriss--Ginzburg principle of this monograph---every algebraic structure
is a Maurer--Cartan element in a convolution algebra---extends to
...
\subsubsection{The five shadows of $\Theta_\cA$: Chriss--Ginzburg synthesis}
...
This is the Chriss--Ginzburg principle in its holographic form:
$\mathcal{H}(T)$ is not six independent objects; it is one
