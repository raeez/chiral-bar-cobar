...
\item \textup{($\cW_N$ prediction.)}
 ...
 GZ\textup{26} remains a separate normalization problem.
\end{enumerate}
\end{theorem}
...
\ClaimStatusConditional{} on the new three-parameter identification;
...
\begin{proposition}[Phantom M5 Koszul dual; \ClaimStatusConditional]
...
\item \emph{Conformal anomalies.}
 ...
 retracted per Vol~I
 Section~\ref{sec:thqg-open-closed-realization} line~1932\textup{)}.
