...
Let\/ $\cA = \widehat{\fg}_k$ and let\/ $Y_z^\hbar(\fg)$ be the Yangian
...
$\mathrm{Res}^{\mathrm{coll}}_{0,2}(\Theta_\cA)$ (vanishing at $k=0$; at the D3 level $k=1$ this reduces to $\Omega/z$):
