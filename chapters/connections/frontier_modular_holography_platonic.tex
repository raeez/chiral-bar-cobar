...
projections are the shadow Postnikov obstruction tower.  The holographic programme
...
\item \emph{Modular Maurer--Cartan class.}
  ...
  and the finite-order projections are the shadow Postnikov obstruction tower
...
the shadow Postnikov obstruction tower.  Arity controls the order of the shadow
...
enveloping vertex algebra~$\Uvert(R)$; the shadow Postnikov obstruction tower
...
\begin{proof}
The shadow Postnikov obstruction tower at arity~$r$ involves the transferred
...
The shadow Postnikov obstruction tower constructs nonlinear invariants
