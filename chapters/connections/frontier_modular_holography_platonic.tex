...
the triangle is expected to be reconciled by
...
quantitative signature expected, at the Lusztig specialisation, to make
the two indexings bulk-boundary projections of the same Drinfeld double
$U_\cA = \cA \bowtie \cA^{!}_\infty$. The class~$\mathsf{M}$ residue
left open by the boundary-linear argument closes cohomologically, and
at chain level only in the completed/pro sense, via the
DS--Hochschild bridge of Vol.~II
