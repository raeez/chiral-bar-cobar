...
The heuristic shadow-weight normalisation ansatz
\begin{equation}\label{eq:frontier-Delta5-weight-decomposition}
\operatorname{wt}(\Delta_5) \;=\; 5 \;=\; 2 \;+\; 3
\end{equation}
is expected at the $1$-loop level of the twisted SUGRA computation and
...
The total weight $5 = 2 + 3$ is a candidate fifth-shadow normalisation
of the
...
remaining open mathematical conditions. The resulting $11$D-SUGRA scalar target is
