...
\begin{proposition}[Collapse permanence; \ClaimStatusProvedHere]%
...
For every arity cutoff~$R$, the interacting sewing kernel
...
The nontrivial content is that higher-arity shadow contributions
$b_r(N)$ depend on the single variable~$N$, not separately on the
arity-$r$ and genus-$g$ indices that might introduce independent
$(s,t)$-separated Dirichlet series.
