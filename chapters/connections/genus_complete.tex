...
\emph{level-$3$} statements (derived chiral centre as the bulk
acting on the chiral category and its boundary modules); the scalar
...
shadow obstruction tower; the all-degree MC element exists by
...
hypothesis package: free Heisenberg core $\cH_k$, Bergman space
