...
By Theorem~\ref{thm:mk-general-structure-vol1} (proved here),
...
Theorem~\ref{thm:mk-general-structure-vol1} (Feynman transform = graph sum)
with the abstract topological recursion framework.
The spectral curve identification in Step~1 invokes
Conjecture~\ref{conj:v1-bar-worldline} (heuristic) for the
...
\item The Heisenberg sewing theorem
 (Theorem~\ref{thm:heisenberg-sewing-vol1}) locks the
...
The $K3 \times E$ chiral bialgebra $\mathbf H_{\Delta_5}$ of Vol~III Chapter~\ref{V3-ch:k3-chiral-bialgebra-platonic} has Siegel character
...
Vol~III Remark~\ref{V3-rem:cydkappa-fibre-functor}.
\end{remark}
