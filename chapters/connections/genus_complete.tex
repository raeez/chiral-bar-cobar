...
\begin{theorem}[Extension obstruction; \ClaimStatusProvedElsewhere]\label{thm:extension-obstruction}
...
\begin{theorem}[Higher-genus bar differential; \ClaimStatusProvedElsewhere]\label{thm:higher-genus-diff}
...
(Theorem~\ref{thm:bar-ainfty-structure}), and the higher
...
\item \emph{Curved case}: When $\kappa \neq 0$, the curvature
  ...
  differential from squaring to zero \emph{on the nose} in the
...
\begin{theorem}[String amplitude = bar complex cohomology; \ClaimStatusConjectured]\label{thm:string-amplitude-bar}
...
\begin{remark}[Scope]
Theorem~\ref{thm:string-amplitude-bar} is labeled \ClaimStatusConjectured{}
...
\begin{theorem}[Poincaré--Verdier duality extended; \ClaimStatusProvedElsewhere]\label{thm:poincare-extended}
