...
cubic, quartic, and (conjecturally) all-arity shadows as
...
The identity $\Dg{g}^{\,2} = 0$ for the total differential at the convolution level is equivalent to the Maurer--Cartan equation for the curved $A_\infty$ structure, which is proved by genus induction in Theorem~\ref{thm:genus-induction-strict}.  (At the ambient level with planted-forest corrections, $D^2 = 0$ is Conjecture~\ref{conj:differential-square-zero}.)
...
\;\longrightarrow\;
\underbrace{\Theta_{\cA}}_{\text{conjectural limit}}.
\end{equation}
...
the conjectural all-arity limit $\Theta_{\cA}$ would be
...
$r \geq 4$ (proved constructively, conjectural as
$r \to \infty$).
\end{theorem}
