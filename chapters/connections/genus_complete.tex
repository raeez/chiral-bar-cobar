...
\end{array}
\]
The three finite values $\{3, 4, \infty\}$ correspond to the three
...
\end{equation}
Each level is a shadow of every later level.  The universal class
$\Theta_{\cA}$ is the source of all of them.
\end{theorem}
