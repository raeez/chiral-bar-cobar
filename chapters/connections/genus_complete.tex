...
\begin{proposition}[Algebraic open--closed bulk from the boundary;
...
algebraic open--closed bulk is the chiral derived centre. Thus
\begin{equation}\label{eq:bulk-derived-center}
 \cA_{\mathrm{bulk}}^{\mathrm{alg}}
 \;\simeq\;
...
The $K3 \times E$ chiral bialgebra $\mathbf H_{\Delta_5}$ of Vol~III Chapter~\ref{ch:k3-chiral-bialgebra-platonic} has Siegel character
...
Vol~III Remark~\ref{rem:cydkappa-gerbe}), while at the Humbert
...
Theorem~\ref{thm:modtr-banding-cocycle}), and the
...
Vol~III Remark~\ref{rem:cydkappa-fibre-functor}.
\end{remark}
...
lattice rank. This confirms the Mukai grading direction rule: grading is on the
...
Remark~\ref{rem:genus-complete-bi-based} precisely encodes this
...
Remark~\ref{rem:htpo-mukai-direction} and Vol~III
Remark~\ref{rem:cydkappa-mukai-grading-direction}.  Primary:
