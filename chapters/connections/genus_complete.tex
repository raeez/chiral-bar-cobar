...
The bar-cobar construction extends to all genera via the modular operad structure on $\overline{\mathcal{M}}_{g,n}$; the genus-$0$ and genus-$1$ identifications are proved, and higher-genus extensions are controlled by the universal Maurer--Cartan class $\Theta_\cA$.
...
The bar complex refines the classical modular functor (Segal, Bakalov--Kirillov) to cochain complexes with $A_\infty$-morphisms as structure maps.
...
\begin{remark}[Scope]
The bar complex resolution (Part~I) encodes OPE coefficients, conformal blocks, and genus expansion.  The AdS/CFT identification requires bulk CS reconstruction~\cite{Wit89}, the 't~Hooft $1/N$ identification, and Witten diagram matching --- physics inputs beyond this monograph.  The remaining targets follow MC4/MC5 (Chapter~\ref{chap:concordance}).  Contributing to Conjecture~\ref{conj:master-bv-brst}.
\end{remark}
