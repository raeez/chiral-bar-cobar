...
(Conjecture~\ref{conj:anomaly-physical}).  The remaining filtered
targets belong to MC4, with the amplitude/bar identification downstream
at MC5 (Chapter~\ref{chap:concordance}).
...
scope of this monograph.  Accordingly, the current theorematic input
stops at bar/semi-infinite data and same-family shadow partners; the
remaining filtered targets (MC4) and holographic identification (MC5)
are recorded in Chapter~\ref{chap:concordance}.
