...
the entire shadow Postnikov obstruction tower into the cohomology ring of
...
genus-$g$ corrections (Theorem~D, the shadow Postnikov obstruction tower,
...
controlled by the shadow obstruction tower alone.
\end{proof}
