...
$r^{\mathrm{ell}}_\fg(z, \tau) \to k\,\Omega/((k+h^\vee)z)$ through the
...
$r$-matrix is singular; at $k = 0$ the unnormalized elliptic
$r$-matrix $k \cdot r^{\mathrm{ell}}_\fg$ vanishes identically
\textup{(}AP126\textup{)}.
