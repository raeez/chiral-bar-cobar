...
% Level prefix k/(k+h^v) mandatory in Killing-form convention;
...
this equation at all $k$. This is the level-prefix discipline
...
which Casimir convention is in force at that statement; the present chapter
...
% Level prefix k/(k+h^v) in Killing-form convention; at k=0 the
...
% Level prefix k/(k+h^v); equivalent to Drinfeld k*Omega_tr/z on
...
$\Phi_3(\mathrm{K3} \times E)$ in the BPS-counting category, with
Stage~1 delivering the canonical $E_3$-holomorphic factorisation
algebra on $\mathrm{K3} \times E$ and Stage~2 restricting to the
elliptic reference curve $E_\tau$; the Borcherds product $\Phi_N$
supplies the BKM character whose elliptic specialisation matches
the $E_\tau$-collision residue.
\end{remark}
