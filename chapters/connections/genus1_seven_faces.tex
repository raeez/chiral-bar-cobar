...
in Vol.~II rather than established in Vol.~I.
...
Three independent faces of this $8$ emerge via Bruinier $2002$ Proposition~$5.1$
...
Beyond the seven faces of genus-$1$ $r(z)$ catalogued in Vol~I, an eighth face appears
...
24 Kodaira $I_1$ fibres. The table below identifies each
with a specific face of the Siegel-elliptic dynamical
$R$-matrix $R_{\mathrm{Sieg,dyn}}$.

\begin{proposition}[Seven K3-genus-$1$ faces of $r(z)$]
...
paramodular $K(1)\subset\mathbb{H}_2$ locus; this is the
...
\end{enumerate}
Faces $1$--$3$ are Vol~I canonical; faces $4$--$7$ are
...
(Mukai doubling, Humbert monodromy, Lusztig
specialisation).
\end{proposition}
...
the Costello CY-$2$ $[2]$-shift argument (K3 is
...
Kronecker--Eisenstein extension; the Etingof
...
$\zeta^8 = 1$ with $\hbar^2 = -1/8$ is the common
...
The seven K3-genus-$1$ faces are not seven independent
...
F-datum realised at the level of $r$-matrices.
\end{remark}

\begin{remark}[Cross-volume: seven faces and BV
