...
Remark~\ref{rem:g1sf-R-sieg} lifts $r^{\mathrm{ell}}$ to the
...
$\ell=8$ monodromy class of Remark~\ref{rem:g1sf-seven-faces}
...
Proposition~\ref{prop:g1sf-seven-K3-faces} are linked by the
