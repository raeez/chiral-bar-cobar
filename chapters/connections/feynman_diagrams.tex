...
The abstract machinery of bar-cobar duality has a concrete physical interpretation 
...
What we have established is a fundamental structural principle:
...
\textbf{Step 1: Feynman transform gives the genus expansion.}
...
\textbf{Step 2: Edge contribution = propagator.}
...
Green function $G_0(z,w) = 1/(z-w)$ on $\mathbb{P}^1$
...
\textbf{Step 3: Vertex contribution = OPE data.}
...
\textbf{Combining:} The genus-$g$ contribution to $m_k$ evaluates the
