...
The chapter is organized as follows.  We begin with tree-level and loop-level decompositions and the off-shell/on-shell distinction, then introduce Kontsevich-style graph complexes and their relation to the bar differential.  The higher $A_\infty$ operations $m_k$ are identified as Feynman amplitudes over configuration spaces, and the BPHZ renormalization recursion is recovered from the $A_\infty$ relations.
