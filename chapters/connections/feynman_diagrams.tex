...
\label{sec:feynman-wave14-anchors}

\begin{remark}[Feynman picture structural anchors]
\label{rem:feynman-diagrams-wave14-anchors}
...
\label{sec:feyn-wave13-DNA}

\begin{remark}[Paramodular $1$-loop diagram at $K3 \times T^2$]
\label{rem:feyn-DNA-paramodular-1loop}
...
Remarks~\ref{rem:v2-oackd-DNA-W15-two-param},
\ref{rem:v2-oackd-DNA-W15-e1-e2};
Vol.~III \texttt{k3\_chiral\_bialgebra\_platonic.tex} CY-2 $[2]$-shift.
\end{remark>

\begin{remark}[Refined Feynman summary]
\label{rem:feyn-W15-DNA-summary}
