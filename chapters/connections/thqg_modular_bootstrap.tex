...
(AP33: $\cH_k^! \neq \cH_{-k}$ as chiral algebras,
though their modular characteristics coincide).
...
\item The genus spectral sequence degenerates at $E_1$
  ...
  so no higher-arity corrections survive.
...
\subsubsection{Beyond the Gaussian: higher-arity complexity}
\label{subsubsec:thqg-VII-beyond-gaussian}

\begin{remark}[Higher-arity corrections from the shadow obstruction tower]
\label{rem:thqg-VII-grav-corrections}
\index{higher-arity corrections!shadow tower}
For non-Gaussian algebras ($r_{\max} \geq 3$), the MC recursion
produces genuine higher-arity genus corrections that are
...
algebra: a larger shadow depth forces higher-arity contributions in
the genus expansion.
\end{remark}
