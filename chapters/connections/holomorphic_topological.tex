...
boundary chiral algebras remains an open problem.
...
complex and the same-family partner data on the boundary side; it does
not yet construct an H-level infinite-generator bulk dual, which
remains part of the MC4/MC5 frontier.
