...
\begin{conjecture}[Topological open-closed duality; \ClaimStatusConjectured]
...
the W-algebra associated to $G$.  For $G = SL_N$, this is the $\mathcal{W}_N$ algebra
with generators $T(z), W^{(3)}(z), \ldots, W^{(N)}(z)$
...
\begin{remark}[Physics interpretation; \ClaimStatusConjectured]
...
\begin{conjecture}[AGT through bar-cobar lens; \ClaimStatusConjectured]\label{conj:agt-bar-cobar}
...
\begin{remark}[Scope]
Conjecture~\ref{conj:agt-bar-cobar} reinterprets the AGT correspondence through
