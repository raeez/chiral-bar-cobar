...
The bar-cobar framework of Parts~I and~II operates on chiral algebras as given algebraic data.  This chapter traces these algebras to their origins in four-dimensional physics: holomorphic-topological field theories in the sense of Costello--Li produce chiral algebras on boundary curves, and the bar-cobar adjunction acquires a physical interpretation as a duality between boundary conditions.
...
\begin{remark}[Scope]
Chirality is proved for $\mathcal{N}=4$ SYM (Theorem~\ref{thm:cl-n4-chirality}); the general case remains conjectural.  See \cite{CDG20,GKW24,Zeng23} for related work.  Contributing to Conjecture~\ref{conj:master-bv-brst}.
\end{remark}
...
\begin{remark}[Scope]
Conditions~(i)--(iii) are established for $\mathcal{N}=4$; the general case is conjectural.  Coefficient identities belong to MC4; the bulk/bar identification to MC5 (Conjecture~\ref{conj:master-bv-brst}).
\end{remark}
...
\begin{remark}[Scope]
Open-string side proved (Theorems~\ref{thm:bar-semi-infinite-km}, \ref{thm:bar-semi-infinite-w}).  The closed-string identification belongs to MC4/MC5 (Conjecture~\ref{conj:master-bv-brst}).
\end{remark}
...
\begin{remark}[Scope]
Individual levels are established \cite{BD04,CG17,CWY18}; the iterated bar-cobar claim is conjectural (Conjecture~\ref{conj:master-bv-brst}).
\end{remark}
...
\begin{remark}[Scope]
The 2D side is proved (Theorem~\ref{thm:agt-2d-bar}); the 4D--2D bridge is proved in specific cases \cite{SV13,MO19}.  Remaining coefficient identities belong to MC4; the bulk identification to MC5 (Chapter~\ref{chap:concordance}, Conjecture~\ref{conj:master-bv-brst}).
\end{remark}
