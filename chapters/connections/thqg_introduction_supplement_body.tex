...
between proved and open territory.  All five master conjectures MC1--MC5 are proved, including MC3 for all simple types (Corollary~\ref{cor:mc3-all-types}).  The remaining
...
((x)~$\Rightarrow$~(xii) proved, converse open).
