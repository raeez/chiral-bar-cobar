...
The line category
$\mathsf{Line}(\cA)=\cA^!\text{-}\mathsf{mod}$
is attached to the third entry. It is not the bulk entry
$\mathbf{C}_{\mathrm{ch}}(\cA)$.
...
consequence, one perfectness-conditional Lagrangian criterion, and one
...
$(\partial,\,\mathrm{bulk},\,\mathrm{interaction})
...
the boundary chart is the chiral algebra, the bulk slot is the chiral
