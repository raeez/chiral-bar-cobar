...
surfaces, its genus-$0$ affine specialization recovers the
Knizhnik--Zamolodchikov connection and its genus-$0$ Virasoro
degenerate-module specialization recovers the BPZ differential
...
comparison surface the infinite shadow tower produces the modular
...
between proved and open territory.  MC1, MC2, and MC4 are proved, while
MC3 is only partially resolved: the all-types categorical CG and
evaluation-generated-core DK surfaces are proved, but the remaining
completion packets stay open beyond that core.  The remaining
