...
complementarity $c + c' = 26$; the self-dual point is $c = 13$
(the Virasoro self-dual point, $\kappa = 13/2$).  For the $\beta\gamma$ system
...
Postnikov tower level by level.  For affine Kac--Moody and free-field
...
between proved and open territory.  MC1, MC2, and MC4 are proved, MC3
is proved in type~$A$, and the full MC5 BV/BRST/bar identification
remains open beyond the proved analytic sewing package.  The remaining
frontiers are MC3 in arbitrary simple type
\textup{(}Conjecture~\ref{conj:mc3-arbitrary-type}\textup{)} and the
...
characterizations of the Koszul property for chiral algebras.  Ten
are unconditionally proved equivalent; the eleventh (D-module purity)
is partially proved (forward direction established, converse open);
the twelfth (the Lagrangian criterion) is conditional on perfectness
