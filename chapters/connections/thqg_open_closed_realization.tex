...
\item \emph{The scalar identification.}
  ...
  this remains open
  \textup{(}\textbf{op:multi-generator-universality}\textup{)}.
...
where the boundary shadow tower degenerates.
\end{remark}
...
\item \emph{Boundary-holographic nonlinearity.}
  ...
  gravitational content is determined by the boundary shadow tower.
\end{enumerate}
\end{remark}
