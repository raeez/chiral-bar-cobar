...
\begin{theorem}[Open/closed projection principle; \ClaimStatusConditional]
...
\begin{theorem}[MC-forced open-closed consistency; \ClaimStatusConditional]
...
$\mathfrak{R}^{\mathrm{oc}}_{4}$; \ClaimStatusConditional]
...
$\mathfrak{su}(2)^{24}$ (canonical values; see
Remark~\ref{rem:thqg-occ-retraction} for the
double-retraction of the intermediate evaluation
...
Kodaira $I_1$ fibres $E^{\mathrm{nod,sm}}_{24}$ in the bi-based
...
(Beilinson B-1 verification) coincides with the order of the
...
\begin{remark}[Retraction of an earlier Chacaltana--Distler ansatz]
\label{rem:thqg-occ-retraction}
An earlier programme iteration asserted
...
intermediate retraction $c_{4d} = 26$ is itself retracted here. The
earlier K3 $a_{4d} = 421/24$ differs from the first-principles
