...
The Wave~13 class-$\mathcal S$ theory $\mathcal T[A_1,\Sigma_{0,24}]$ has
$c_{4d} = 26$, $c_{2d} = -312$, Coulomb rank $21$, flavour
$\mathfrak{su}(2)^{24}$, providing a $4d$/$2d$ open-closed realisation
