...
(cf.\ Fulton--MacPherson~\cite{FM94}; the formal-disk
...
the right side is the categorical Hochschild homology of the $A_\infty$-algebra
$A_b$:
...
standard topological Hochschild boundary operator under this identification,
because the last face map wraps $a_n$ past $a_{n+1}$ to compose
with $a_0$; this is the cyclic trace term that
distinguishes the topological Hochschild differential from the bar
differential.
...
definition of topological Hochschild homology.
...
components), hence topological Hochschild homology, rather than something more
exotic.
...
By the annulus trace theorem, this is the topological Hochschild homology
class $[1] \in HH_0(A_b)$.
