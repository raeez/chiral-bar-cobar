...
Hochschild cochains of $A_b$. The final comparison is exactly
Proposition~\ref{prop:geometric-algebraic-hochschild}; the degree
concentration is then transported only under the Koszul/PBW
hypotheses of Theorem~H.
\end{proof}
...
The derived tensor product above is computed
...
The two-sided bar complex above is
identified with the \emph{cyclic bar complex}
$B^{\mathrm{cyc}}(A_b)$: an element
$a_0 [a_1 | \cdots | a_n] a_{n+1}$ in that two-sided bar complex
