...
\item \emph{No Euler product.}
  ...
  + L_B^{\mathrm{sh}}$ \textup{(}additive, not
  multiplicative\textup{)}, with the first failure at $n = 6$:
  $\sigma_{-1}(6) = 1 + 1/2 + 1/3 + 1/6 = 2 \neq
  \sigma_{-1}(2)\,\sigma_{-1}(3) = (3/2)(4/3) = 2$
  \textup{(}this particular value is an accidental coincidence;
  the failure appears at $n = 12$\textup{)}.
