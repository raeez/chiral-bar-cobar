...
shadow data at all degrees is determined by finitely many
...
threefold $\mathrm{K3} \times E$, with the universal trace
identity $\kappa_{\BKM}(X) = K(\Phi(X))/2$ supplying the
conductor side. The depth quadrichotomy
