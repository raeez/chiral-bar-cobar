...
The evidence has three layers.  First,
...
characteristic $\kappa(\cA)$.  This makes $s = 0$ the scalar
point and $s = 1$ the first nontrivial polar locus.
...
root-of-unity specialization.  No identification of a
specific knot-theoretic Habiro series with a specific shadow
tower is proved here; that matching is part of the
conjectural content.
\end{remark}
