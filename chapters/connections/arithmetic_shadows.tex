...
The shadow Postnikov obstruction tower $\Theta_\cA^{\leq r}$
...
and the shadow Postnikov obstruction tower organizes the algebraic data that,
...
the shadow Postnikov obstruction tower $\Theta_{V_\Lambda}^{\le r}$ decomposes
...
The non-lattice regime is where the shadow Postnikov obstruction tower
...
This illustrates a striking dichotomy among holomorphic $c = 24$
...
mixed-Tate world.  The shadow Postnikov obstruction tower is the
...
The shadow Postnikov obstruction tower of the Virasoro algebra carries a
...
\item \emph{Heisenberg:}
  ...
  $r = 2$ with $S_2 = \kappa = 1/2$, $S_r = 0$ for
...
$S_2 = \kappa = 1/2$, $S_r = 0$ for $r \ge 3$.
...
\[
  ...
  N_0 = 0.
\]
Here $\kappa(V_\bZ) = 1/2$ and $d_{\mathrm{arith}} = 1$
