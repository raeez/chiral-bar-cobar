...
$d_{\mathrm{arith}}$ counts Hecke eigenforms detected by
graph-sum amplitudes: for lattice vertex algebras, each
...
into $L$-functions.  The \emph{homotopy-theoretic
component} $d_{\mathrm{alg}}$ measures $A_\infty$ non-formality of
...
For lattice vertex algebras, the Maurer--Cartan element $\Theta_\cA$
connects both the Langlands programme
...
share the same Bernoulli factor.  Both arise from the $\hat{A}$-genus of the
