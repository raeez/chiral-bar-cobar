...
The quantity $d_{\mathrm{alg}}$ itself is \emph{defined} as the
remainder $d - 1 - d_{\mathrm{arith}}$, not independently
characterized.  For class~$\mathbf{G}$ (lattice vertex algebras),
...
Theorem~\ref{thm:shadow-multiplicativity-low-arity} below.
\end{proof}
