...
the expected functional equation, boundedness in vertical strips, and
...
therefore has exactly the conditional status of
Corollary~\ref{cor:moment-automorphy}.
...
status of Conjecture~\ref{conj:irrational-ramanujan}.
\end{proof}
...
Theorem~\ref{V2-thm:universal-holography-master}), and the Vol~III BKM
...
\begin{proposition}[Settled cases; \ClaimStatusConditional]%
...
(Vol~II Theorem~\ref{V2-thm:universal-holography-master}) realises
...
Theorem~\ref*{V3-thm:k3-classification-etingof}) identifies
...
\item \emph{Humbert-monodromy face.} The Humbert surface
  ...
  monodromy order $8$ (Vol~III Theorem~\ref*{V3-thm:humbert-order-K-kappa}),
...
super-EK quantisation (Vol~III Theorem~\ref*{V3-thm:k3-structural-genesis}):
...
Theorem~\ref*{V3-thm:schur-to-delta5-composite} reads: the Schur index of
...
Section~\textup{\ref{sec:koszul-across-genera}} inherited via the
...
\item \textup{(Sharpness.)}  The bound $k_{\max}^{HH}(g)=2g-1$ is
  ...
  in Section~\textup{\ref{sec:koszul-across-genera}} at
