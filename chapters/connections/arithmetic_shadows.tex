...
arithmetic faces (Wave~13 DNA, S11)]
\label{rem:arith-shad-DNA-11}%
...
\index{Wave-13 DNA!universal Phi-trace identity}%
...
bar--cobar side intertwines through $\Phi$ with the automorphic
weight:
...
supertrace, the automorphic weight $\operatorname{wt}(\Delta_5)$ is
the Vol~III supertrace, and $\Phi$ is the single map equating them.
...
$Z(V_{\Lambda_{24}})$ through $\Phi$. This is the Wave-13 bridge
...
Lusztig specialisation (Wave~13 DNA, S8)]
\label{rem:arith-shad-DNA-8}%
...
\index{Wave-13 DNA!three faces of eight}%
...
\emph{Enlarged Vol~I Theorem~C bucket.} The complementarity bucket
$\kappa + \kappa^! \in \{0, 13, 250/3, 98/3\}$ of
Theorem~\ref{thm:complementarity-root-datum} enlarges, on the
Lorentzian-lattice-parametric B-family, to
...
Saito--Kurokawa packet and $M_{24}$ twist (Wave~13 DNA, S9)]
\label{rem:arith-shad-DNA-9}%
...
\index{Wave-13 DNA!Andrianov Saito-Kurokawa}%
...
$11$D SUGRA on $\mathrm{K3} \times T^2$ (Wave~13 DNA, S5)]
\label{rem:arith-shad-DNA-5}%
...
\index{Wave-13 DNA!Delta5 four duality frames}%
...
invariant (Wave~13 DNA, S2)]
\label{rem:arith-shad-DNA-2}%
...
\index{Wave-13 DNA!Delta5 gauge-class classification}%
...
\label{sec:as-wave14-anchors}

\begin{remark}[Wave-$14$ anchor map for the arithmetic shadow tower]
\label{rem:as-wave14-anchors}
\index{wave-14 anchors!arithmetic shadows entry point}
\index{cross-volume bridge!arithmetic shadows}
The arithmetic-shadow chapter sits at three wave-$14$ structural
anchor points:
...
$-24\kappa$ prefactor. The wave-$14$ statement of this chapter
...
CY-to-chiral functor~$\Phi$ realises the Leech-style
...
\section{Wave 13 DNA perspective: Gelfand structural lens}
\label{sec:as-wave13-gelfand-DNA}

\begin{remark}[The Etingof--Kazhdan cohomology group as the arithmetic shadow of $\Delta_5$]
\label{rem:as-DNA-gelfand-ek-cohomology}
The Vol~III Wave-13 classification theorem
...
The Wave-14 arithmetic reading is: $\Delta_5$ itself is the classification
...
\label{rem:as-DNA-gelfand-8-three-faces}
...
\label{rem:as-DNA-gelfand-schur-composite}
