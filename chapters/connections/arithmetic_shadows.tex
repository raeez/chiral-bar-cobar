...
\end{equation}
with $\mu_{32}\subset \mu_{N_{\mathrm{quad}}}$ the
$2$-part of the Bruinier multiplication (Bruinier $2002$ LNM~$1780$
Prop~$5.1$ $2$-adic stratification). The Chern-class refinement
...
Vol~I face of the Vol~III Theorem~C $\mathsf B$-row ceiling
...
value $8$ exactly on the Mukai-enhanced K$3$ Heisenberg.
\end{theorem}
