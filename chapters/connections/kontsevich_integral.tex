...
\label{v1-ch:kontsevich-integral}
...
the algebraic bar-complex differential $D^2 = 0$ holds at all genera
(proved at the convolution level, Theorem~\ref{thm:ambient-d-squared-zero});
...
Conjecture~\ref{conj:v1-vassiliev-bar}.
\end{remark}
...
\end{enumerate}
This gap is the subject of Conjecture~\ref{conj:v1-vassiliev-bar}
...
Five results are proved: the bar-complex/weight-system
identification (Theorem~\ref{thm:bar-weight-systems}), the
propagator restriction to the Kontsevich propagator on
$S^1 \subset \bP^1$
(Proposition~\ref{prop:propagator-restriction}), the genus-$0$
bar/KZ identification (Proposition~\ref{prop:kz-from-bar}), the
Drinfeld associator from bar-cobar monodromy
(Theorem~\ref{thm:drinfeld-associator-bar}), and the
Feynman-transform/graph-complex identification
...
higher genus (Conjecture~\ref{conj:v1-vassiliev-bar},
