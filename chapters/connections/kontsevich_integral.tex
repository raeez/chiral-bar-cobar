...
The Kontsevich integral is a universal Vassiliev invariant built from the same configuration space integrals and logarithmic forms that define the bar construction: it is the bar complex evaluated on a knot complement.
\end{remark}
