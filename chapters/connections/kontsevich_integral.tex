...
The governing question of this chapter is the mathematical role of \emph{Knot invariants and the Kontsevich integral}: how this bridge interfaces with the proved modular Koszul core without blurring theorematic content and programme.
\end{remark}
...
\label{rem:programme-kontsevich}
