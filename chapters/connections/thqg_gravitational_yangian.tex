...
\emph{full collision $r$-matrix}
$r_\cA^{\mathrm{coll}}(z) \in \cA^!\,\widehat{\otimes}\,\cA^!$ of
Remark~\textup{\ref{rem:three-r-matrices}}\textup{(a)},
valued in the tensor square of the Koszul dual
and carrying all pole orders of the OPE.  In particular, for
Virasoro, $r^{\mathrm{coll}}(z)$ has a cubic pole $z^{-3}$ from
