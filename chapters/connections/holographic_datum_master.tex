...
\item \emph{$R$-matrix slot.} We pin the fourth slot to the
 ...
 \]
 Bare $r(z)$ will therefore not be used below.
...
with the pinned bulk slot~$\cC$ remains conjectural.
...
global triangle comparing it to the line model is conjectural.
\end{proposition}
...
\item \emph{Bar-cobar reflection.} The universal twisting morphism
 ...
 strict lane, and $\pi_\cA$ is its tautological twisting datum. This
...
$N \in \{1,2,3,4,6\}$, supplying the conductor side of slot~(5) in the
