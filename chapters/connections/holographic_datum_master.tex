...
the Yangian deformation $Y_z^\hbar(\fg)$ of the universal enveloping
...
$Y_z^\hbar(\fg) = \mathcal{U}(\fg[\![z^{-1}]\!])\otimes\mathbb{C}[\![\hbar]\!]$
...
$Y_z^\hbar(\fg)$ admits the following three identifications:
