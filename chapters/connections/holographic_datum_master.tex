...
theorem is the centrepiece of Part~III: it asserts that the
...
The seven-face master theorem of this chapter is subordinate to a
...
\item the leading $\lambda$-bracket coefficient of the classical
  Poisson vertex algebra of Khan--Zeng~\cite{KhanZeng25};
...
\section{Face 3: the classical $\lambda$-bracket of Khan--Zeng}
...
\begin{theorem}[Face~3: Khan--Zeng PVA; \ClaimStatusProvedHere]
...
Face~3 is the classical-Poisson incarnation of the collision
...
limit functor of Face~3.  Equivalently, the Sklyanin bracket is the
...
Theorem~\ref{thm:hdm-face-2}.  Face~3 is Theorem~\ref{thm:hdm-face-3}.
...
The seven-face programme is the centrepiece of Part~III precisely
