...
$r_{\cH_k}(z)=k\,J\otimes J/z$ is a single tensor with no Lie-bracket
...
$r_{\mathrm{Vir}_c}(z)=(c/2)/z^3+2T/z$ is fixed by every Casimir
...
\begin{itemize}
\item At genus~$0$, $\GRT^{(\geq 3)}$ acts trivially on $r(z)$, the
...
$r(z)$ (Vol~I), the GRT-orbit representatives of $\Face(\cA)$
