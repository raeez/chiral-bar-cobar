...
Every chiral algebra studied in Part~II arose from an algebraic construction.  This chapter reverses the perspective: string amplitudes, gauge theory anomalies, and conformal blocks each independently produce bar-cobar structures.  The recurring pattern --- that physically natural objects organize themselves into a bar complex --- is evidence for Conjecture~\ref{conj:master-bv-brst} (BV/BRST = bar at all genera).  We present the physical constructions and formulate their bar-cobar content as precise mathematical conjectures; physical identifications are conjectural unless theorem-labeled.
