...
The physical theories that first exhibited chiral Koszul phenomena---string amplitudes, gauge theory anomalies, conformal blocks---are here translated into the language of the proved modular core.
\end{remark}
...
boundary construction were established, the remaining filtered
H-level targets and coefficient identities belong to MC4, with the
BV/BRST identification downstream at MC5; see the concordance
(Chapter~\ref{chap:concordance}) for the exact frontier.
...
\begin{remark}[From \texorpdfstring{$\Einf$}{E-infinity} to \texorpdfstring{$\Eone$}{E1}]
