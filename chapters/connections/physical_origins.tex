...
The chiral algebras of this monograph arise naturally in physics: as algebras of local operators in two-dimensional conformal field theory, as operator algebras associated to four-dimensional $\mathcal{N}=2$ theories via the 4d/2d correspondence, and as deformation-quantization algebras in holomorphic Chern--Simons theory.  In each context, bar-cobar duality has a physical interpretation --- as S-duality, as the relation between Higgs and Coulomb branches, or as the passage from classical to quantum field theory --- and the genus expansion $F_g(\mathcal{A})$ computes partition functions.  This chapter sketches these origins without claiming physical rigor; the mathematical content of the preceding chapters stands independently.
...
\begin{theorem}[AGT correspondence; \ClaimStatusProvedElsewhere{} \cite{alday-gaiotto-tachikawa}]\label{thm:agt}
...
\begin{corollary}[Virasoro from gauge theory; \ClaimStatusProvedElsewhere{} \cite{AGT}]\label{cor:virasoro-gauge}
