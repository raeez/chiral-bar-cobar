...
Theorem~\ref{conj:operadic-complexity-detailed} implies that
...
Theorem~\ref{conj:operadic-complexity-detailed}.  The converse
...
Theorem~\ref{conj:operadic-complexity-detailed} identifies the
...
For Gaussian algebras on the proved scalar lane
\textup{(}e.g.\ Heisenberg and the uniform-weight Gaussian
examples\textup{)}, the scalar genus-$g$ partition function is
