...
\cite{FP00}, and $\hat A(x)=(x/2)/\sinh(x/2)$ is their
generating function.
...
\footnote{This is the \emph{OPE $r$-matrix}
$r^{\mathrm{OPE}}(z)$ of
Remark~\textup{\ref{rem:three-r-matrices}}, carrying all OPE
poles and valued in $\cA\otimes\cA$ (pre-dualisation).
