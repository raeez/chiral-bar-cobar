...
imposes constraints on the shadow tower of the pair
$(\cA,\cA^!)$.
...
$\kappa(\mathrm{SVir}_c)=c/2+11/2$
(Remark~\ref{rem:svir-bar-complex}), vanishing at the critical
central charge $c=-11$.  The complementarity sum is
$\kappa(\mathrm{SVir}_c)+\kappa(\mathrm{SVir}_{15-c})=37/2$,
independent of~$c$.  The
critical dimension $c=15$ (ten spacetime dimensions) gives
$\kappa(\mathrm{SVir}_{15})=13$.
