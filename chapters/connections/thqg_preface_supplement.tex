...
scalar-level entry~$\kappa(\cA)$.  The shadow Postnikov obstruction tower
...
the smallest integer~$r$ such that the shadow Postnikov obstruction tower
...
shadow Postnikov obstruction tower: an infinite sequence of irreducible
...
shadow obstruction tower, the Koszul dual, and the genus expansion.  Part~III
