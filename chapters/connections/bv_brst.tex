...
\medskip
\noindent\textbf{Finite coefficient comparison.}
...
\end{enumerate}
All three agree for every $g=1,\ldots,15$. Sample values:
...
\end{itemize}
The two displayed values follow by exact substitution of
$\kappa_{\mathrm{Burns}}=4$ into
$F_g=\kappa\lambda_g^{\mathrm{FP}}$ for $g=1,2$.
\end{computation}
...
entry whose scalar values are calculated here: four weight-one
$\beta\gamma$ pairs give $c=8$ and $\kappa=4$, hence
$F_1=4/24=1/6$ and $F_2=4\cdot7/5760=7/1440$.  It is marked
\ClaimStatusProvedElsewhere{}. The
