...
see Costello--Gwilliam~\cite{CostelloGwilliam}).  Stage~2 assembles the BV
...
synthesis --- identifying the QME as the functorial expression of bar-cobar
Verdier compatibility --- is new to this work.
\end{remark}
