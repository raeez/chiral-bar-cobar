...
The bar complex is the BRST complex: its differential is the BRST operator, its cohomology is the space of physical states, and the BV antibracket is Verdier duality on configuration spaces.
\end{remark}
...
\begin{remark}[Genus-\texorpdfstring{$1$}{1} partition function]\label{rem:genus1-bv}
