...
\]
inscribed in Chapter~\ref{chap:universal-conductor}. The identity
...
$K_E = K_c = K_g$, and per-family corollaries are inscribed in
...
\begin{remark}[Wave-$14$ structural cross-references]
\label{rem:bv-brst-anchors}
\index{wave-14 anchors!BV/BRST entry point}
...
The Wave~13--14 DNA inscribed the $1$-loop origin of $\Delta_5$ as the
...
Chapter~\ref{ch:k3-chiral-bialgebra-platonic} inscribes the same
...
\subsection{Wave 22: Diagrammatic moves and sign-verification for 4-loop cancellations}
...
T^2$) each vanishing under Costello renormalisation. The Wave 21
enumeration inscribed each amplitude topology-by-topology; Wave 22
inscribes the explicit \emph{diagrammatic move} underlying each
...
\subsection{Wave 22: Five-loop extension (33 topologies, $d_5 = 33$)}
