...
The BV formalism applied to chiral algebras identifies the BV complex with the bar complex via Verdier duality, and relates gauge fixing to Koszul duality.  The treatment draws on Gaiotto's work \cite{Gai19} on holomorphic-topological theories.
