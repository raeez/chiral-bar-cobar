...
functor~$\Phi$: for K3-fibered Class~A threefolds the universal
trace identity $\kappa_{\BKM}(X) = K(\Phi(X))/2$ realises the
present BV/BRST conductor formula in the BPS-counting category.
\end{remark}
