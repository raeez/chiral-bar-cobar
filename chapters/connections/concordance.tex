...
\item\label{item:kp-lagrangian}
  ...
  (Theorem~\ref{thm:lagrangian-koszulness}).
...
\item \textbf{``All master conjectures resolved.''}
  ...
  proved: the analytic HS-sewing package is established
  ...
  genuswise BV/BRST/bar identification itself remains
  conjectural (Conjecture~\ref{conj:master-bv-brst}).
  MC3 is proved for all simple types on the
  evaluation-generated core
