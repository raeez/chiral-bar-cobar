...
proved in Volume~II); higher genus requires analytic
propagator comparison and is downstream of MC3/MC4.
\end{remark}
...
9 & BV/BRST completion & Genus~$0$ proved; $\mathcal{W}$-bridge genus~$0$ proved; Quillen equiv.\ unconditional; $g \geq 1$ analytic \\
\bottomrule
\end{tabular}
\end{center}
\noindent
