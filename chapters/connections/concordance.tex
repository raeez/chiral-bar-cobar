...
\section{Anti-pattern registry (cross-volume)}
...
\subsection*{Top-5 cross-voice anti-patterns}
...
\subsection*{Per-voice count (full registry in Vol~III)}
...
\section{Central-charge retraction: constitutional record}
