...
\end{tabular}
\end{center}
For the Heisenberg algebra, the single branch point is
$x=1/k$; for $\widehat{\mathfrak{sl}}_2$ there are two branch
points and one pole.  For $\mathcal W_3$, the two branch points
merge at $c=\infty$ and separate at finite~$c$.
\end{computation}
