...
$\Theta_\cA$ package, and the dependency-ordered conjectural frontier
...
The spectral constraint for Yangian equivariance of the singular
vector is $b = a - (\lambda+1)/2$
(Proposition~\ref{prop:baxter-yangian-equivariance}, $85$~tests);
naturality on $\mathcal{O}_{\mathrm{poly}}$ is proved
(Corollary~\ref{cor:baxter-naturality-opoly}).
\emph{Remaining gap}: extension of the categorical lift from
