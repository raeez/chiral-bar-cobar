...
Theorem~\ref{thm:shadow-archetype-classification} unifies the
four shadow depth classes ($\mathbf{G}$/$\mathbf{L}$/$\mathbf{C}$/%
$\mathbf{M}$) into a single classification theorem with complete
proofs for all primitive archetypes.  Shadow depth is orthogonal
to Koszulness: all four archetypes are chirally Koszul, yet their
