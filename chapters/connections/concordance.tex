...
\paragraph{Shadow archetype classification theorem.}
...
shadow depths differ.  The general classification admits
$\mathbf{F}_r$ for any $r \geq 2$; the gap between
$\mathbf{F}_4$ and $\mathbf{M}$ is empirical.
