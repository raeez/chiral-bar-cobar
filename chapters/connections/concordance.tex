...
\item \emph{Topological Hochschild cohomology} $\HH^*(A, A)$.
 Input: an $E_1$-algebra~$A$ (associative up to homotopy).
 Output: an $E_2$-algebra (Deligne conjecture, proved by
 many authors). Geometric origin: the real line~$\bR$
 and its interval compactifications.
 This is the classical theory of deformation complexes.
...
\item \emph{Categorical Hochschild homology}
 $\HH_*(\cC)$.
