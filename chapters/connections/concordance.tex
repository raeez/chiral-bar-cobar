...
(Chapter~\ref{ch:chiral-koszul-pairs}) and the explicit calculations
in \S\ref{sec:w-completion-kinematics}
(Chapter~\ref{ch:w-algebras-deep}).
...
\item \emph{Heisenberg sewing theorem}
  (Conjecture~\ref{conj:heisenberg-sewing}): the sewing envelope
...
\noindent
\emph{Status.}  All four targets are \ClaimStatusConjectured{}.
The programme is recorded here to fix definitions and the precise
relationship to the algebraic proved core; the decisive first case
is the Heisenberg sewing theorem
(Conjecture~\ref{conj:heisenberg-sewing}).
