...
(10 unconditional, 1 conditional, 1 conjectural).  This is the spine.  Nothing in the extension
...
\noindent
\emph{Status}: ten equivalences proved unconditionally; the Lagrangian
criterion~(xi) is conditional on perfectness of the ambient tangent
complex; $\mathcal{D}$-module purity~(xii) remains conjectural (one direction implied by~(x))
