...
the Lagrangian criterion~(\ref{item:kp-lagrangian}) conditional on
perfectness; $\mathcal{D}$-module purity~(\ref{item:kp-dmod})
...
derived-intersection theory (conditional on
perfectness/non-degeneracy).
