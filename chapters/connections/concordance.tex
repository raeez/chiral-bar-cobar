...
\item\label{item:kp-barrbeck}
  ...
  (Theorem~\ref{conj:barr-beck-lurie-koszulness}).
...
\item\label{item:kp-facthom}
  ...
  (Theorem~\ref{conj:fh-concentration-koszulness}).
...
\item\label{item:kp-fmbdy}
  ...
  (Theorem~\ref{conj:fm-boundary-acyclicity}).
...
\item\label{item:kp-nullvec}
  ...
  (Theorem~\ref{conj:kac-shapovalov-koszulness}).
