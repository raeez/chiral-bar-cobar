...
\begin{remark}[Scope]
This chapter records the principal contributions, literature comparisons,
the three-pillar architecture, the three concentric rings, cross-volume
bridges, and the modular homotopy theory development.  The conjecture
stratification, homotopy templates, six research directions,
and project-level status assessment appear in
...
the Lagrangian criterion~(xi) is conditional on perfectness
of the ambient tangent complex
