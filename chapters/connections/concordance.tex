...
is MC because $D_\cA^2 = 0$).  The shadow Postnikov obstruction tower
...
From the five theorems and the shadow Postnikov obstruction tower,
...
the pipeline extends: the shadow Postnikov obstruction tower is a functor
...
additionally proves shifted-prefundamental generation and pro-Weyl
...
The full infinite shadow Postnikov obstruction tower is uniquely
...
MC3 & Prefundamental CG & \textbf{Partially resolved}.
...
and~H and the shadow Postnikov obstruction tower unconditionally,
...
The shadow Postnikov obstruction tower through arity~$4$ is proved, and the
...
The shadow Postnikov obstruction tower would be a formal
...
\item \textbf{D-module purity: converse direction}
  ...
  ``Koszulness $\Rightarrow$ D-module purity on $\Ran(X)$''
  is proved.  Does the converse hold: does D-module purity of
  the bar factorization coalgebra imply chiral Koszulness?
