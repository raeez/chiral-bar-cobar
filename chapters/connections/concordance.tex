...
(verified $n = 1, \ldots, 8$, $15$~tests) proves that $L^-$ is
\emph{evaluation-stable}: tensoring with $V_n$ preserves the
prefundamental class.  Combined with the unconditional Baxter SES,
