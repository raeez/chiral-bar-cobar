...
twelve equivalent characterizations of chiral Koszulness (ten unconditional, one conditional on perfectness/nondegeneracy, one partially proved).
...
The master conjectures MC1, MC2, and MC4 are proved;
MC3 is proved in type~$A$
(Theorem~\ref{thm:mc3-type-a-resolution}).
The remaining open frontiers are MC3 extension to arbitrary simple
type \textup{(}Conjecture~\ref{conj:mc3-arbitrary-type}:
Hern\'andez--Jimbo prefundamental CG for all Dynkin types\textup{)}
