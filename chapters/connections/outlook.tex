...
proved on the all-types categorical-CG / evaluation-generated-core
surface, and on the standard type-$A$ tower DK-5 is formal once the
relevant realized compact-core or spectral vector-line packets are
supplied),
...
MC1, MC2, and MC4 are proved.  MC3 is only partially resolved:
all-types categorical CG and evaluation-generated-core DK are proved,
