...
This chapter develops the relative and higher-body extensions of the
boundary deformation theory of Chapter~\ref{ch:ym-boundary-theory}.
The relative Hochschild duality theorem
(\S\ref{sec:relative-hochschild-mixed-ks}) captures genuine mixed
couplings between pairs of non-quadratic $\mathcal{W}$-boundaries, while
the higher-body \v{C}ech theory
(\S\ref{sec:w-boundary-cech-theory}) extends the analysis to
arbitrary finite collections of boundary conditions organized into a
simplicial boundary package.
