...
\label{v1-ch:ym-boundary-theory}
...
and a domination estimate (Chapter~\ref{v1-ch:ym-instanton-screening}).
\end{remark}
...
\item \emph{Bar/cobar construction.} Apply the chiral bar and cobar functors of Part~\ref{part:bar-complex} to the
boundary envelope.
...
\item the assumption that $\cA_{\cB}$ lies on the Koszul locus of Part~\ref{part:bar-complex} and belongs to a class
