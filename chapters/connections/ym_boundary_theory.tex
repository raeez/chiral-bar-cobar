...
categories are controlled by bar-cobar duality.  The framework of
Parts~I and~II must survive contact with the nonperturbative,
instanton-rich, confining world of Yang--Mills.

A chain of controlled reductions connects the two sides.  From the boundary
...
Throughout, we separate what the algebraic engine proves
...
bridge for untwisted Yang--Mills, remain conditional---but they are now
within the formalism.

The programme is organized around a single chain of ideas:
\[
...
\]
The first four arrows are proved unconditionally in the present chapter
and the two that follow it.  The final passage requires an untwisting
bridge datum and a screening domination estimate
...
This section isolates the mathematically controlled input from
...
Koszul-admissible, bar-cobar inversion (Theorem~\ref{thm:bar-cobar-adjunction}) applies and gives the quasi-isomorphism
...
Under vanishing of infinitesimal automorphisms and dual negative-degree Hochschild classes, the formal boundary moduli problem linearizes completely.  The Koszul dual center provides actual formal coordinates on the deformation space, not merely the tangent space.
\end{remark}
...
\end{enumerate}
Together these give a local geometry of boundary moduli, not merely a linear duality.
\end{remark}
