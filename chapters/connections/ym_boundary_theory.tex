...
The boundary data of a four-dimensional gauge theory encode the chiral
algebra of a twisted holomorphic-topological theory whose defect
categories are controlled by bar-cobar duality.  From the boundary
...
central screening extracts the visible infrared content; and a
conditional spectral-gap argument translates visible-center collapse
into a mass-gap criterion.

The boundary BRST package, the tangent-to-center correspondence, central
