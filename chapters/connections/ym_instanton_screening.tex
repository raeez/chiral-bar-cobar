...
The preceding chapters organize perturbative and twisted Yang--Mills
boundary sectors.  To bring instantons, confinement, and the untwisted
mass-gap problem into scope, three new ingredients enter:
...
extracting the genuinely visible infrared center by quotienting by
instanton-generated screening charges;
\item a \emph{Hilbert-screening bridge} that translates visible-center
...
\end{enumerate}
The results of this chapter do \emph{not} solve the Yang--Mills
mass-gap problem.  Rather, they materially enlarge the framework so
that instanton sectors, confinement criteria, and a conditional
...
\begin{proof}
This is the same linear-algebra argument as in the unscreened higher-body \v{C}ech theorem
(Theorem~\ref{thm:w-boundary-cech-duality}), now applied
...
The screening Hodge theory of the preceding section provides an
external spectral-gap criterion.  The point of the present section is
to show that the screening side of the comparison is already
\emph{internal} to the instanton-completed boundary package.  Once one
equips the defect algebra with a positive vacuum state, central
screening classes produce a canonical positive quadratic form on the
GNS space, and the mass-gap problem reduces to bounding
$H_{\mathrm{YM}}$ below by this internal form on a dense algebraic
core.
...
instanton-completed boundary package: the defect algebra $\mathcal A_{\mathrm{def}}$, the vacuum state $\tau$,
