...
\begin{theorem}[\textbf{G12$'$}: Algebraic quantum extremal surface]\ClaimStatusConjectured
\label{thm:thqg-g12-qes}\label{item:g12}
...
\begin{theorem}[\textbf{G13}: Modular flow from shadow connection]\ClaimStatusHeuristic
\label{thm:thqg-g13-modular-flow}\label{item:g13}
...
\begin{theorem}[\textbf{G16}: Replica structure]\ClaimStatusHeuristic
\label{thm:thqg-g16-replica}\label{item:g16}
