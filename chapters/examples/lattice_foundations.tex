...
This chapter develops the lattice vertex algebra and its bar
complex, establishing the explicit presentations and OPE
data on which all subsequent computations depend.
