...
The governing question of this chapter is the mathematical role of \emph{Setup and conventions}: what this family or computation reveals about the modular bar-cobar mechanism, and which parts of that portrait are proved, model-level, or shadow-level.
\end{remark}
