...
In the shadow obstruction tower, $\beta\gamma$ occupies a unique position.
Heisenberg and lattice algebras (class~G) have
trivial towers terminating at arity~$2$.  Affine Kac--Moody
algebras (class~L) terminate at arity~$3$.  Virasoro and
$\mathcal{W}_N$ (class~M) have infinite towers.  The
$\beta\gamma$ system is the sole representative of class~C
(contact/quartic): nontrivial beyond the
scalar level, yet terminating at arity~$4$.
