...
The shadow Postnikov tower tells the decisive story.  The scalar
curvature vanishes: $\kappa_{\beta\gamma} = 0$, so the bar complex
is uncurved and the genus tower is trivial at the scalar level.  But
...
That a free bosonic system with $\kappa = 0$ can still have a
...
For the $\beta\gamma$ system, $\kappa = 0$ (the bar complex is
uncurved at all genera) but the shadow Postnikov tower is
...
\index{shadow Postnikov tower!beta-gamma termination}
