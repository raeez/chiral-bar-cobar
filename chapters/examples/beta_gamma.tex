...
with two generators of complementary conformal weight: $\beta$ of
weight~$\lambda$ and~$\gamma$ of weight~$1-\lambda$, coupled by a
single simple-pole OPE
$\beta(z)\gamma(w) \sim 1/(z{-}w)$.
Its Koszul dual is the $bc$ ghost system
(Theorem~\ref{thm:betagamma-fermion-koszul}), exchanging bosonic
and fermionic statistics: the chiral lift of
$\mathrm{Sym}(V)^! = \Lambda(V^*)$.

Within the shadow Postnikov tower, $\beta\gamma$ occupies a position
unique among all standard families.
The Heisenberg and lattice algebras (class~G) have
trivial towers terminating at arity~$2$.  The affine Kac--Moody
algebras (class~L) terminate at arity~$3$.  The Virasoro and
$\mathcal{W}_N$ algebras (class~M) have infinite towers.  The
$\beta\gamma$ system is the sole representative of class~C
(contact/quartic): its shadow tower is nontrivial beyond the
scalar level yet still terminates, at arity~$4$.
...
\index{shadow Postnikov tower!beta-gamma termination@$\beta\gamma$ termination}
