...
Within the shadow Postnikov obstruction tower, $\beta\gamma$ occupies a position
...
(contact/quartic): its shadow obstruction tower is nontrivial beyond the
...
uncurved, since the $\beta\gamma$ OPE has no double pole) but the shadow Postnikov obstruction tower is
...
\begin{corollary}[$\beta\gamma$ shadow Postnikov obstruction tower:
...
On the weight-changing line, the shadow Postnikov obstruction tower
