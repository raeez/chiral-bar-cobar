The Heisenberg genus tower, previewed in Chapter~\ref{ch:heisenberg-frame}, admits a closed-form expression in terms of Eisenstein series.  This section carries out the full computation at all genera, establishing the generating function whose recognition as the $\hat{A}$-genus is explained by the family index theorem (Theorem~\ref{thm:family-index}).
