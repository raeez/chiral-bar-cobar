...
The Heisenberg algebra is the Gaussian archetype: its shadow
Postnikov tower terminates at weight~$2$, all transferred
operations $\ell_n^{\mathrm{tr}}$ vanish for $n \geq 3$, and the
genus expansion is controlled entirely by the scalar modular
