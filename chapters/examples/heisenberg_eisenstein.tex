...
here and constitute the bridge from formal
...
\label{rem:heisens-1}
The Heisenberg-Eisenstein construction, applied at the K3 base point
of the chiral bialgebra $\mathbf H_{\Delta_5}$, produces the Gritsenko 1995 additive lift
\[
...
(the class-G Heisenberg chamber in Theorem~C on the $\mathcal B$-family), the K3
