The Heisenberg genus tower admits a closed-form expression in terms of Eisenstein series; the resulting generating function is the $\hat{A}$-genus (Theorem~\ref{thm:family-index}).
