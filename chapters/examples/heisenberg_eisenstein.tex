...
\begin{theorem}[Genus-2 obstruction class for \texorpdfstring{$\mathcal{H}_\kappa$}{H_kappa}; \ClaimStatusConditional]\label{thm:heisenberg-genus2-obstruction}
...
This Heisenberg degeneration is the Eisenstein part of the
Arthur--Hecke decomposition for the unnormalised Igusa square
$\Phi_{10}^{\mathrm{un}}=\Delta_5^2$:
\[
L(s,\Phi_{10}^{\mathrm{un}})
=L(s,\Delta\otimes E_6)\cdot\zeta(s-9)\cdot\zeta(s-8).
\]
The two $\zeta$-shifts correspond to the two Heisenberg-dual directions
in the Eisenstein-modular spectrum. The Oberdieck--Pandharipande
reduced-DT normalization is instead
$D_5^2=(64^{-1}\Delta_5)^2=4096^{-1}\Delta_5^2$; it is not used in
this Arthur--Hecke statement. Primary-lit: Gritsenko 1995, Eichler-Zagier 1985
(Jacobi forms), Langlands-Shahidi theory.
\end{remark}
