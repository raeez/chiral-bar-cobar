...
(\ClaimStatusProvedElsewhere, Klingen 1967); %TODO: add citation (Klingen not in bibliography)
...
correction ensuring modular covariance).  Note: $\widetilde{G}_\tau$ has a double pole at $z=0$ and equals $-\partial_z G_\tau(z)$, where $G_\tau$ is the simple-pole Green function of Theorem~\ref{thm:heisenberg-genus-one-complete}.
