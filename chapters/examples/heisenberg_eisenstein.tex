...
rank-one level~$k$ is exactly the programme invariant:
\[
\kappa(\cH_k)=k.
\]
...
collapse pattern $r_{\max}=2$). MA-6 discipline: the five
...
\begin{theorem}[Faber--Pandharipande scalar free energy; \ClaimStatusProvedHere]\label{thm:dmvv-agreement}
