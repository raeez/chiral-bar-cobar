...
$V = \bC J \oplus \bC T$. The degree-$2$ scalar
$\Sigma_2$-coinvariant keeps the central self-OPE channel and discards
the non-scalar $J$-, $T$-, and descendant-valued channels. Hence
$\mathrm{av}(r(z)) = \kappa = \Psi$, recovering the scalar modular
characteristic.
\end{computation}
