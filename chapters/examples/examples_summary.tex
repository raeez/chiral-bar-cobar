...
$\widehat{\mathfrak{sl}}_3$ (level~$k$)
  & 8 & 36 & 204 & 1352$^\dagger$ & 9892$^\dagger$ & --- & --- & --- & --- & --- & $8^n$ \\
\hline
$\mathrm{Vir}_c$
  & 1 & 2 & 5 & 12 & 30 & 76 & 196 & 512 & 1353 & 3610 & $3^n$ \\
\hline
$\mathcal{W}_3$
  & 2 & 5 & 16 & 52 & 171$^\dagger$ & 564$^\dagger$ & --- & --- & --- & --- & $3.3^n$ \\
\hline
Yangian $Y(\mathfrak{sl}_2)$
  & 4 & 10 & 28 & 82$^*$ & 244$^*$ & 730$^*$ & --- & --- & --- & --- & $3^n$ \\
\hline
\end{tabular}
}
...
for all $n \geq 1$; values through $n = 10$ in
Conjecture~\ref{conj:yangian-bar-gf}.\\
$^\dagger$\,Predicted from conjectured rational GF:
$\widehat{\mathfrak{sl}}_3$ via \eqref{eq:sl3-bar-gf},
$\mathcal{W}_3$ via \eqref{eq:w3-bar-recurrence};
