...
The governing question of this chapter is the mathematical role of \emph{examples summary}: what this family or computation reveals about the modular bar-cobar mechanism, and which parts of that portrait are proved, model-level, or shadow-level.
\end{remark}
...
fixed to `2'.  The live stage-$4$ comparison is therefore four free
...
is the displayed stage-$4$ six-channel problem.
...
extension past the evaluation-generated sector and then DK-4/DK-5, the
...
one mixed-tensor residue computation; Proposition~\ref{prop:yangian-dk5-compact-generators}
then reduces the remaining completed module-category enhancement to the
compact generator packet.
...
\item Yangians: the proved content now includes the natural DK core
  ...
  extension to full factorization categories and the dg-shifted
  Yangian comparison beyond that natural core remain conjectural
