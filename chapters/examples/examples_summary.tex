...
which exceeds practical hand computation.  Similarly, the $\mathcal{W}_3$
and Yangian $Y(\mathfrak{sl}_2)$ gaps await either explicit machine
computation or the discovery of closed-form generating functions
analogous to the Riordan/Motzkin formulas for
...
$\beta\gamma \otimes \mathcal{H}$ (Theorem~\ref{thm:wakimoto-rep}),
