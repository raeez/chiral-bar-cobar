...
\item the first genuinely open standard-tower packets are:
  ...
  content is the visible pairing package isolated in
  ...
  once theorematic finite RTT quotients are added,
  Proposition~\ref{prop:yangian-typea-realization-criterion}
  upgrades this to the H-level realization, and
  Corollaries~\ref{cor:yangian-typea-realization-plus-compacts}
  and~\ref{cor:yangian-typea-realization-plus-fundamental-packet}
  package the remaining categorical step as compact-core equivalence or
  completed fundamental-packet transport.
\end{enumerate}
...
shared-seed finite-quotient data to the H-level realization, while
Corollaries~\ref{cor:yangian-typea-realization-plus-compacts}
and~\ref{cor:yangian-typea-realization-plus-fundamental-packet}
package the remaining categorical step.  The last sentence is a
...
\item on the standard type-$A$ RTT Yangian tower, the H-level
  ...
  theorematic finite RTT quotients are added,
  Proposition~\ref{prop:yangian-typea-realization-criterion} supplies
  the H-level realization, and
  Corollaries~\ref{cor:yangian-typea-realization-plus-compacts}
  and~\ref{cor:yangian-typea-realization-plus-fundamental-packet}
  reduce the completed categorical step to compact-core equivalence or
  completed fundamental-packet transport.
\end{enumerate}
...
in place, the downstream standard-tower MC5 reduction is already
theorematic
...
and~\ref{cor:yangian-typea-realization-plus-fundamental-packet}.  The last
sentence is then the dependency order encoded by
Proposition~\ref{prop:standard-tower-mc5-reduction}.
\end{proof}
