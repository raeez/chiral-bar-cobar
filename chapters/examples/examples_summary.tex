...
\item the first genuinely open standard-tower packets are:
  ...
  Conjecture~\ref{conj:winfty-stage4-ward-inheritance}, whose open
  content splits into the visible mixed-weight orthogonality and
  visible diagonal normalization conjectures, isolated in
  Proposition~\ref{prop:winfty-stage4-visible-pairing-gap};
  ...
  Proposition~\ref{prop:yangian-canonical-hlevel-target}; once its
  RTT-adapted finite-quotient/shared-seed package is verified,
  Proposition~\ref{prop:yangian-typea-realization-criterion}
  upgrades an RTT-adapted dg model of that target to the standard RTT
  realization, and
