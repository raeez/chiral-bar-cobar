...
\item[\textbf{T1$\frac{1}{2}$.}] \emph{Unconditional via PBW}
  ...
  (Theorem~\ref{thm:km-chiral-koszul}); higher-genus degeneration
  proved unconditionally (Theorem~\ref{thm:pbw-allgenera-km}).
  All invariants follow from the main theorems.
\item[\textbf{T2.}] \emph{PBW-conditional} (Virasoro, $\mathcal{W}$-algebras):
  Koszulness proved via the PBW spectral sequence
  (Theorem~\ref{thm:virasoro-chiral-koszul}).
  Higher-genus degeneration for Virasoro and $\mathcal{W}_N$ remains
