...
We now consolidate the explicit computations of Part~II into a single reference.  Across fifteen families of chiral algebras --- from the free fermion (where the bar complex collapses) to toroidal algebras (where Eisenstein series govern the differential) --- a set of universal invariants emerges: central charges, curvature coefficients, bar cohomology growth rates, and spectral sequence collapse pages.  The Master Table below records these for every algebra computed in this monograph, making visible the patterns that the abstract theory of Part~I predicts: complementarity sums $c + c' = K$, genus universality $\mathrm{obs}_g = \kappa \cdot \lambda_g$, and the shared discriminant phenomenon.
