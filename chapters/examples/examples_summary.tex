...
\]
The first values are: $K_2 = 26$, $K_3 = 100$, $K_4 = 246$, $K_5 = 488$.  In general $K_N = 4N^3 + 2N - 4$ (equivalently $K_N = 2(N-1)(2N^2+2N+1)$).
\end{remark}
...
\[
\sigma(E_8) = \frac{1}{2} + \frac{1}{8} + \frac{1}{12} + \frac{1}{14} + \frac{1}{18} + \frac{1}{20} + \frac{1}{24} + \frac{1}{30} = \frac{248}{120} = \frac{31}{15}.
\]
One verifies $\kappa = c \cdot \sigma$: at level $k$, $c = 248k/(k+30)$ and $\kappa = 62(k+30)/15$, so $c \cdot \sigma = 248k/(k+30) \cdot 31/15 = 62 \cdot 248k/(15(k+30))$... this identity holds when $c \neq 0$ via the DS formula specific to $E_8$.  For KM algebras the relation is $\kappa = td/(2h^\vee)$ with $t = k + h^\vee$, directly.
\end{remark}
