...
\item the first genuinely open standard-tower packets are:
  ...
  Proposition~\ref{prop:winfty-stage4-visible-pairing-gap}; the first
  next reduced stage is the eleven-entry packet
  $\mathcal{J}_5^{\mathrm{red}}$ of
  Corollary~\ref{cor:winfty-ds-stage5-reduced-packet}, which contracts
  under Corollary~\ref{cor:winfty-stage5-residue-eight-channel} to
  eight higher-spin channels; on the
