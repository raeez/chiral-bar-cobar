...
the Koszul dual discriminant $\Delta_{\cA}(x)$ is an invariant of
the modular characteristic package.  Specifically:
\begin{enumerate}[label=\textup{(\roman*)}]
...
the modular characteristic package~$\mathcal{C}_{\cA}$
