...
The governing question of this chapter is the mathematical role of \emph{w algebras deep}: what this family or computation reveals about the modular bar-cobar mechanism, and which parts of that portrait are proved, model-level, or shadow-level.
\end{remark}
...
Conjecture~\textup{\ref{conj:master-infinite-generator}} \textup{(MC4: filtered H-level comparison for standard infinite towers).}
\end{conjecture}
...
that determine Conjecture~\ref{conj:w-infty-bar} are now extracted:
\begin{enumerate}[label=\textup{(\roman*)},nosep]
\item $\mathcal{W}_\infty$ side: all four DS OPE coefficients
  extracted as explicit rational functions of~$c$
  ...
  $c_{444}^2 = 112c^2(2c-1)(3c+46)/[(c+24)(7c+68)(10c+197)(5c+3)]$,
...
\item Yangian side: auxiliary kernel
  ...
  $N = 2, 3, 4$ ($156$~tests); single residue
  $P(e_1 \otimes e_2) = e_2 \otimes e_1$ determines the full structure.
\end{enumerate}
\end{remark}
