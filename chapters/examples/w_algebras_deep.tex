...
(Theorem~\ref{thm:winfty-all-stages-rigidity-closure}) is a
...
$\mathsf{C}^{\mathrm{res}} = \mathsf{C}^{\mathrm{DS}}$
--- treated as the live MC4 open problem in earlier sections ---
...
\begin{theorem}[Scalar saturation of $\mathcal{W}_\infty$]\label{thm:winfty-scalar}
\ClaimStatusProvedHere
