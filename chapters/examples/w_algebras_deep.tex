...
Drinfeld--Sokolov reduction produces $\mathcal{W}$-algebras from affine Lie algebras, but the algebraic output depends on geometric data: jet-space coordinates on affine flag varieties, chiral de~Rham resolutions, and screening operators inherited from the nilpotent orbit.  This chapter traces those dependencies explicitly and connects each to the modular bar-cobar story.
\end{remark}
