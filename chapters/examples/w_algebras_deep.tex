...
\subsection{Companion chapters and theorem ownership}
...
The source
\texttt{chapters/examples/n2\_superconformal.tex}, included
immediately after this file, owns the \(N=2\) OPE, spectral-flow,
and bar-comparison calculations.  This chapter retains these labels
as reference anchors and delegates the scalar derivation to that
source.
\begin{equation}
