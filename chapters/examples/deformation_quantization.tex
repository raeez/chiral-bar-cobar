...
This is the point where the monograph turns its algebraic engine back
toward quantization.  The bar-cobar adjunction, the modular
characteristic, and the shadow Postnikov tower were developed in
Part~I as abstract structural theorems.  Deformation quantization is
where these structures meet the oldest problem in mathematical physics:
...
The key insight, which makes the chapter more than an application, is
