...
$r^{\mathrm{dyn}}(u, Z) = \partial_Z\log\Phi_{10}^{\mathrm{un}}(Z)\cdot\Omega_{\mathrm{K3}}
+ O(u^{-2})$.
...
factors as $(\partial_Z\log\Phi_{10}^{\mathrm{un}})^2\cdot
...
$(\mathfrak g_{\Delta_5},\delta_{\mathrm{GN}})$ with $r$-matrix
$r(u, Z) = \Omega_{\mathrm{Mukai}}/u + \partial_Z\log\Phi_{10}^{\mathrm{un}}\cdot
