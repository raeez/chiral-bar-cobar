...
of Theorem~H; the two agree only after passing to the derived chiral
centre $Z^{\mathrm{der}}_{\mathrm{ch}}$ (concordance T7($\beta$)(ii)),
...
of a $\cD_X$-module\textup{)}, the derived chiral centre
$Z^{\mathrm{der}}_{\mathrm{ch}}$ (concordance T7($\beta$)(ii))
satisfies
\[
...
K3 base point, to the BKM Lie bialgebra $\mathfrak g_{\Delta_5}$:
\[
...
equivalent up to gauge, and $\mathbf H_{\Delta_5}$ is the unique
...
The uniqueness of the Etingof--Kazhdan
quantisation $\mathbf H_{\Delta_5}$ was established via the cohomological moduli line
$H^2(\mathfrak g_{\Delta_5})^{\mathbb Z/2,\,K(1)}\cong\mathbb C\cdot
\Delta_5$. This section traverses that moduli line to the opposite endpoint
...
this is the Siegel--Borcherds associator.
\end{proof}
...
\begin{theorem}[Kazhdan classical-limit theorem, Vol~I form]
...
is the CY-to-chiral image of the K3 base point.
\end{proof}
...
Together with the quantum structure at $\hbar^2 = -1/8$ established in
Remark~\ref{rem:defq-1}, the classical-limit theorem closes the Kazhdan axis on
$\mathbf H_{\Delta_5}$:
\begin{itemize}
...
The classical-limit theorem pins one end of the
...
the Etingof $c_{12}^{(9)}$ coefficient appearing in the pentagon
