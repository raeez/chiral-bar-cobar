...
The governing question of this chapter is how Kontsevich-style deformation quantization appears as the genus-$0$ shadow of the chiral bar-cobar mechanism, and which parts of that lift are actually proved here.
\end{remark}
