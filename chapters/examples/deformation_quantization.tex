...
Kontsevich's formality theorem constructs star products on Poisson manifolds via configuration space integrals on the same spaces that define our bar complex.  The bar-cobar machinery identifies Kontsevich's formula as the genus-$0$ shadow of a chiral quantization defined at all genera.
