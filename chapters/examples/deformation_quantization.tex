...
The governing question of this chapter is the mathematical role of \emph{Chiral deformation quantization}: what this family or computation reveals about the modular bar-cobar mechanism, and which parts of that portrait are proved, model-level, or shadow-level.
\end{remark}
...
In the monograph's frontier order, the theorematic input here is the boundary genus expansion itself; the open task is the downstream MC5 identification of that series with a bulk path integral, not any missing finite-type bar construction.
