...
\item The Jacobi identity of the PVA ensures vanishing of $o_3$ (the cubic quantization obstruction).  Higher obstructions $o_r$ for $r \geq 4$ are governed by the shadow tower of the quantized algebra and do not automatically vanish.  (Koszulness of the quantized algebra is a separate property from shadow tower termination; both finite and infinite shadow depth algebras can be Koszul.)
\end{enumerate}
\end{construction}
