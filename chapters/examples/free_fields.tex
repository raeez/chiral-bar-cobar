...
From the standpoint of the shadow obstruction tower in $\gAmod$
...
\index{shadow obstruction tower!free-field atoms}
...
obstruction tower terminates at arity~$2$, meaning
...
MC3 package.  (MC3 thick generation on the evaluation-generated core
is now proved for all simple types by
Corollary~\ref{cor:mc3-all-types}; the residual DK-4/5
