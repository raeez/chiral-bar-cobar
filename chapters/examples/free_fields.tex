...
free-field bar complex and the proved type-$A$ MC3 thick-generation
package; extension beyond type~$A$ remains open.
\end{remark}
...
The geometric bar complex provides the algebraic package behind
perturbative string-theory language:
\begin{enumerate}[label=\textup{(\roman*)}]
