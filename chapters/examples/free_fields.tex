...
B (inversion) &
 ...
 Heisenberg bar-cobar qi (Thm~\ref{thm:heisenberg-koszul-dual-early}) \\
C (complementarity) &
...
At the separating-node degeneration of the genus-$2$ Siegel character of the K3 chiral bialgebra $\mathbf H_{\Delta_5}$ (Vol~III Chapter~\ref{V3-ch:k3-chiral-bialgebra-platonic}), $1/\Phi_{10}(\mathrm{diag}(\tau, \rho)) = 1/\eta(\tau)^{24} \cdot 1/\phi_{10,1}(\rho)$: the $\eta^{24}$ free-field denominator reappears on the elliptic $\tau$-direction, times the Jacobi form $\phi_{10,1}$ on the $\rho$-direction.
\end{remark}
