...
The Heisenberg algebra has one generator, one pole, and a shadow
tower that terminates at arity~$2$.  Free-field archetypes break this
degeneracy: two generators of complementary statistics produce the
first nontrivial contact shadow, forcing the tower to arity~$4$
(class~C).  The $\beta\gamma$ and $bc$ systems are the simplest
algebras where the quartic stratum-separation mechanism operates
(Chapter~\ref{chap:beta-gamma}), while the free fermion remains
Gaussian (class~G) by fermionic antisymmetry.  Each pair exhibits
Koszul duality in its purest form: statistics exchange and
