...
\end{tabular}
\end{center}
This is not a formal analogy: it is the genus-$0$ projection of the
Chriss--Ginzburg structure principle
...
$N = k$.  In the Chriss--Ginzburg framework, this identity is the
