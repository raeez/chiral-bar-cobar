...
at every genus
\textup{(}UNIFORM-WEIGHT; all currents $J^a$ have conformal weight~$1$, so
...
\textup{(}UNIFORM-WEIGHT: all currents share conformal weight~$1$, so
...
\textup{(}Conjecture~\ref{conj:admissible-koszul-rank-obstruction}
supplies the inequality
$\dim H^2 \geq \mathrm{rk}(\fg)$; the present conjecture sharpens
this to equality\textup{)}.  The compute engine
