...
Fulton--MacPherson compactification.  The shadow Postnikov obstruction tower
...
In the shadow Postnikov obstruction tower, affine Kac--Moody
...
\begin{remark}[Shadow Postnikov obstruction tower for Kac--Moody]\label{rem:km-master-mc}
...
\begin{corollary}[Affine shadow Postnikov obstruction tower:
