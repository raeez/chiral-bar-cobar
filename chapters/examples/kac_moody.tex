...
\begin{theorem}[Screening charges implement bar differential; \ClaimStatusConditional]\label{thm:screening-bar}
...
\begin{theorem}[Genus-1 bar-cobar inversion for \texorpdfstring{$\widehat{\mathfrak{sl}}_{2,k}$}{sl-hat_2,k}; \ClaimStatusConditional]
...
\begin{theorem}[Genus-1 bar-cobar inversion for \texorpdfstring{$\widehat{\mathfrak{sl}}_{3,k}$}{sl-hat_3,k}; \ClaimStatusConditional]
...
Frenkel--Teleman~\cite{FT06} proved (\ClaimStatusConditional):
