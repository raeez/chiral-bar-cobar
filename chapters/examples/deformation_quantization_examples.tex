...
= K(\mathcal{A})/2
\]
where $K(\mathcal{A}) = c(\mathcal{A}) + c(\mathcal{A}^!)$ is the
Koszul conductor, independent of~$\hbar$
(Theorem~\ref{thm:central-charge-complementarity}).
For affine Kac--Moody and free fields, $\kappa + \kappa' = 0$;
for the Virasoro algebra, $\kappa + \kappa' = 13$
