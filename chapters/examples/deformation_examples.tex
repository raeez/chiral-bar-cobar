...
Coisson algebras (Poisson vertex algebras) are $\mathcal{D}_X$-modules
quantizing to $\Einf$-chiral algebras (singly quantum);
$\Pinf$-chiral algebras are genuine chiral algebras ($\Einf + L_\infty$)
quantizing to $\Eone$-chiral algebras (doubly quantum).  The examples
in this chapter realize the full ladder and verify bar-cobar predictions
at each level.
\end{remark}
...
\end{remark}
The examples range from Coisson algebras (Poisson vertex algebras, the commutative starting point) through star products on lattice vertex algebras to symplectic fermion deformations, illustrating the full hierarchy $\mathrm{Coisson} \to \Einf \to \Eone$ and verifying the bar-cobar predictions in each case.\label{rem:deformation-examples-hms}
