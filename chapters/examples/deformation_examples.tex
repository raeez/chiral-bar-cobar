...
$bc$ system at $\lambda = 1$ (where $\lambda$ is the
conformal weight of $b$; cf.\ Section~\ref{sec:betagamma-koszul-dual}).
Its Koszul dual is the $\beta\gamma$ system at $\lambda = 1$.
