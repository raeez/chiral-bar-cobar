...
The governing question of this chapter is how explicit deformation examples realize the ladder from coisson data to chiral algebras, and which bar-cobar predictions survive across that progression.
\end{remark}
