...
The shadow-class transition
$\mathbf{G} \to \mathbf{M}$ that distinguishes
$V^\natural$ from its Niemeier cousins is an instance of the
quadrichotomy $\{\mathbf{G},\mathbf{L},\mathbf{C},\mathbf{M}\}$
analysed in
Chapter~\ref{chap:shadow-quadrichotomy-platonic}; the
Virasoro-sector complementarity sum $\kappa + \kappa' = 13$
witnesses the universal Koszul conductor $K = 13$ for the
class-$\mathbf{M}$ Virasoro lane, computed from
...
\ClaimStatusConditional]\label{prop:moonshine-kappa}%
