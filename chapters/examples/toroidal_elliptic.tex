...
Conjecture~\ref{conj:v1-master-infinite-generator}, not the standard
...
(Construction~\ref{constr:v1-platonic-package}); what remains is the
...
\item \emph{Modular factorization envelope.} Is there a
 ...
 (Definition~\ref{def:v1-cyclically-admissible}) that
