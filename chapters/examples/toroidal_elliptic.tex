...
\item the Leech lattice VOA $V_\Lambda$, with
  ...
  $\kappa(V_\Lambda) = 24$, class $\mathbf{G}$.
\end{enumerate}
...
$c = 24$, $\kappa = 24$, class $\mathbf{G}$, and
...
$\kappa = k$, class $\mathbf{G}$), the conjecture predicts
...
At $k = 0$ the seed degenerates and $\kappa$ vanishes on
...
for which $\kappa(\cH_k) = k$ (AP39) and the shadow class
...
The bar-complex arity-$2$ class $\kappa = 2k$ matches the
$N = 2$ case of
...
arity-$2$ scalar $\kappa = Nk$ is the Nakajima Heisenberg
