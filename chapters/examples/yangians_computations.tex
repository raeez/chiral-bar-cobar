...
\ClaimStatusProvedHere]
\label{conj:baxter-exact-triangles}\label{thm:baxter-exact-triangles}
...
(Proved by Theorem~\ref{thm:mc3-type-a-resolution} and
...
\begin{theorem}[Pro-Weyl recovery of ordinary standards; \ClaimStatusProvedHere]
\label{conj:pro-weyl-recovery}\label{thm:pro-weyl-recovery}
...
\begin{theorem}[DK on compacts, extended by completion; \ClaimStatusProvedHere]
