...
\end{enumerate}
Components~\textup{(ii)}--\textup{(iv)} extend to all simple Lie algebras. Component~\textup{(i)} is proved for type~$A$ (Theorem~\ref{thm:mc3-type-a-resolution}) and expected for types~$B$ and~$C$ (Proposition~\ref{prop:mc3-type-b-folding}).
\end{proposition}
