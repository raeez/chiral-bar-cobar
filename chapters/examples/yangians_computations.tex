...
is Drinfeld's~\cite{Drinfeld87} and Jimbo's~\cite{Jimbo85}.  In the
...
\begin{theorem}[Quantum $R$-matrix from the shadow tower;
...
\item \emph{XXZ chain \textup{(}trigonometric, from $U_q(\hat{\mathfrak{sl}}_2)$\textup{)}.}
  ...
  \quad i = 1, \ldots, M.
  \end{equation}
  These arise from the genus-$0$ shadow tower on
