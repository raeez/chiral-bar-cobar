...
master-conjecture~MC3. Accordingly, the MC3 master
...
the K3 Fock space. The explicit
...
coefficient of $\rho^N$ in $\log\Phi_{10}^{\mathrm{un}}$ past the wall satisfies the
