...
comparison, it remains downstream of the post-core MC3 completion
packet and the later categorical bridge inputs.
(Contributing to Conjecture~\ref{conj:master-dk-kl}.)
\end{remark}
...
post-CG MC3 packet: one still needs the shifted-prefundamental
generation and completion input beyond the type-$A$ surface.
\end{remark}

\begin{theorem}[DK on compacts and completion extension; \ClaimStatusConjectured]
