...
\[
 \begin{aligned}
  ...
  \kappa_{\mathrm{BKM}}(\Phi_{10}) &= c_{10}(0)/2 = 5,\\
  \kappa_{\mathrm{fiber}}(K3) &= 2,
 \end{aligned}
\]
and K3-specific spectrum $\{2, 3, 5, 24\}$ from four distinct
constructions (Mukai lattice, Igusa $\Phi_{10}$ via Gritsenko $\Delta_5$,
BKM Borcherds weight, K3 fibre-rank). The Mukai-doubling identity
...
(K3$\times$E or quintic) $\kappa_{\mathrm{ch}} = 0$ with $\kappa_{\mathrm{BKM}} = 5$
