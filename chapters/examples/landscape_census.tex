...
of the Humbert divisor $H_1\subset\overline{\mathcal{A}_2}$ (Wave 13 inscription).
\end{proposition}
...
$\{0, 8, 13, 250/3, 98/3\}$ is generated by the seven landmark
...
\begin{remark}[Landscape census row at K3$\times$E: the canonical Wave~13 base point]
\label{rem:landscape-1}
The landscape census's K3$\times$E row is the Wave~13 canonical base
...
specialisation $\hbar^2 = -1/8$ selects this row as the Wave~13 canonical
...
\begin{remark}[Landscape census Wave~13 rows beyond K3$\times$E]
\label{rem:landscape-2}
Extending the Wave~13 base point through the landscape: (i) CY-$1$
...
$d\geq 2$ has an (in principle) BKM lift with Wave~13 identity
