...
\begin{table}[ht]
\centering
\caption{Scalar-component free energies $F_1 = \kappa/24$ and
...
standard-tower MC5 dependence theorem becomes available in conditional
form
...
The principal $\cW_N$ central charge~\eqref{eq:fateev-lukyanov-wn}
