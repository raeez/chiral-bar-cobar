...
\begin{corollary}[Algebraicity of bar generating functions for interacting algebras; \ClaimStatusConditional]
...
\begin{theorem}[DS reduction and bar cohomology generating functions; \ClaimStatusConditional]
...
\ClaimStatusConditional]\label{thm:ds-spectral-branch-preservation}
...
\begin{proposition}[Discriminant as first characteristic invariant; \ClaimStatusConditional]
...
\begin{theorem}[Linear dependence in the discriminant family; \ClaimStatusConditional]
...
\begin{proposition}[Functorial origin of the linear relation; \ClaimStatusConditional]
...
\begin{corollary}[Exponential growth rate from Lie algebra dimension; \ClaimStatusConditional]
...
re-entered in this master table. The Schellekens $71$ rows at
