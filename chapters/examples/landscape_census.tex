...
Koszul chiral algebra treated in Part~IV.  Read horizontally, each row
...
\noindent\emph{The Master Table below collects the invariants computed throughout Part~IV.  For the Heisenberg algebra, these invariants were derived in Chapter~\ref{ch:heisenberg-frame}; for each subsequent algebra, the corresponding chapter provides the complete computation.}
...
presentations of the bar complex given in Part~IV;
