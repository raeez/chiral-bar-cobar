...
\begin{table}[ht]
\centering
\caption{Shadow Postnikov obstruction tower census: each family as a projection of $\Theta_\cA$}
...
\hline
Niemeier $V_\Lambda$ (all 24; $\kappa = 24$) & G & 2 & ---; blind to root system & Thm~\ref{thm:lattice:niemeier-shadow-universality} \\
\hline
