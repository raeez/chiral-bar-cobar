...
\item the first genuinely open standard-tower packets are as follows.
  ...
  \emph{$\mathcal{W}_\infty$ side: stage-$4$ frontier.}
  The unconditional stage-$4$ identity packet is the six-entry block
  on~$\mathcal{I}_4$
  (Proposition~\ref{prop:winfty-mc4-frontier-package}).  Under the
  ...
  Proposition~\ref{prop:winfty-stage4-visible-pairing-gap} reduces the
  open content to the single scalar identity
  $\mathsf{C}^{\mathrm{res}}_{4,4;2;0,6}(4)=2$, packaged by
  Corollary~\ref{cor:winfty-stage4-single-scalar-equivalent} as the
  exact theorematic form of the four-channel refinement.  On the
  ...
  shows that the visible swap-odd transport square forces agreement
  with the principal side.
  Proposition~\ref{prop:winfty-stage-growth-virasoro-target-contraction}
  gives the uniform reduced-packet contraction under the normalized
  residue package.
