...
The theorematic Kazhdan--Lusztig target is the semisimplified tilting
quotient $\mathcal{C}(U_q(\mathfrak{g}))$ of
Remark~\ref{rem:kl-category-precision}.  To discuss BGG reciprocity,
however, one must work with a \emph{non-semisimple lift} of the
correspondence to the finite-dimensional quantum-group category before
semisimplification.  On that non-semisimple lift, at
$q = e^{\pi i/(k+h^\vee)}$,
...
\subsection{Kazhdan--Lusztig programme from bar-cobar duality}
...
\item Faithful braid group actions on derived categories of $N$-complexes
  ...
  of the finite-dimensional quantum-group lift on the bar complex side,
  and hence after semisimplification the braided structure of
  $\mathcal{C}(U_q(\fg))$.
\end{enumerate}
