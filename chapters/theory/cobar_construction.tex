...
K3 chiral bialgebra $\mathbf H_{\Delta_5}$, produces
\[
...
is the K3 incarnation of bar--cobar inversion (Theorem~A).
...
The closedness $d_\Omega^2 = 0$ is the K3 Maurer--Cartan equation
