...
The bar complex $\barB(\cA)$ encodes a chiral algebra as a
factorization coalgebra; the cobar complex $\Omega(\cC)$ is its
inverse, recovering the algebra from coalgebraic data.  Together
they realize the bar-cobar inversion
$\Omega(\barB(\cA)) \xrightarrow{\sim} \cA$ (Theorem~B), which
