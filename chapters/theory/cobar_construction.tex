...
the Koszul locus; off the
Koszul locus the conclusion of (1)--(4) still holds, but $\psi_{\cA}$ is
only an isomorphism in the coderived category under the off-Koszul
filtered pro-conilpotent hypotheses.
\end{enumerate}
\end{theorem}
...
\begin{theorem}[Extension obstruction {\cite{BD04}}; \ClaimStatusConditional]
...
\begin{corollary}[Recognition principle; \ClaimStatusConditional]
