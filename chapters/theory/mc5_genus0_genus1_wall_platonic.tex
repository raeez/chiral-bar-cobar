...
evaluation-generated core $\cA^{\evcore}$ in keeping with the AP47
...
qualifier would violate the AP47 evaluation-generated-core discipline
applied throughout the MC chain.
\end{remark}
...
\textup{(}see Remark~\ref{rem:mc5-g0g1-ap47-qualifier}\textup{)}.
...
$N = 5$ is a quasi-isomorphism. The AP47 qualifier restricts the
theorem to the eval-gen-core; full-category extension is conjectural
