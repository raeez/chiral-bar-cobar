...
% comparison in the pro-ambient for class M); this file addresses
% the geometric content of MC5: the eleven boundary divisors
...
% Full-category extension is Conjectured.
%
...
Without the MC5 wall theorem, the bar differential is silent
...
stage will need to handle further genus crossings; the MC5 theorem is
the proof of concept that the bar differential
...
the wall itself and its first appearance in the MC chain.
