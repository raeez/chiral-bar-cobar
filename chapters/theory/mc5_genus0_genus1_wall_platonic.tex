...
Theorem~\ref{thm:mc4-strong-completion-tower} extends the MC element
...
We state the central theorem of the chapter. The statement is restricted
to the evaluation-generated core $\cA^{\evcore}$, in keeping with the
 enforcement template applied throughout MC3 and MC4
\textup{(}see Remark~\ref{rem:mc5-g0g1-ap47-qualifier} below for the
...
\label{rem:mc5-g0g1-ap47-qualifier}
...
We organise the proof into four steps corresponding to the four
hypotheses of the supervisory brief. Throughout, $\cA$ is restricted to
$\cA^{\evcore}$ \textup{(}see
Remark~\ref{rem:mc5-g0g1-ap47-qualifier}\textup{)}.
...
\textup{(}Theorem~\ref{thm:mc4-strong-completion-tower}\textup{)},
both restricted to $\cA^{\evcore}$ as in
Remark~\ref{rem:mc5-g0g1-ap47-qualifier}.
...
\textup{(}Theorem~\ref{thm:mc4-strong-completion-tower}\textup{)} applied
...
\textup{(}Theorem~\ref{thm:mc4-strong-completion-tower}\textup{)}, but
...
$N = 5$ is a quasi-isomorphism. restricts the theorem to the
eval-gen-core; full-category extension is conjectural
...
extensions are conjectural per 
