...
MC3 \textup{(}see item~\ref{it:mc3-eval-core}\textup{)}.
...
\textup{(}Lemma~\ref{lem:degree-cutoff}\textup{)} bounds
...
$\cN = 4$ characters, applied to the genus-one bubble trace
\[
F^{(1)}_{3}
=
\mathrm{Tr}_{\cA^{\evcore}}\Bigl(
V(\xi_{i_{1}})V(\xi_{i_{2}})V(\xi_{i_{3}})
\, e_{a}\, q^{L_{0}-c/24}\Bigr).
\]
The scope is
...
Theorem~\ref{thm:mc5-g0g1-wall-five-point-sewing} proves that the
