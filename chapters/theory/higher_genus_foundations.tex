...
The verification is therefore \emph{complementary}, not fully
disjoint: the comparison source is the clutching-socle PTVV route,
with no Chern--Weil or Arakelov input and with scope restricted to
the socle at $g\ge3$. The
