...
% ================================================================
% PROPOSITION: Scalar obstruction as Hodge Euler class.
...
%
% Fiber-base discipline: the fiberwise curvature
...
\begin{remark}[Clutching-uniqueness: socle vs on-the-nose scope]
\label{rem:clutching-uniqueness-scope}
\index{clutching uniqueness!socle vs on-the-nose scope}
The statement "clutching uniqueness pins
$\mathrm{obs}_g/\kappa = \lambda_g$ uniquely" should be read as:
uniquely pinned on the socle
