...
\begin{conjecture}[Logarithmic clutching from degeneration geometry;
  \ClaimStatusConjectured]%
\label{conj:log-clutching-degeneration}
\index{clutching kernel!logarithmic!from degeneration geometry}
The degeneration formula of Mok~\cite{Mok25} canonically produces
logarithmic clutching kernels compatible with the stable-graph
boundary stratification of\/ $\overline{\mathcal{M}}_{g,n}$.
In particular, every rigid combinatorial type of logarithmic
$\FM$ degeneration determines a correspondence component of\/
$K^{\mathrm{log}}_{g_1,n_1;\,g_2,n_2}$.
\end{conjecture}
...
modular programme: stable-curve gluing lives on the Deligne--Mumford
