...
the MC element inherits genuine modular corrections: the shadow Postnikov obstruction tower
...
seen through progressively coarser lenses.  The shadow Postnikov obstruction tower
...
weight-$2$ level of the shadow Postnikov obstruction tower
...
scalar level of the shadow Postnikov obstruction tower:
...
$\Theta_{\cA}^{\leq 2} = \kappa(\cA)$ of the shadow Postnikov obstruction tower
...
\begin{remark}[Beyond the master table: the shadow Postnikov obstruction tower]
