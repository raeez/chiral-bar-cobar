...
factorisation-at-nodes input relies on Mok~\cite{Mok25} logarithmic
Fulton--MacPherson compactification and the Francis--Gaitsgory
six-functor base-change for the relative Ran prestack. Per
Theorem~\ref{thm:A-infinity-2} modular-family scope, these inputs
are conditional; see
...
\begin{table}[ht]
\centering
\caption{Genus-$g$ obstruction classes. For single-generator scalar-diagonal families, $\mathrm{obs}_g = \kappa \cdot \lambda_g$
