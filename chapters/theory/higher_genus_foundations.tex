...
Remark~\ref{rem:hgf-siegel-sepnode}. See Part~\ref{part:seven-faces}
...
(Remark~\ref{rem:hgf-H2-classification}) arises as a one-loop-forced
...
Remark~\ref{rem:hgf-H2-classification} to appear rather
...
Remark~\ref{rem:hgf-H2-classification} both appearing as concrete
