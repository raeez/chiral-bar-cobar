...
\cite{Faltings84}: the curvature of the Hodge bundle
...
theorem~\cite{Faltings84}\textup{)}, and Chern--Weil applied
...
\item Every scalar propagator is the standard weight-$1$
 ...
 the scalar channel.
\item The Arakelov--Faltings theorem~\cite{Faltings84} identifies
