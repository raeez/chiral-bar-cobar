...
available on the proved scalar lane but is itself part of the
open multi-weight universality problem in general.
\end{openproblem}
...
$\Theta^{\min} = \kappa\cdot\eta\otimes\Omega$ for some
