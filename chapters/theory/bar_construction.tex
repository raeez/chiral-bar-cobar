...
\item \textup{(Ordered tensor bar.)}
 ...
 level-$2$ ordered object carrying the $R$-matrix tower.
...
$E_\infty$ surface this projection preserves the cohomology used in
Theorem~H; outside that surface it is only the averaging map and need not
