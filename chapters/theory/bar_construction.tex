...
\begin{proposition}[Model independence; \ClaimStatusConditional]
...
genus~$0$. The symmetric bar is the $\Sigma_n$-coinvariant projection of
the primitive ordered bar
$B^{\mathrm{ord}}_X(\cA)=T^c(s^{-1}\bar\cA)$. On the PBW/Koszul
$E_\infty$ lane this projection preserves the cohomology used in
Theorem~H; outside that lane it is only the averaging map and need not
preserve the ordered cohomology. The cobar--bar adjunction
...
(Vol.~II, \S\ref{V2-sec:bar-cobar-review-supplement}). The Hall
...
\]
matching Vol.~III
Theorem~\ref{V3-thm:pentagon-sieg-bor}. The next nontrivial correction at
...
Theorem~\ref{V3-thm:pentagon-sieg-bor}; the $\hbar^4$ equation
...
Theorem~\ref{V3-thm:kcb-phi-arrow-discipline} and compute module
...
Theorem~\ref{V3-thm:kcb-MC-hbar7-hbar12} and in the compute modules
...
Lemma~\ref{V3-lem:polar-support-phi-K3}; primary source
...
(Volume~III
Proposition~\ref{V3-prop:A-infty-structure-constants-humbert}), where
\[
...
\item $n = 3$: $\phi^{(3)} \ne 0$, the Etingof--Kazhdan pentagon
  cocycle of Theorem~\ref{V3-thm:pentagon-sieg-bor}
  (Volume~III).
...
Theorem~\ref{V3-thm:filtration-sharpness} (filtration sharpness), where
