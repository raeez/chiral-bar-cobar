...
on $\Ran(X)$ is its $\Sigma_n$-coinvariant quotient, the
input to the universal MC element
$\Theta_\cA \in \MC(\gAmod)$ governing the genus expansion,
...
\textup{(}/B49; treated in
Chapter~\ref{chap:higher-genus}\textup{)}, and at the curved $A_\infty$
level the relation $\mu_1^2(a) = [\mu_0, a]$ supersedes the strict
$\mu_1^2 = 0$ \textup{(}\textup{)}. The two nilpotence statements
