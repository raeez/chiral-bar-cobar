...
The bar construction on the K3 chiral bialgebra $\mathbf H_{\Delta_5}$ takes the form
\[
...
piece $d_{\mathrm{Hall}}$ is what distinguishes the Hall-theoretic bar from classical
...
representatives of the single-valued $\mathrm{ChirHoch}^3$ basis. The $\hbar^3$ equation
