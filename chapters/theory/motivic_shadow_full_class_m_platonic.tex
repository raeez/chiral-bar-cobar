...
AP161), and let $\Phi_{\KZ}^{\mot}$ denote the motivic Drinfeld
...
(iii) is AP171: the chiral quantum-group equivalence on the Koszul
...
1/2$; kappa on this line is $k_{\mathrm{res}}$ (AP39), and the class
...
terminate at $r = 4$ by the class-C depth bound (AP47).
