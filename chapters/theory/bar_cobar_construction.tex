...
\textup{(}Conjecture~\ref{conj:winfty-factorization-package}\textup{)},
...
\begin{conjecture}[Factorization realization package for
\texorpdfstring{$W_\infty$}{W_infty}; \ClaimStatusProvedElsewhere]
\label{conj:winfty-factorization-package}
...
Conjecture~\ref{conj:winfty-factorization-package} breaks into four
...
Proposition~\ref{conj:winfty-stage4-visible-orthogonality} with
$s=t$ imply
\[
F(z,w)=N_s(z-w)^{-2s}
\]
...
Proposition~\ref{conj:winfty-stage4-visible-orthogonality} gives the
...
\begin{proof}
By Proposition~\ref{conj:winfty-stage4-visible-orthogonality},
...
identity, by
Proposition~\ref{conj:winfty-stage4-visible-orthogonality}.  Thus the
...
\label{conj:winfty-stage4-visible-orthogonality}
Let $\mathcal{W}^{\mathrm{fact}}_\infty$ be a principal-stage
compatible factorization target in the sense of
Conjecture~\ref{conj:winfty-factorization-package}, and let
...
hypotheses by
Proposition~\ref{conj:winfty-stage4-visible-orthogonality}.  If the
...
\begin{remark}[Attack order for the first stage-$5$ higher-spin packet]
\label{rem:winfty-stage5-attack-order}
The first attack on
$\mathcal{J}_5^{\mathrm{hs}}$ should begin with the two-channel entry
packet $\mathcal{J}_5^{\mathrm{entry}}$, first through the mixed-entry
singleton $\mathcal{J}_5^{\mathrm{ent,mix}}$ and then through the
self-return singleton $\mathcal{J}_5^{\mathrm{ent,self}}$ of
Proposition~\ref{prop:winfty-stage5-entry-mixed-self}.  The remaining
six-channel packet
$\mathcal{J}_5^{\mathrm{tr}}$ is the genuine mixed transport frontier,
and Proposition~\ref{prop:winfty-stage5-transport-target-ladders}
reduces it further to the three fixed-target ladders
$\mathcal{J}_5^{\mathrm{tr},3}$,
$\mathcal{J}_5^{\mathrm{tr},4}$,
$\mathcal{J}_5^{\mathrm{tr},5}$.  By
Corollary~\ref{cor:winfty-stage5-target5-corridor}, the first
singleton and the lowest-pole transport ladder already form one
three-channel target-$5$ corridor.  Thus the natural local sequence is:
first resolve Conjecture~\ref{conj:winfty-stage5-block-34}, then close
the residual target-$5$ continuation
$\mathcal{J}_5^{\mathrm{tr},5}$ of
Corollary~\ref{cor:winfty-stage5-target5-residual}; equivalently,
first match the new-generator tail coefficient in
$W^{(3)}W^{(4)}$, then match the pole-$3$ transport singleton in
$W^{(3)}W^{(5)}$, then the pole-$4$ transport singleton in
$W^{(4)}W^{(5)}$, and only then move to
$\mathcal{J}_5^{\mathrm{tr},4}$ and
$\mathcal{J}_5^{\mathrm{tr},3}$.  By
Proposition~\ref{prop:winfty-stage5-transport-pole-profiles}, the
transport part of that sequence begins with the lowest-pole ladder
$\mathcal{J}_5^{\mathrm{tr},5}$, followed by
$\mathcal{J}_5^{\mathrm{tr},4}$ and then
$\mathcal{J}_5^{\mathrm{tr},3}$.
\end{remark}
