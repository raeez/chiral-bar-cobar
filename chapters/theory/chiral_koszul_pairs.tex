...
The governing question of this chapter is the mathematical role of \emph{Chiral Koszul duality}: which part of the modular bar-cobar construction or its inversion it isolates, and which boundary between construction, resolution, and shadow it clarifies.
\end{remark}
...
\label{rem:chiral-dual-pair}% backward-compatible label
...
\begin{theorem}[Yangian as quantization {\cite{Drinfeld85}}; \ClaimStatusProvedElsewhere]\label{thm:yangian-quantization}
...
\begin{theorem}[Affine Yangian from $\mathcal{W}$-algebras {\cite{SV13}}; \ClaimStatusProvedElsewhere]\label{thm:affine-yangian-w}
...
\begin{proposition}[Yangian Koszulness for all simple $\mathfrak{g}$; \ClaimStatusProvedHere]\label{prop:yangian-koszul-general}
...
in full generality in Proposition~\ref{prop:yangian-koszul-general}.
...
\begin{theorem}[Yangian as Hopf algebra {\cite{Drinfeld85}}; \ClaimStatusProvedElsewhere]\label{thm:yangian-hopf}
...
\begin{theorem}[Bar construction for Hopf algebras {\cite{LV}}; \ClaimStatusProvedElsewhere]\label{thm:bar-hopf-algebras}
...
\begin{theorem}[Yangian vs.\ quantum group {\cite{Drinfeld85}}; \ClaimStatusProvedElsewhere]\label{thm:yangian-vs-quantum-group}
