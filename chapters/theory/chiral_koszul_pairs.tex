...
By Keller's classicality theorem, the bar spectral sequence of a
formal $A_\infty$-algebra collapses at~$E_2$: the HPL transfer from
$H^*(\barBgeom)$ back to $\barBgeom$ preserves the PBW filtration,
and all transferred differentials $d_r = 0$ for $r \geq 2$ because
$m_n = 0$.  This is $E_2$-collapse, hence Koszulness.
\end{proof}
