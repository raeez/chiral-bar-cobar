...
On the closed side this is recorded by the truncation
...
This is the relevant vanishing criterion. The discriminant alone does
not suffice: class~$L$ also has $\Delta = 0$ but $S_3 \neq 0$.
Among the standard classes, Proposition~\ref{prop:swiss-cheese-nonformality-by-class}
