...
is equivalent to the existence of a harmonic metric on the nonabelian Hodge triple
$(\cA, \cA^!, \Theta_\cA)$, with the Shapovalov form playing the role of the pluriharmonic map.
\end{remark}
...
\end{enumerate}
These three conditions are equivalent to each other and to each of the
twelve conditions in Theorem~\textup{\ref{thm:koszul-equivalences-meta}}.
\end{proposition}
