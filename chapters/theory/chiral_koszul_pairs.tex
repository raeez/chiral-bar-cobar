...
rank, its root-space image, and the two Cartan cokernel calculations
are recorded in
\texttt{compute/lib/admissible\_sl3\_d1\_poisson\_engine.py} and
\texttt{compute/tests/test\_admissible\_sl3\_d1\_poisson\_engine.py}.
