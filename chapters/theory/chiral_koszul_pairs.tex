...
For $\fg = \mathfrak{sl}_3$ and higher rank, the same structural
argument does not apply (the null-vector ideal has generators at
multiple conformal weights), and admissible Koszulness
remains open.
\end{remark}
