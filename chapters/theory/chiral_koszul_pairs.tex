...
\]
% RECTIFICATION-FLAG: The notation $\cA_2^!$ when $\cA_2 = \cA_1^!$
% creates a double-dual ambiguity.  The intended meaning is the
% coalgebra underlying the Koszul dual of $\cA_2$, i.e.\ $\cA_1^i$.
% Verify against Convention~\ref{conv:bar-coalgebra-identity}.
