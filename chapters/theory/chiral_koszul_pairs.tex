...
\begin{remark}[Status of FM197 and FM161]
\label{rem:fm-closures-kp}
\index{FM197!closure via Hodge--Betti chart}
\index{FM161!closure via Yangian chart inclusion}
Two frontier items close via the moduli scheme.
\textup{FM197} (Virasoro Koszulness, circular bar--cobar):
...
\textup{FM161} (Yangian chiral lift): the associative
...
circularity of FM197 is closed.
\end{proof}
...
question \textup{(FM161)} is chart-surjectivity: whether every
...
\begin{remark}[Chart-surjectivity is the honest FM161]
\label{rem:fm161-honest}
\index{FM161!chart-surjectivity formulation}
...
the precise content of~FM161: do there exist chiral charts
