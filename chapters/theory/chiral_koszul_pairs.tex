...
\section{The $\Eone$-Chiral Koszul Duality Theorem}
...
\subsection{Augmented and Pro-Nilpotent $\Eone$-Chiral Algebras}
...
\subsection{The Bar-Cobar Equivalence for $\chirAss$}
...
explicit geometric model (Theorem~\ref{thm:bar-geometric}):
\[
...
\subsection{$\Eone$-Chiral Module Category Koszul Duality}
...
Corollary~\ref{cor:e1-self-duality}).  Then there is an equivalence
of derived module categories:
\[
D(\mathrm{Mod}^{\Eone}_{\mathcal{A}})
\;\simeq\;
D(\mathrm{Mod}^{\Eone}_{\mathcal{A}^!})
\]
