...
Chapter~\ref{ch:heisenberg-frame} identified the Koszul dual of the
Heisenberg algebra as $\mathrm{Sym}^{\mathrm{ch}}(V^*)$.  The governing question
of this chapter is: \emph{which checkable hypotheses on chiral data force
bar-cobar constructions to become an actual inversion theorem?}
This chapter answers that question by isolating recognition criteria
for Koszulity and proving that bar-cobar identification is a theorematic
output, not part of the definition.
