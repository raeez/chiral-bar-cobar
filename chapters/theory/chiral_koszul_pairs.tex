...
for every chiral algebra on a curve, but its shadow Postnikov obstruction tower
...
controls termination of the shadow Postnikov obstruction tower
...
shadow Postnikov obstruction tower $\Theta_\cA^{\leq 3}, \Theta_\cA^{\leq 4},
...
measuring non-formality.  The shadow Postnikov obstruction tower
...
The shadow Postnikov obstruction tower probes the \emph{dynamic} axis of the
