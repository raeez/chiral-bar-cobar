...
\item \emph{OPE data modulo $d\log$ absorption.}
  ...
  Remark~\textup{\ref{rem:pole-absorption}}\textup{)}.  Thus $r(z)$ is
...
presentation in a different framework, and Part~V
...
The three tiers organise Part~V (Seven Faces): tier (a) is the
...
\item \emph{Three invariants of a chiral algebra}
  ...
  govern the bar complex and pre-empts the four depth classes G/L/C/M.
...
\textbf{Part~II: The Characteristic Datum} (shadow tower; $\Eone$ wing).
...
\item \emph{Ordered associative chiral Koszul duality}
  (Ch.~\ref{chap:ordered-associative-chiral-kd}).
...
\textbf{Part~III: The Standard Landscape} (every family, every depth class).
...
\textbf{Part~V: The Seven Faces of the Collision Residue}.
