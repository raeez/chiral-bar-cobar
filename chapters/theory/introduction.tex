...
The Virasoro and $\mathcal{W}_N$ families are conditionally modular Koszul,
pending genus-$g$ PBW spectral sequence degeneration
...
(Conjecture~\ref{conj:master-pbw}, resolved for Kac--Moody by
Theorem~\ref{thm:pbw-allgenera-km}) is the entry point and the
...
(Theorem~\ref{thm:pbw-allgenera-km}); conditional modular Koszulity
for Virasoro and $\mathcal{W}_N$
