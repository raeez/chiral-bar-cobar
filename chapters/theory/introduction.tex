...
%%% Wave 13 DNA weave - Vol I introduction %%%
...
\[
  ...
  8,
\]
yielding the Wave~13 Theorem-C enlargement
...
output; the BKM extension at $d = 3$ is a Wave $13$ conjectural
...
\begin{remark}[Vol~I introduction as bar-cobar's Wave~13 instantiation]
\label{rem:v1-intro-DNA-1}
The Vol~I introduction's bar-cobar programme instantiates at the Wave~13
K3 base point as a sharp statement about $\mathbf H_{\Delta_5}$: the
...
Wave~13 base point, the averaging triangle
...
\begin{remark}[Introduction's five theorems at Wave~13 base point]
\label{rem:v1-intro-DNA-2}
Each of the introduction's five theorems admits a Wave~13 K3-specific
...
at the Wave~13 base point to $\mathbf H_{\Delta_5}$ on the bi-based
...
twist, class-$\mathcal S$ AGT with $c_{2d} = -312$. The transition
functions are the Wave~13 DNA strands
