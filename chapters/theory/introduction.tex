...
Ordered associative chiral KD (Ch.~\ref{ch:ordered-associative-chiral-kd}) &
 Diagonal bicomodule; Hochschild-coHochschild dictionary; open trace formalism; chiral--quantum group equivalence \textbf{proved on the ordered Koszul locus} (Thm~\ref{thm:chiral-qg-equiv}), with elliptic and toroidal extensions \\
