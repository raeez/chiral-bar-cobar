...
The resolution of the circularity problem uses a fundamental geometric fact: configuration spaces carry a natural duality that independently constructs the Koszul dual.  On $\overline{C}_k(X)$, two dual sheaf complexes live naturally.
