...
Verdier duality on $\Ran(X)$ intertwines bar complexes: $\mathbb{D}_{\Ran}\bar{B}(\cA) \simeq \bar{B}(\cA^!)$.  Here $\bar{B}(\cA)$ is a factorization coalgebra; its Verdier dual $\mathbb{D}_{\Ran}\bar{B}(\cA)$ is naturally a factorization \emph{algebra} (as the dual of a coalgebra).  The identification with $\bar{B}(\cA^!)$ means: the algebra structure on $\mathbb{D}_{\Ran}\bar{B}(\cA)$, when restricted to cogenerators, determines the chiral bracket of~$\cA^!$.  The Koszul dual algebra~$\cA^!$ is thereby determined intrinsically, without presupposing a definition from classical Koszul theory.  The Heisenberg specialization of Chapter~\ref{ch:heisenberg-frame} is the prototypical case.\label{rem:poincare-duality-hms}
