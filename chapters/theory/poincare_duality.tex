...
space $\Ran(X)$ and its factorization structure.  On $\Ran(X)$, Verdier duality becomes a
...
chain-level equivalence.  The quadratic
...
The homotopy upgrade serves two purposes.  First, the
