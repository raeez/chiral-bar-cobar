...
$\operatorname{Ran}^{\leq n}$ (Theorem~\ref{thm:bar-cobar-inversion-quasi-iso})
...
exactly one of the four shadow depth classes
...
\end{enumerate}
Shadow depth is orthogonal to Koszulness: all four archetypes are
chirally Koszul
