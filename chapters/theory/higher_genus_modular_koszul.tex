...
\textup{(}three channels of $\overline{\cM}_{0,4} \cong \PP^1$\textup{)}.
\begin{equation}
...
$H^1(\PP^1) = 0$; the ternary bracket is exact but
...
\subsection{The modular bar--Hamiltonian: the explicit graph sum}
