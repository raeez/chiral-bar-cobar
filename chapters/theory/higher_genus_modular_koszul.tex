...
\item \emph{Universality.}
  ...
  \item \emph{Free-energy\textup{:}} For all modular Koszul chiral
  algebras \textup{(}including multi-generator algebras such as
  $\mathcal{W}_N$ with $N \geq 3$\textup{)}, the genus-$g$
  ...
  $N \geq 3$\textup{)}, the cohomological factorization at
  $g \geq 2$ is conjectural
  \textup{(}Open
