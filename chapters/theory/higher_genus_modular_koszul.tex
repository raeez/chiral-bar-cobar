...
\item \emph{Universality.}
  ...
  \textup{(}Heisenberg, Virasoro, affine Kac--Moody\textup{)} and
  for all algebras at $g = 1$, the genus-$g$
  free energy $F_g = \int_{\overline{\mathcal{M}}_g}
  \mathrm{obs}_g$ factors as
...
from the genus-completed Verdier intertwining
(Theorem~\ref{thm:genus-internalization}(ii)); see
...
The genus-completed Verdier intertwining
(Theorem~\ref{thm:genus-internalization}(ii), itself
an application of
Theorem~\ref{thm:bar-cobar-isomorphism-main}(2))
