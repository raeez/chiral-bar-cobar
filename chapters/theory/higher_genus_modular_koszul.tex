...
The \emph{shadow Postnikov tower} of $\cA$
...
\end{align}
The sign pattern $S_5 < 0$, $S_6 > 0$, $S_7 < 0$ for $c > 0$
...
\texttt{pixton\_shadow\_bridge.py} \textup{(}$54$ tests\textup{)}.}%
...
\item
  ...
  through $20$~stable graphs ($4$ one-vertex, $12$ two-vertex,
  $3$ three-vertex, $1$ four-vertex star), yielding a
  $9$-term polynomial:
  ...
  \begin{aligned}
    ...
    \;=\;&
    \tfrac{7}{8}\,S_3 S_5
    - \tfrac{1}{36}\,S_3 S_4\,\kappa
    - \tfrac{343}{2304}\,S_3\,\kappa
    - \tfrac{1}{384}\,S_3\,\kappa^2
  ...
  \end{aligned}
  \end{equation}
  The four terms $S_3 S_4\kappa$, $S_3\kappa^2$,
  $S_4\kappa^2$, $S_3\kappa^3$ come from three- and four-vertex
  star graphs; the last is the four-vertex star $(0,3)$-center
  with three $(1,1)$-leaves.
\end{itemize}
\end{remark}
...
The shadow tower free energy (Theorem~D) is the
...
c_g(\mathbb{E})$ is the top Hodge class.  The $\psi$-class CohFT
graph sum at $(g,0)$,
\[
F_g^{\psi}
\;=\;
