...
The modular characteristic~$\kappa(\cA)$ is only the linear leading term of this structure.  Part~\ref{part:characteristic-datum} extracts the full nonlinear content: the shadow obstruction tower $\kappa \to \Delta \to \mathfrak{C} \to \mathfrak{Q} \to \cdots$, a hierarchy of finite-order invariants whose all-arity limit is the universal class~$\Theta_\cA$.
