...
Thus the formerly proposed degree-two class represented by
\(\psi\psi^*\) is exact in this model.  A free-fermion chart
calculation now consists of a family support datum
\(H_H(\cA_{\mathcal F};S_{\mathcal F})\) or a proved
bounded-to-chart comparison, as recorded in
