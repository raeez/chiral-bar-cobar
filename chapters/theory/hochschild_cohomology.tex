...
The classical Gerstenhaber bracket on Hochschild cochains is the
strict shadow of a full $L_\infty$ bracket on the chiral Hochschild
complex.  In the strict model, $\mathrm{HH}^2$ classifies
