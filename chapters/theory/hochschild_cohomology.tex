...
This periodicity arises from the Coxeter element $w_{\mathrm{Cox}} \in W$ acting on the center at critical level (Feigin--Frenkel~\cite{FF92}).  For simply-laced~$\mathfrak{g}$, $h = h^\vee$; for non-simply-laced~$\mathfrak{g}$, $h \neq h^\vee$ in general.
...
\emph{Type B terms cancel} because of associativity of the chiral product:
\begin{align*}
