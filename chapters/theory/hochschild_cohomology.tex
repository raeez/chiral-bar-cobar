...
The governing question of this chapter is the mathematical role of \emph{Chiral Hochschild cohomology and deformation theory}: which part of the modular bar-cobar construction or its inversion it isolates, and which boundary between construction, resolution, and shadow it clarifies.
\end{remark}
...
\begin{theorem}[Comparison with classical {\cite{BD04}}; \ClaimStatusProvedElsewhere]\label{thm:hochschild-classical-comparison}
...
\begin{theorem}[Critical level cohomology {\cite{FT87,BD04}}; \ClaimStatusProvedElsewhere]\label{thm:critical-level-cohomology}
...
\subsection{$\mathcal{W}$-algebra periodicity}

For W-algebras, the periodicity depends on the conformal weights of the generating fields:

\begin{theorem}[$\mathcal{W}$-algebra cohomology; \ClaimStatusProvedHere]\label{thm:w-algebra-hochschild}
...
\begin{theorem}[Deformation classification {\cite{Ger63}}; \ClaimStatusProvedElsewhere]\label{thm:deformation-classification}
\begin{enumerate}
...
\begin{theorem}[Maurer--Cartan equation {\cite{KontsevichSoibelman}}; \ClaimStatusProvedElsewhere]\label{thm:maurer-cartan-deformations}
...
\begin{theorem}[Bar spectral sequence {\cite{LV}}; \ClaimStatusProvedElsewhere]\label{thm:bar-spectral-sequence-hochschild}
