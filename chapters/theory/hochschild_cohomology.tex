...
This is deformation theory in its mature form.  Every construction
in the preceding chapters (bar differentials, twisting morphisms,
curvature elements, shadow invariants) can now be re-read as a single
deformation machine.  The Maurer--Cartan elements that appeared
piecemeal in the convolution algebra
$\Convinf(\barBch(\cA), \cA)$ live in a completed, filtered,
curved $L_\infty$ algebra whose cohomology \emph{is} the chiral
Hochschild cohomology $\ChirHoch^*(\cA)$.
...
\begin{proposition}[Morita equivalence; \ClaimStatusProvedElsewhere]
...
\begin{proposition}[Endofunctor--bimodule equivalence;
...
\]
Here we note that $A \otimes A$ acts on the left copy of~$A$
