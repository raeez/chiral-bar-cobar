...
The governing question of this chapter is the mathematical role of \emph{Chiral Hochschild cohomology and Koszul duality}: which part of the modular bar-cobar construction or its inversion it isolates, and which boundary between construction, resolution, and shadow it clarifies.
\end{remark}

\begin{remark}[H/M/S route; Convention~\ref{conv:hms-levels}]
This chapter is primarily H/M-level. It builds homotopy-native or model-level constructions explicitly, and any scalar, character, or numerical consequences are read only as S-level shadows unless the printed theorem surface says otherwise.
\end{remark}
...
\begin{theorem}[Existence and uniqueness {\cite{LV}}; \ClaimStatusProvedElsewhere]\label{thm:universal-twisting-existence}
