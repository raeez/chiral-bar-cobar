...
On cohomology:
\[
\ChirHoch^n(\mathcal{A}) \cong HH^{2-n}_{\mathrm{chiral}}(\mathcal{A}^!)^{\vee} \otimes \omega_X.
\]
...
\begin{proposition}[Formal Legendre duality; \ClaimStatusConjectured]
...
in Appendix~\ref{app:nonlinear-modular-shadows}, where the quartic
shadow cocycle
