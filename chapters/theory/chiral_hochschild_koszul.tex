...
landscape; \ClaimStatusProvedHere]
...
periodicity mechanism; however, Step~2 contains a gap in the passage from
...
\end{enumerate}
The relation~\eqref{eq:period-sum} holds for the Heisenberg algebra ($c = c' = 1$, $N = N' = 24$, sum $= 1/12$) and for the $\widehat{\mathfrak{sl}}_2$ WZW model at level $k = 1$ ($c = 1$, $c' = 1$, $N = N' = 24$). For $c = 5$, $c' = 21$ (both coprime to~$24$ but $\gcd(21, 24) = 3$), one gets $N = 24$, $N' = 8$, and $1/N + 1/N' = 1/6 \neq 1/12$, showing the special case $1/N + 1/N' = 1/12$ requires both $p$ and $p'$ coprime to~$24$.
\end{remark}
...
Koszul hypotheses.
Under $\widetilde{M}_{24}$-equivariance the Serre functor acquires a
projective Schur cocycle of order $6$ in
...
Vol~III $\Phi_3$ construction, and its restriction to the Vol~I
