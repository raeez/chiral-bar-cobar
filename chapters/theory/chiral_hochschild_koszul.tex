...
operads on~$X$ along the OPE-residue pairing.
...
$R^{\perp}$, the annihilator of~$R$ under the chiral pairing
$\langle -,-\rangle_{\mathrm{OPE}}$ on $\cF(E)(3)$ defined by
iterated OPE residues at the principal collision on
$\overline{C}_{3}(X)$.  Fresse's construction
...
composition pairing by the OPE-residue pairing; the
compatibility of $d_{\mathrm{K}}$ with $d_{\bar{B}}^{\vee}$
