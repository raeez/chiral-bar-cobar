...
\emph{Relation to the shadow Postnikov obstruction tower.}\;
...
shadow obstruction tower, the cubic shadow~$C$, quartic resonance class~$Q$,
...
classes are all shadows of the shadow Postnikov obstruction tower
$\Theta_\cA^{\leq r}$
...
At each finite order, the shadow Postnikov obstruction tower
...
\begin{theorem}[Graph complex controls shadow obstruction tower deformations; \ClaimStatusHeuristic]
