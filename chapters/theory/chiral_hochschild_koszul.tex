...
$\Theta_\cA$.  Every deformation, obstruction, and bulk-field
...
refinement.  Theorem~H concentrates the tangent complex
...
is Verdier duality on this tangent space.  The complementarity
...
extends these structures into the full modular regime.
...
A degree-$n$ cochain in the chiral Hochschild complex involves $(n+2)$ marked points on~$X$: one output, $n$ inputs, and one evaluation point.  The complex lives on configuration spaces of $(n+2)$ points.
...
obstruction tower terminates at arity~$2$:
