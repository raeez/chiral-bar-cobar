...
The MC2 extension problem is reduced by
Proposition~\ref{prop:mc2-reduction-principle} to three constructions;
...
$\mathfrak{sl}_3$, where
$\rho=H_3-1=1/2+1/3=5/6$.
\end{proof}
...
\textup{(}Theorem~\ref{thm:riccati-algebraicity}\textup{)}.  Applying
the displayed recursion through arity~$11$ gives
\begin{align*}
 S_5&=-\frac{48}{c^2(5c+22)},\\
 S_7&=-\frac{2880(15c+61)}{7c^4(5c+22)^2},\\
 S_9&=-\frac{1280(2025c^2+15570c+29554)}
 {3c^6(5c+22)^3},\\
 S_{11}&=-\frac{15360(91125c^3+990225c^2+3500190c+3988097)}
 {11c^8(5c+22)^4}.
\end{align*}
Thus the odd coefficients are generically nonzero in this finite
range; an all-arity assertion requires a separate argument. A deformation
$\cA_t$ then maps to
...
rational functions of~$c$: substitute the recursively defined
$S_r(c)$ and $\kappa=c/2$ in the displayed quotient.
...
\[
 ...
 \subseteq S_{\Delta_5}.
\]
The curve-level calculation then requires three further constructions:
\begin{itemize}
