...
The MC element $\Theta_\cA \in \MC(\gAmod)$ is the closed-sector
projection of the full open/closed element
$\Theta^{\mathrm{oc}}_\cA$.  At genus~$g \geq 1$, the MC equation
for $\Theta_\cA$ forces a Lagrangian decomposition of the genus-$g$
moduli: Theorem~C (Theorem~\ref{thm:quantum-complementarity-main})
proves that the obstruction space splits into
$\cA$-visible and $\cA^!$-visible halves.
...
discrete correspondence, with $\cA$ and~$\cA^!$ connected
only by the functor $\Omega \circ B$.  On an algebraic
curve at genus~$g \geq 1$, the two algebras interact through moduli.
...
\index{Virasoro algebra!self-dual point}
At the self-dual point $c = c_* = K_N/2$, both
...
The Virasoro self-dual point is $c = 13$ (not $c = 26$;
