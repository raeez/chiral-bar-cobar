...
$\overline{\mathcal{M}}_{g,n}$; \ClaimStatusProvedHere]
...
$\Phi$ \textup{(}W12-A;
Proposition~\textup{\ref{prop:modular-bootstrap-to-curved-dunn-bridge}}%
\textup{)} in cohomological degrees $\leq 2$, the genus-wise
...
obstruction cocycle in the curved-Dunn twisting-cochain complex
 is exact. Under $\Phi$ (W12-A), the modular-bootstrap
...
conditions). Multi-weight cases require the cross-channel
$\delta F_g^{\mathrm{cross}}$ correction of Theorem~D to enter the
isotropy check.
\end{proof}
