...
\begin{itemize}
\item \emph{H-level.}  The shadow Postnikov obstruction tower
  $\Theta_\cA^{\leq r}$
...
measured by the shadow Postnikov obstruction tower $\Theta_{\cA}^{\leq r}$
(Definition~\ref{def:shadow-postnikov-tower},
...
\end{tabular}
\end{center}
The connection with the shadow Postnikov obstruction tower
