...
\begin{theorem}[Quantum complementarity as Lagrangian polarization; \ClaimStatusConditional]
...
\begin{lemma}[Quantum corrections as spectral sequence limit; \ClaimStatusConditional]
...
\begin{corollary}[Quantum corrections are dual; \ClaimStatusConditional]
...
\begin{lemma}[Center isomorphism via module Koszul duality; \ClaimStatusConditional]
...
\begin{lemma}[Trivial intersection; \ClaimStatusConditional]
...
\begin{lemma}[Exhaustion property; \ClaimStatusConditional]
...
\begin{corollary}[Modular properties; \ClaimStatusConditional]
...
\begin{theorem}[Self-dual halving; \ClaimStatusConditional]\label{thm:self-dual-halving}
...
\begin{corollary}[Virasoro quantum corrections; \ClaimStatusConditional]
...
\begin{corollary}[Critical level uncurving; \ClaimStatusConditional]
...
\begin{theorem}[Critical dimension; \ClaimStatusConditional]
