...
(Theorem~\ref{thm:modular-characteristic-main}); at
$\kappa^! = 0$ they vanish.
...
For~$V_k(\fg)$: $\kappa = k\,\dim\fg/(k + h^\vee)$ and
$\kappa^! = (-k - 2h^\vee)\dim\fg/(-k-h^\vee)$; $\kappa^! = 0$
at $k^! = -k - 2h^\vee = 0$, i.e., $k = -2h^\vee$.
This is the dual of the critical level: the bar complex of
$\widehat{\fg}_{-2h^\vee}^! \simeq \widehat{\fg}_0$ is
uncurved.
\end{proof}
