...
(AP32; multi-weight cases require the cross-channel $\delta F_g^{\mathrm{cross}}$
...
(FM67) is exact. Under $\Phi$ (W12-A), the modular-bootstrap
...
\begin{remark}[Scope: FM116 respected; PTVV-for-$\mathrm{CY}_d$ distinguished]
...
The distinction is FM116 in the Vol~II registry: Verdier-on-$\overline{\mathcal{M}}_{g,n}$
