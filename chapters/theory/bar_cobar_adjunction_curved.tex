...
$\mathbb{D}_{\Ran}\barBch(\cA) \simeq \barBch(\cA^!)$ identifies
this \emph{algebra} with the bar \emph{coalgebra} of~$\cA^!$ via
the canonical D-module pairing on holonomic objects
