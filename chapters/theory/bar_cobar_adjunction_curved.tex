...
$\Theta_\cA \in \MC(\gAmod)$; the arity-$2$ projection of
...
was Proposition~\ref{conj:winfty-stage4-visible-diagonal-normalization},
equivalently the single scalar identity
\[
\mathsf{C}^{\mathrm{res}}_{4,4;2;0,6}(4)=2.
\]
Its package form is
Proposition~\ref{conj:winfty-stage4-ward-inheritance}.
\end{remark}
...
Same argument as
Proposition~\ref{conj:winfty-stage4-ward-inheritance}: the hypotheses
...
Ward inheritance
(Proposition~\ref{conj:winfty-stage4-ward-inheritance}), and
Borcherds transport
...
Proposition~\ref{conj:winfty-stage5-principal-target5-no-new-independent-data}
holds if and only if both
Proposition~\ref{conj:winfty-stage5-principal-target5-transport-vanishing}
and
Proposition~\ref{conj:winfty-stage5-principal-tail-cross-target-reduction}
...
of
Propositions~\ref{conj:winfty-stage5-principal-target5-no-new-independent-data}
...
identities
Propositions~\ref{conj:winfty-stage5-block-34}
...
ladder identities
Propositions~\ref{conj:winfty-stage5-transport-target-3}
...
with Proposition~\ref{conj:winfty-stage5-block-34}, this matches every
...
Propositions~\ref{conj:winfty-stage5-transport-target5-35}
...
identities
Propositions~\ref{conj:winfty-stage5-entry-identities}
and~\ref{conj:winfty-stage5-transport-identities}
both hold.  On the full visible
\texorpdfstring{$W^{(3)}$}{W3}/\texorpdfstring{$W^{(4)}$}{W4}/\texorpdfstring{$W^{(5)}$}{W5}
pairing locus,
Proposition~\ref{conj:winfty-stage5-principal-one-coefficient-normal-form}
...
Proposition~\ref{conj:winfty-stage5-one-coefficient-comparison},
...
identity network
\textup{(}Propositions~\textup{\ref{conj:winfty-stage5-principal-target5-no-new-independent-data}}%
...
In particular, Propositions~\ref{conj:winfty-stage4-visible-borcherds-transport},
