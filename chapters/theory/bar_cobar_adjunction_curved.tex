...
For example, the Virasoro and $W_\infty$ completed
infinite-generator lanes require this topology, while Heisenberg and
the finite-type Kac--Moody lanes do not.
...
\begin{theorem}[Conilpotency controls algebraic convergence; \ClaimStatusConditional]
