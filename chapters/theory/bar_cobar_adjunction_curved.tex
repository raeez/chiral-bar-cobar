...
$T(z)T(w) \sim c/(z-w)^4 + 2T(w)/(z-w)^2 + \partial T(w)/(z-w)$
...
The key point is that $d_\Omega$ respects the coradical filtration: if
...
conjectured regime is $0 < \rho < \infty$
...
\]
Moreover, \textup{\cite[Theorem~3.8]{Val16}} upgrades this to an
