...
The three regimes of Convention~\ref{conv:regime-tags} are
distinguished by the singular OPE structure and the
resulting bar-cobar technology.
...
\begin{tabular}{llll}
\textbf{Regime} & \textbf{Singular OPE} & \textbf{Bar differential} & \textbf{Example} \\
\hline
I.\;Quadratic & $d_{\mathrm{bracket}} = 0$
  & $d_{\mathrm{bar}}^2 = 0$
  & $\mathcal{H}_k$ \\[2pt]
II.\;Curved & $d_{\mathrm{bracket}} \neq 0$;\; finitely generated
...
\noindent
Regime~I: the OPE has no simple pole, so
$d_{\mathrm{bracket}} = 0$ and
$d_{\mathrm{bar}}^2 = 0$ on the nose; the classical
bar-cobar adjunction
(Theorem~\ref{thm:bar-cobar-adjunction}) holds without
qualification.  Regime~II: the OPE has simple and higher
poles but the algebra is finitely generated and quadratic;
$d_{\mathrm{bar}}^2 = 0$ on the total bar complex, but
the fiberwise differential over
