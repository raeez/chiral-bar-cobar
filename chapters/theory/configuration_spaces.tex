...
When describing collision of points $\{i_1,\ldots,i_k\}$, we order
...
$d\log$ gives the displayed formula.  The Poincare residue along
...
subdivisions and planted forests, not merely by pairwise labels.
