...
\begin{theorem}[Boundary strata of $\overline{\mathcal{M}}_{g,n}$; \ClaimStatusProvedElsewhere]\label{thm:boundary-higher-genus}
...
\begin{corollary}[Boundary divisors in the FM compactification; \ClaimStatusProvedElsewhere]\label{cor:dimension-strata}
...
\begin{theorem}[Boundary stratification; \ClaimStatusProvedElsewhere]
...
\begin{theorem}[Universal property: operadic structure; \ClaimStatusProvedElsewhere]\label{thm:FM-operad}
...
\begin{theorem}[Factorization homology via configuration spaces; \ClaimStatusProvedElsewhere]\label{thm:fact-homology}
...
\begin{proposition}[Fundamental group across genera; \ClaimStatusProvedElsewhere]
\leavevmode\\
...
\begin{proposition}[Logarithmic form properties; \ClaimStatusProvedElsewhere]
The forms $\eta_{ij} = d\log(z_i - z_j)$ satisfy:
\begin{enumerate}
\item $\eta_{ji} = \eta_{ij}$ (symmetry as forms; see Proposition \ref{prop:eta})
...
\begin{proposition}[Explicit local charts for $\overline{C}_n(X)$; \ClaimStatusProvedElsewhere]\label{prop:local-charts}
...
\begin{theorem}[Cohomology via Orlik--Solomon; \ClaimStatusProvedElsewhere]\label{thm:os-cohomology-config}
...
\begin{theorem}[NBC basis theorem; \ClaimStatusProvedElsewhere]\label{thm:NBC}
...
\begin{theorem}[Chiral algebras as factorization algebras; \ClaimStatusProvedElsewhere]\label{thm:chiral-as-fact}
...
\begin{theorem}[Factorization monoidal structure; \ClaimStatusProvedElsewhere]\label{thm:fact-monoidal-corrected}
...
\begin{proposition}[Elliptic Arnold relations; \ClaimStatusProvedElsewhere]
...
\begin{theorem}[Period integrals and bar differential; \ClaimStatusProvedElsewhere]
...
\begin{theorem}[Stokes on configuration spaces; \ClaimStatusProvedElsewhere]
...
\begin{theorem}[Chiral algebras as algebra objects; \ClaimStatusProvedElsewhere]
...
\begin{theorem}[Presentation independence; \ClaimStatusProvedHere]\label{thm:presentation-independence}
   ...
   The geometric bar complex depends on:
   \begin{enumerate}
   ...
   \begin{remark}[Criticality and conformal weight]
...
\begin{corollary}[Dictionary between perspectives; \ClaimStatusProvedHere]
...
\begin{corollary}[Operadic associativity; \ClaimStatusProvedElsewhere]
...
\begin{theorem}[Elliptic logarithmic forms; \ClaimStatusProvedElsewhere]
The logarithmic form becomes:
...
\begin{proposition}[Transition functions; \ClaimStatusProvedElsewhere]\label{prop:transition-functions}
...
\begin{theorem}[Chiral algebras ↔ D-modules on Ran space; \ClaimStatusProvedElsewhere]
...
\begin{theorem}[Chiral homology via Ran space; \ClaimStatusProvedElsewhere]
