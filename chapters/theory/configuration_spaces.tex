...
The Fulton--MacPherson compactification encodes all collision patterns
as boundary divisors; the Arnold relation among triple collisions is a
residue theorem on that boundary and is the genus-$0$ reason
that~$d^2=0$.
\end{remark}
...
\begin{example}[\texorpdfstring{$n=2$}{n=2}: no relations]
