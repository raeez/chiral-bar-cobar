...
On the gauge-fixed factor, the forms $a_i$, $b_i$, and $c_{ij}$ are the
pairwise logarithmic differentials of the points
$0,1,z_4,\ldots,z_n$. The four displayed relations are exactly the
...
Thus the gauge-fixed algebra has exactly the size forced by the
displayed relations, and the equivalent projective formulation
