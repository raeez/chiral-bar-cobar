...
sections with a Schur-multiplier class. The anomalous classes
...
sections via a Schur-multiplier class in
...
package and the projective $\mathbb Z/12$ Schur multiplier in
...
is the Schur-multiplier component, and the explicit formula is
...
Gritsenko weight $5$, the Schur $\mathbb{Z}/12$ phase, and the
