...
$\nabla_{\mathrm{Arnold}}$; and the residue maps
...
acquires elliptic and prime-form corrections
(Proposition~\ref{prop:elliptic-arnold-relations}; \cite{Fay73}
prime forms): the deficit is absorbed into the curvature
...
This is the main theorem of \cite{Arnold69, }. The proof uses intersection theory on $\overline{C}_n(\Sigma_g)$ and is beyond our scope here.
\end{proof}
...
elliptic and prime-form propagators satisfy modified Arnold relations
(Proposition~\ref{prop:elliptic-arnold-relations} for $g = 1$), and the
extra terms are absorbed into the curvature class
