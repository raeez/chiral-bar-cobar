...
categorical thick generation results of the MC3 frontier are
...
\begin{remark}[H-level frontier]\label{rem:virasoro-mc4-scope}
...
see \S\ref{sec:principal-contributions} for the current finite-detection frontier).
\end{remark}
