...
The governing question of this chapter is the mathematical role of \emph{Chiral modules and geometric resolutions}: which part of the modular bar-cobar construction or its inversion it isolates, and which boundary between construction, resolution, and shadow it clarifies.
\end{remark}
...
\begin{theorem}[$A_\infty$ module structure {\cite{Kadeishvili80}}; \ClaimStatusProvedElsewhere]\label{thm:ainfty-module}
...
\begin{proposition}[BGG resolution of $L(\Lambda_0)$ {\cite{BGG76}}; \ClaimStatusProvedElsewhere]
...
\begin{remark}[$\mathrm{Ext}$ complementarity at dual levels; \ClaimStatusProvedHere]
...
\begin{corollary}[$\mathcal{W}$-algebra cobar from KM bar; \ClaimStatusProvedHere]\label{cor:ds-bar-level-shift}
...
\begin{example}[KM Verma modules: explicit genus-$1$ computation]
...
\begin{example}[Non-trivial $\mathrm{Ext}^1$ at special level;
\ClaimStatusProvedHere]
