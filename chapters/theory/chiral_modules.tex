...
\begin{proposition}[Conditional conformal-block comparison from braided categorical duality; \ClaimStatusConditional]
...
Proposition~\ref{prop:conformal-block-duality} is now explicitly a
...
\begin{proposition}[Conditional highest-weight Koszul t-structure from bar linearity; \ClaimStatusConditional]
