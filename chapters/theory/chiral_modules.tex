...
The key property is that when the $V_i$ have special structure, this infinite sum collapses to a closed form.
...
\begin{proof}
\textbf{(1) Constancy of Euler characteristic.}
...
\textbf{(2) Gauss--Manin connection.}
