...
categorical thick generation results of the MC3 extension problem are
...
\begin{remark}[H-level open problem]\label{rem:virasoro-mc4-scope}
...
(bar-cobar duality, in the sense of Theorem~A, holds fully only
in regime~(i)):
\begin{enumerate}[label=\textup{(\roman*)}]
