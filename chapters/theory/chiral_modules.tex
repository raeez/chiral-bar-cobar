...
\label{rem:chiralmod-DNA-3}
The CY-to-chiral functor $\Phi: D^b\mathrm{Coh}(K3)\to\mathbf H_{\Delta_5}\text{-}\mathrm{mod}^{\mathrm{ch}}$
sends the CY-2 module category to the chiral module category tabulated
here, matching Mukai pairing (signature $(4,20)$) against chiral
Hochschild pairing on $\mathbf H_{\Delta_5}$. The averaging morphism
