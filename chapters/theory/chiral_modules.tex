...
\begin{proposition}[Module bar-comodule comparison on the quadratic \texorpdfstring{$\Eone$}{E1} lane; \ClaimStatusProvedHere]
...
of the present chapter. The module bar functor $\Phi=\barB(\cA;-)$
...
\begin{theorem}[Lax monoidal structure of the module bar functor; \ClaimStatusProvedHere]
...
\begin{proposition}[Derived Ext exchange on the quadratic \texorpdfstring{$\Eone$}{E1} lane; \ClaimStatusProvedHere]
...
notation of the present chapter. On the proved quadratic
...
\begin{proposition}[Vacuum Verma under the module bar functor on the finite-type \texorpdfstring{$\Eone$}{E1} lane; \ClaimStatusProvedHere]
...
\begin{proposition}[Non-vacuum Verma modules under the module bar functor on the finite-type \texorpdfstring{$\Eone$}{E1} lane; \ClaimStatusProvedHere]
...
\begin{corollary}[\texorpdfstring{$\mathcal{W}$}{W}-algebra bar at dual level via DS and Verdier intertwining; \ClaimStatusProvedHere]\label{cor:ds-bar-level-shift}
...
\begin{remark}[CY-2 $[2]$-shift and Mukai-doubling $K^{\kappa_{\mathrm{ch}}} = 8$]
...
See Vol.~III, Chapter~\ref{ch:k3-chiral-bialgebra-platonic}, \S\ref{sec:Mukai-Humbert-Lusztig}.
\end{remark}
...
See Vol.~III, Chapter~\ref{ch:k3-chiral-bialgebra-platonic}, and
