...
The Gerstenhaber structure on topological Hochschild cochains of associative algebras
...
\item The chiral Hochschild complex is computed from the bar
 ...
 $p$-th bar term $\barB_p(A)$ to~$A$, with chiral Hochschild differential
...
\item The BRST differential acts fiberwise on both the source
 ...
 chiral Hochschild differential. The same derivation property implies
