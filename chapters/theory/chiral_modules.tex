...
\begin{theorem}[Denominator identity for trivial module {\cite{Kac}}; \ClaimStatusProvedElsewhere]
...
\ClaimStatusProvedHere]\label{conj:fusion-bar-cobar}
\index{fusion product!Koszul duality}
...
We verify Theorem~\ref{conj:fusion-bar-cobar} for the Heisenberg algebra
...
and Theorem~\ref{conj:fusion-bar-cobar} for the general
statement.
\end{remark}
...
(Conjecture~\ref{conj:fusion-bar-cobar}),
