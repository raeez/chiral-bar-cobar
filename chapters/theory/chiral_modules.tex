...
All intermediate quantities have been verified computationally;
see \S\ref{sec:bgg-sl2-pipeline} for matrix-level verification
and Corollary~\ref{cor:bgg-koszul-involution} for the BGG
...
\emph{Unconditional for Kac--Moody}
(Theorem~\ref{thm:pbw-allgenera-km});
\emph{conditional for Virasoro and $\mathcal{W}_N$}
(Conjecture~\ref{conj:master-pbw}):
