...
coincidence.} Theorem~\ref{thm:level-shift-universality} proves the
opposite. The denominator $k+\hv$ is the universal Sugawara
denominator; the trace-form and KZ presentations are two
normalisations of the same Casimir datum, related by the canonical
level-shift bridge of
Theorem~\ref{thm:trace-KZ-convention-bridge}.
