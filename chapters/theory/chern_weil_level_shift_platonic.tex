...
level-dependent rescaling of the Casimir. AP126 healing becomes
...
\begin{remark}[AP126 bare-$r$ regime]
...
(see AP126/HZ-4). At $k = -\hv$ this gives $0$, the critical-level
value.
...
\section{Universal AP126 healing}
\label{sec:ap126-healing}

We now close the healing of AP126 at the universal level.

\begin{corollary}[Universal AP126 healing]
...
$(k + \hv)$ denominator is an AP126 violation; by
...
\begin{remark}[AP141 downstream]
\label{rem:ap141-downstream}
The level-shift universality also heals AP141 (level prefix omission):
...
\section{HZ-IV independent verification}
\label{sec:hz-iv-level-shift}

We decorate the four proved-here theorems of this chapter with
independent verification witnesses per the HZ-IV protocol. The
...
Coverage delta: $+4$ into the Vol~I HZ-IV registry (from $0/2275$
...
locus. AP126 healing is thereby made universal in
