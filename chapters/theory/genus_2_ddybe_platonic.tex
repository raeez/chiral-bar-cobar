...
\item \textbf{Face-model DDYBE, scope-restricted}
  ...
  regime carries no genuinely $g=2$ content (AP157).
...
\begin{remark}[AP157: separating versus non-separating
degenerations]
\label{rem:ap157-g2}
...
\end{enumerate}
AP157 states: the separating regime carries no genuinely
...
\item \textbf{Separating-degeneration regime
  (AP157-empty):} at the separating boundary
...
\item \texttt{prop:g2-sep-degen}: at the separating boundary
  ...
  and is AP157-empty of genuinely genus-$2$ content.
\end{itemize}
...
DDYBE at separating boundary (AP157-empty)
  & ProvedHere &
