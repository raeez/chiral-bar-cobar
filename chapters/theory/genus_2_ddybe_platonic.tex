...
\item \textbf{Face-model DDYBE, scope-restricted}
 ...
 content.
 \emph{Verification: exact on the diagonal and numerical at generic
 \(\Omega\) for the conjectural full DDYBE.}
...
\end{itemize}
The engine docstring should reference
\texttt{rem:g2p-g1-limit} for the non-separating degeneration
and Theorem~\ref{thm:g2-face-model-bypass-scope-restricted}(i)
for the separating degeneration. These two anchors state exactly
the genus-$1$ Felder reductions used by the computation.
\end{remark}
