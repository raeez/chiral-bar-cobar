...
$d_n = d_{n-2} + d_{n-3}$ with
$(d_0,d_1,d_2)=(1,0,1)$. Thus
\[
...
$(1-x^2-x^3)^{-1}$ through weight~$12$.
Deligne--Goncharov and Hoffman give explicit admissible-basis models;
the present use is only the Brown dimension count and its depth
filtration, not a canonical ordered list of iterated-zeta words.
