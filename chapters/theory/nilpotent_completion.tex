...
proof: Vol~III \S~\ref{sec:qgf-grt1-bkm},
Theorem~\ref{thm:qgf-grt1-bkm-transitivity}.  The three verification
...
Definition~$\ref{def:qgf-imag-pro}$; the $\grt_1$-action lifts to
...
locus (Theorem~$\ref{thm:qgf-grt1-bkm-transitivity}$(iii)), removing
the only obstacle to transitivity.

\emph{Ingredient~$3$ (freeness).} Equivariance of the
Gritsenko--Nikulin character identity
(Definition~$\ref{def:qgf-quant-delta5}$(c)) under
$\exp(\widehat{\grt}_1)$-twist is the content of
Theorem~$\ref{thm:qgf-grt1-bkm-transitivity}$(i). The fixed-point set
...
Theorem~$\ref{thm:qgf-grt1-bkm-transitivity}$(iii)), and its image
...
of Definition~\ref{def:qgf-quant-delta5}(c). The decomposition makes
...
\item \emph{Part~I (EK~$1996$ Sel.~Math.~$2$).} Existence and
 ...
 quantisation moduli is Corollary~\ref{cor:qgf-grt1-affine-recovery}.
...
(Cor.~\ref{cor:qgf-grt1-affine-recovery}) verifies the shift on
...
(Remark~\ref{rem:qgf-grt1-three-paths}) verifies the invariance of
$c_{\Phi_{10}/\eta^{24}}^{(3)}$.
...
Theorem~\ref{thm:qgf-grt1-bkm-transitivity}(iii).  A general proof
