...
\begin{remark}[\ClaimStatusConjectured; ref.\
...
Theorem~\ref{thm:modular-characteristic}) is the scalar shadow of a
conjectural Maurer--Cartan class
...
\right).
\end{equation}
Constructing $\Theta_{\cA}$---making the Fourier transform into a
functor of $\infty$-categories---is the principal open problem of the
subject (Conjecture~\ref{conj:master-theta}, MC2).
\end{remark}
