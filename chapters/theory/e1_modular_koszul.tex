...
\begin{remark}[Genus-$1$ non-splitting and the holomorphic anomaly]
\label{rem:genus1-nonsplitting-anomaly}
\index{holomorphic anomaly!and non-splitting}
The quasi-modular obstruction of
Proposition~\ref{prop:e1-nonsplitting-genus1} is the bar-complex
manifestation of the holomorphic anomaly equation of
Bershadsky--Cecotti--Ooguri--Vafa: the genus-$1$ free energy
$F_1 = -\log\,\eta(\tau)^{2\kappa}$ satisfies
$\partial_{\bar{\tau}} F_1 \neq 0$ precisely because the
non-holomorphic completion converts $E_2$ to $\widehat{E}_2$.
The strength of the obstruction is proportional to~$\kappa$:
at $\kappa = 0$ (the uncurved case), $F_1 = 0$ and both
the genus-$0$ and genus-$1$ obstructions survive through the
$\mathrm{GRT}_1$-torsor, but the quasi-modular channel closes.
