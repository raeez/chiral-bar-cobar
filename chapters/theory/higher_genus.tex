...
\item At genus~$g \geq 1$: $\tau_{\mathrm{mod}}$ satisfies the
  \emph{curved} MC equation
  $\partial\tau_{\mathrm{mod}} +
  \tau_{\mathrm{mod}} \star \tau_{\mathrm{mod}} =
  ...
  obstruction to flatness of $\tau_{\mathrm{mod}}$ at genus~$g$.
\item The total differential $D_{\mathrm{tot}} =
  \dzero + [\tau_{\mathrm{mod}}, -]$
  (Theorem~\ref{thm:total-differential-from-mc}) is the
  \emph{twisted differential} associated to
  $\tau_{\mathrm{mod}}$.  Its nilpotence $D_{\mathrm{tot}}^2 = 0$
  is the MC equation for $\tau_{\mathrm{mod}}$ in the modular
  convolution algebra.
\end{enumerate}
