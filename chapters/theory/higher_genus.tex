...
Conjecture~\ref{conj:universal-theta}.  Then:
\begin{enumerate}[label=\textup{(\roman*)}]
...
$\operatorname{tr}(\Theta_{\cA^!}) = -\kappa(\cA) \cdot \lambda_g$.
In particular, Conjecture~\ref{conj:universal-theta}
...
$\Theta_{\cA}$ of
Conjecture~\textup{\ref{conj:universal-theta}} exists with the
...
Conjecture~\textup{\ref{conj:universal-theta}} \textup{(MC2)} holds
