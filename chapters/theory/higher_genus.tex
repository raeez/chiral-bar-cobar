...
\begin{theorem}[Structure of \texorpdfstring{$\overline{\mathcal{M}}_{g,n}$}{M-bar(g,n)} {\cite{DeligneM69,Knu83}}; \ClaimStatusProvedElsewhere]
...
\begin{remark}[\texorpdfstring{$E_2$}{E2} collapse mechanism]\label{rem:e2-collapse-mechanism}
