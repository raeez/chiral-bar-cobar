...
% - cor:e3-solvable-filtration-criterion
...
(Corollary~\ref{cor:e3-solvable-filtration-criterion}).
...
(Theorem~\ref{thm:chain-level-E3-top-class-L}) gives this
...
Corollary~\ref{cor:e3-solvable-filtration-criterion}; the derived series
...
classes. Corollary~\ref{cor:e3-solvable-filtration-criterion} gives the
exact criterion.
...
\label{sec:solvable-filtration-criterion}

\begin{corollary}[Solvable filtration criterion and abelian endpoint]
\label{cor:e3-solvable-filtration-criterion}
\ClaimStatusConditional
...
case of
Corollary~\ref{cor:e3-solvable-filtration-criterion}(v): the
...
(Corollary~\ref{cor:e3-solvable-filtration-criterion}): the finite derived
