...
\label{rem:ifc-DNA-1}
The Wave~13 class-$\mathcal S$ fingerprint for
$\mathcal T[A_1,\Sigma_{0,24}]$ is the triple
\[
...
image as $\mathbf H_{\Delta_5}$-module. The $c_{2d} = -312 = -26\cdot 12$
factorisation reads the Virasoro shadow-tower face against the $24$
Schur/flavour $\mathfrak{su}(2)$ currents at the Kodaira $I_1$
punctures \cite{Gaiotto2009,BeemRastelli2015}. Cross-ref Vol.~III
Chapter~\ref{ch:k3-chiral-bialgebra-platonic}.
\end{remark}

\begin{remark}[Coulomb-rank $21$ vs Mukai-signature $20$]
\label{rem:ifc-DNA-2}
The Wave~13 fingerprint distinguishes Coulomb rank $21$ from the Mukai
...
lattice $II_{4,20}\oplus\langle 1\rangle$. The fingerprint depth at
the Virasoro face is $c_{2d} + 2c_{4d} = -260 = -2\cdot c_-(c_-/4+1)$,
consistent with the Mukai-doubling $K^{\kappa_{\mathrm{ch}}} = 8 = 2c_+$
\cite{Mukai1987,Borcherds1998}. Cross-ref
Chapter~\ref{ch:k3-chiral-bialgebra-platonic}.
\end{remark}

\begin{remark}[Pentagon--umbral cohomology class as Wave-14 fingerprint refinement]
\label{rem:ifc-DNA-3-pentagon-umbral}
Wave~14 adds a cohomological fingerprint refinement on top of the
numerical triple $(c_{4d}, c_{2d}, \mathrm{rank}_{\mathrm{Coul}}) =
(26, -312, 21)$ of Remark~\ref{rem:ifc-DNA-1}. The pentagon
...
(Cheng--Duncan--Harvey~$2014$, Table~$1$). Two theories with identical
numerical fingerprints but different umbral-cocycle classes are distinct
even at the level of the Wave-13 DNA; cross-ref Vol.~III
Theorem~\ref{ch:k3-chiral-bialgebra-platonic}'s
