...
$A^i=H^*(B(A))$ its Koszul-dual coalgebra,
$A^!=(A^i)^\vee$ its Koszul-dual algebra, and
...
\begin{remark}[Pentagon--umbral cohomology class as fingerprint refinement]
...
$\hbar^3$-obstruction of the Siegel--Borcherds associator
