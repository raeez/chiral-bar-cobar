...
(Convention~\ref{conv:bar-coalgebra-identity}), not a tautology \emph{Caution}: the cobar construction $\Omega(\bar{B}(\mathcal{A}))$
...
structure, while $\cH_{-k}$ is generated by $V$ with level $-k$
. The bar complex
...
punctures \cite{}. Under this identification, the operad composition
