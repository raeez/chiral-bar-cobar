...
(Theorem~\ref{conj:universal-MC}) lives in
...
\begin{proposition}[Forced by conformal invariance {\cite{BPZ84}}; \ClaimStatusProvedElsewhere]
...
\begin{theorem}[Bar-cobar adjunction {\cite{LV}}; \ClaimStatusProvedElsewhere]
