...
is the Wave~13 quantum-Poincar\'e-duality pairing on $\mathbf H_{\Delta_5}$.
...
is Wave~13's refinement of derived-centre complementarity
...
\label{rem:pdq-DNA-2}
On $\mathcal T[A_1,\Sigma_{0,24}]$: Coulomb rank $21$, $c_{4d} = 26$,
$c_{2d} = -312$. The Virasoro face of the shadow tower is
$c_{2d} = -2c_{4d} - 2c_-(c_-/4+1) = -52 - 260$ with $c_- = 20$
(Mukai signature negative part). The Wave~13 quantum-Poincar\'e-duality
reads this as a chiral/vertex-algebra Poincar\'e dual of the Mukai
pairing: class-$\mathcal M$ Virasoro on the chiral side dualises
the Mukai $(4,20)$ on the CY side. Cross-ref Vol.~III
Chapter~\ref{ch:k3-chiral-bialgebra-platonic} \S on class-$\mathcal S$
AGT chiral algebra.
\end{remark}

\begin{remark}[Witten DNA: DMVV / Nakajima-BPS character of
$\mathbf{H}_{\Delta_{5}}$]
\label{rem:pdq-DNA-witten-dmvv-nakajima}
