...
The genus expansion and Feynman transform structure observed for the Heisenberg algebra in Chapter~\ref{ch:heisenberg-frame} extend to a modular operad framework for arbitrary Koszul chiral algebras. This chapter develops the quantum corrections to Poincar\'e duality in the modular setting.

At genus zero, bar-cobar duality is an operadic fact: it follows from the formal properties of the bar and cobar functors applied to the chiral operad.  At higher genus, the situation changes qualitatively.  The modular operad of stable curves $\overline{\mathcal{M}}_{g,n}$ replaces the genus-$0$ operad, curvature classes enter through the Hodge bundle, and Koszul duality must be ``quantized'' to accommodate the genus tower.  This section develops the genus-graded framework via the Feynman transform of the modular operad and its physical interpretation through holographic duality.
