...
These are \emph{dual} constructions: factorization homology computes the derived tensor product (the \emph{homological} side), while the bar complex computes the derived Hom (the \emph{cohomological} side). They are related by $\mathbb{E}_2$-Koszul duality as developed by Francis \cite{Francis2013}.
\end{theorem}

\begin{proof}[Proof sketch]
Both constructions are derived functors of the forgetful functor from $\mathcal{A}$-modules to chain complexes, evaluated on the trivial module. The tensor product and Hom versions are related by the universal coefficient theorem and, more fundamentally, by the self-duality of the $\mathbb{E}_2$-operad.
\end{proof}
