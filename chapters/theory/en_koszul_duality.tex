...
all shadow classes on the canonical pro-object / $J$-adic /
filtered weight-completed presentations of the raw bar complex,
...
the same mechanism as Theorem~\ref{thm:E3-topological-DS}:
...
\]
Theorem~\textup{\ref{thm:e-infinity-topologization}} at
...
fields of~$\cW_N$. Theorem~\textup{\ref{thm:e-infinity-topologization}}
at $k = N$ gives
\[
  \Zder^{\mathrm{ch}}(\cW_N)
  \;\in\;
...
Theorem~\textup{\ref{thm:e-infinity-topologization}} gives
\[
...
argument as Theorem~\ref{thm:E3-topological-DS-general} of
...
\item \emph{Monster orbifold (rem:monster-orbifold-route,
  Theorem~\ref{thm:monster-orbifold-e3}):} $V_\Lambda^+$ with
...
\item \emph{DS reduction (Theorems~\ref{thm:E3-topological-DS},
  \ref{thm:E3-topological-DS-general}):} $\cW_k(\fg, f)$ inherits
...
in~\ref{rem:e3-topological-scope-map}~\ref{item:scope-orbifold}(b)
...
through cosets (case~\ref{item:scope-orbifold} of
...
Theorem~\ref{thm:e-infinity-topologization} embeds each
...
Conjecture~\ref{conj:coderived-e3} is the alternative
path.
\end{proof}
...
\begin{remark}[CY-$2$ $[2]$-shift with $\widetilde{M}_{24}$ Schur cocycle at K3]
...
After topologisation (Vol.~II, \S\ref{sec:schtop-heptagon-supplement}),
...
(Vol.~II, \S\ref{sec:3dgravvix-supplement}). The universal identity
