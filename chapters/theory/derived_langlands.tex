...
At critical level $k = -h^\vee$ the bar complex becomes uncurved and recovers the derived oper space: chiral Koszul duality produces a vertex-algebraic path to geometric Langlands, independent of the categorical approach.
\end{remark}
...
Positselski~\cite{Positselski11} develops the theory of CDG-algebras,
