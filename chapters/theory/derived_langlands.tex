...
equivalence, remain at the frontier---they are part of the MC3
programme that is proved in type~A and conjectural beyond.
...
frontier (MC3 itself is proved in type~A; the periodicity aspect is open).  Even on the KL side, the ordinary semisimplified target
