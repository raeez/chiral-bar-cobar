...
no physical content beyond tracking the genus grading.
\end{definition}
...
chiral Koszul characteristic transport within the $\mathcal{W}$-algebra family, not the
...
Chapter~\ref{V3-ch:k3-chiral-bialgebra-platonic} \S on pentagon closures.
\end{remark}
...
action on the chiral side. See Vol.~III Chapter~\ref{V3-ch:k3-chiral-bialgebra-platonic}.
\end{remark}
...
(Vol.~III Definition~\ref{V3-def:k3-chiral-bialgebra}) and its status. The
...
Section~\ref{V3-sec:R-Sieg-dynamical}.
\end{remark}
