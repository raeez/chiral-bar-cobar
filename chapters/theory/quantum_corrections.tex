...
The governing question of this chapter is the mathematical role of \emph{Quantum corrections to Arnold relations}: which part of the modular bar-cobar construction or its inversion it isolates, and which boundary between construction, resolution, and shadow it clarifies.
\end{remark}
