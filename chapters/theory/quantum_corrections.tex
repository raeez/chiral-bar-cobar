...
Arnold's relation is the geometric reason
that the bar differential squares to zero: the partial-fraction identity
...
survives curvature and modular transport.
...
is the classical bar differential governed by Arnold's
relation, and the higher-genus parts
$D^{(g)}$ for $g \geq 1$ are the quantum corrections.
...
corrections assemble into a universal, additive,
...
The Jacobiator homotopy is the arity-$3$ component of the MC equation
...
operations $F_n$ of \cite{MS24} at arity $n \geq 3$ are
