...
The quantum corrections to bar-cobar duality---curvature terms, Eisenstein regularizations, and their organization into a curved $A_\infty$ package---are collected here in their most explicit form.  The genus-$1$ curvature $d^2 = \kappa \cdot \omega_1$ first encountered for the Heisenberg algebra (Chapter~\ref{ch:heisenberg-frame}, \S\ref{sec:frame-genus1}) exemplifies the general pattern.
