...
operad and recorded in the shadow Postnikov obstruction tower of
...
% RECTIFICATION-FLAG: The $m_3$ coefficient for beta-gamma requires
% recomputation from HTT on FM_3(C) with the beta-gamma OPE data.
% The Q^2 prefactor was unsupported and has been removed.
