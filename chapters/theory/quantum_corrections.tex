...
The $A_\infty$ structure is strict: $m_1 = 0$ (the bar complex is already a complex), $m_2$ is the standard product, and $m_n = 0$ for $n \geq 3$.  The genus-$g$ corrections for $g \geq 1$ enter not through higher $m_n$ but through the propagator and the cohomology of $\mathcal{M}_g$ (cf.\ Part~II).
