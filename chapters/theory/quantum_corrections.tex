...
\label{rem:qc-1}
The pentagon-level quantum correction on $\mathbf H_{\Delta_5}$ has explicit form
\[
 \phi^{(3)}
 \;=\;
...
independent of $c_{2d}$, so the retraction
...
\label{rem:qc-2}
The $\widetilde M_{24}$ quantum correction attaches the Schur
