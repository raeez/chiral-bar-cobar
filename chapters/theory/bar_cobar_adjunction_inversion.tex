...
duality (AP25/AP34 discipline). At $\cA = \mathcal{H}_{\mathrm{Muk}}$ the Mukai-Heisenberg
...
The bar-cobar inversion map for the K3 chiral bialgebra,
\[
\Omega_X\bigl(B_{\mathrm{ch}}(\mathbf H_{\Delta_5})\bigr)\ \xrightarrow{\;\eta\;}\ \mathbf H_{\Delta_5},
\]
is a quasi-isomorphism for all $\hbar$, and becomes a \emph{strict
isomorphism} at the Lusztig specialisation $\hbar^2 = -1/8$. This
strictness is forced by the universal identity
