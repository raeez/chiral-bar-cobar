...
(Proposition~\ref{prop:two-element-strict}).
\end{proposition}
...
Proposition~\ref{prop:two-element-strict} applies.  The \v{C}ech
...
\Phi_{\widehat{\mathfrak{sl}}_2}
  = (d_M, F_2, 0, 0, \ldots),
\]
by Proposition~\ref{prop:two-element-strict}.  The binary bracket
...
complex has $V^2 \neq 0$, so
Proposition~\ref{prop:two-element-strict} does \emph{not} apply.
