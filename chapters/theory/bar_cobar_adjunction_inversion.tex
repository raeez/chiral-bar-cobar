...
(Theorem~\ref{thm:shifted-symplectic-complementarity}) makes them
...
(Theorem~\ref{thm:shifted-symplectic-complementarity}) is proved
unconditionally; the characterization of Koszulness as Lagrangian
...
the sub-exponential growth condition~\textup{(ii)} of
