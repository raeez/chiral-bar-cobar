...
statement that the MC element $\Theta_\cA$ determines~$\cA$: one can
recover the algebra from its coalgebraic shadow.  This is not a formal
...
(MC3, partially resolved: CG all types, post-CG open beyond type~$A$).
