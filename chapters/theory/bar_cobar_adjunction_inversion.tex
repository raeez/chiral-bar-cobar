...
The two-layer answer is the chain-level realisation of the unified
Koszul reflection of Theorem~\ref{thm:koszul-reflection}: the
strict Koszul lane is clause~\ref{KR-ii}
\textup{(}$K^{2}\simeq\mathrm{id}$ at chain level on $\Kosz(X)$\textup{)},
the coderived off-Koszul lane is clause~\ref{KR-iii}
\textup{(}$K^{2}\simeq\mathrm{id}$ in
...
constructive form of the inverse half $K^{-1} = \Omegach$ of the
Koszul reflection, computed concretely in distributional kernels and
with explicit coderived corrections off the Koszul locus.
...
\subsection{Theorem A in Platonic form: the Koszul reflection}
\label{sec:theorem-A-platonic}

The chiral bar functor $\bar{B}_X$ and the chiral cobar functor $\Omega_X$
assemble into a single involutive symmetric-monoidal adjoint equivalence on
the natural ambient $(\infty, 1)$-category of factorisation algebras on
$\Ran(X)$.  The statement is one sentence, one display, one diagram.

\begin{theorem}[Chiral bar--cobar duality, Platonic form]
\label{thm:bar-cobar-platonic}
\ClaimStatusProvedHere
Let $X$ be a smooth projective curve over $\mathbb{C}$.  The pair
$(\Omega_X, \bar{B}_X)$ is a symmetric-monoidal adjoint equivalence of
...
\]
with unit $\eta_A \colon A \to \bar{B}_X \Omega_X(A)$ the universal
Maurer--Cartan element and counit $\varepsilon_C \colon \Omega_X \bar{B}_X(C) \to C$
its Verdier dual.  The equivalence restricts, on the Koszul locus
$\mathrm{Kosz}(X) \subset \mathrm{Alg}^{\mathrm{fact, aug, comp}}_X$, to a
symmetric-monoidal adjoint equivalence with values in \emph{ordinary}
\textup{(}non-coderived\textup{)} factorisation coalgebras and chain-level
quasi-isomorphism for both unit and counit.
\end{theorem}
...
filtration compatibility\textup{)}. Chain-level and $(\infty,1)$ are sibling lanes, not
hierarchy: the chain-level
$h$ constructs $K^2\simeq\mathrm{id}$ strand by strand; the
$(\infty,1)$-adjunction
...
\paragraph{The Koszul reflection.}
Define the involutive symmetric-monoidal endofunctor
\[
  K \;\colon\; \mathrm{Alg}^{\mathrm{fact, aug, comp}}_X \;\to\; \mathrm{Alg}^{\mathrm{fact, aug, comp}}_X,
  \qquad K(A) \;:=\; \Omega_X \bar{B}_X(A).
\]
Theorem~\ref{thm:bar-cobar-platonic} asserts $K^2 \simeq \mathrm{id}$ on
$\mathrm{Kosz}(X)$ at the chain level and $K^2 \simeq \mathrm{id}$ off
$\mathrm{Kosz}(X)$ in the coderived sense.  The slogan: \emph{the chiral
bar is its own Koszul dual}, the universal symmetry of the chiral world.
...
\ClaimStatusConjectured
The Koszul reflection $K \colon A \mapsto \Omega \bar{B}(A)$ is involutive
in the chain-level sense \textup{(}not merely up to coderived
correction\textup{)} on the full Koszul locus $\mathrm{Kosz}(X)$, including
...
\textup{(}This is Theorem~B of the programme; in the unified Koszul
reflection of Theorem~\ref{thm:koszul-reflection}, it is the
involutivity clause~\ref{KR-ii} \textup{(}chain-level
$K^2\simeq\mathrm{id}$ on the Koszul locus\textup{)} together with
the coderived clause~\ref{KR-iii} \textup{(}$K^{2}\simeq\mathrm{id}$
