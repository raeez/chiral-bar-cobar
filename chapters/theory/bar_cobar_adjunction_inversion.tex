...
\ClaimStatusProvedHere]\label{conj:barr-beck-lurie-koszulness}
...
\ClaimStatusProvedHere]\label{conj:fh-concentration-koszulness}
...
\ClaimStatusProvedHere]\label{conj:fm-boundary-acyclicity}
...
\ClaimStatusProvedHere]\label{conj:lagrangian-koszulness}
