...
The contraderived category of such contramodules is
...
in category~$\mathcal{O}$; proved for all simple types via
multiplicity-free $\ell$-weights, Corollary~\ref{cor:mc3-all-types})
