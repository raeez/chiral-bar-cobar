...
The table refines
Remark~\ref{rem:critical-level-dimensional-divergence}: at
non-critical level the three theories already have unequal
cohomological dimension vectors. Heisenberg has
...
\begin{remark}[What ``agreement'' means precisely; \ClaimStatusProvedHere]
...
convention. This is a structural distinction among operads and
differentials, not a size theorem about topological Hochschild
homology. A THH comparison enters only after the spectrum-level lift
