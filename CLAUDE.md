...
Major structural component. The meta-theorem (thm:koszul-equivalences-meta in chiral_koszul_pairs.tex) lists 12 equivalent characterizations of chiral Koszulness — **10 unconditionally proved + 1 conditional + 1 partially proved**. Concordance section: sec:concordance-koszulness-programme.

**Unconditionally proved (10):**
...
- thm:barr-beck-lurie-koszulness: Barr-Beck-Lurie monadic characterization
- thm:fh-concentration-koszulness: factorization homology concentration
- thm:fm-boundary-acyclicity: FM boundary acyclicity

**Conditional (1):**
- thm:lagrangian-koszulness: Lagrangian criterion (conditional on perfectness/nondegeneracy hypotheses)

**Partially proved (1):**
- conj:d-module-purity-koszulness: D-module purity ((x)⟹(xii) proved, converse open)

## Three Concentric Rings (the architecture)

**Ring 1** — Proved core: Theorems A-H, **MC1-5 ALL PROVED**, DK-0 through DK-3, MC3 thick generation (type A all N), MC4 strong completion towers (thm:completed-bar-cobar-strong, W_N rigidity, 21 conjectures resolved), MC5 all-genera sewing (thm:general-hs-sewing, thm:heisenberg-sewing), Koszulness 10 unconditional + 1 conditional + 1 partial (thm:koszul-equivalences-meta).
...
7. **Koszulness characterization programme** (sec:concordance-koszulness-programme in concordance.tex, thm:koszul-equivalences-meta in chiral_koszul_pairs.tex): 12 equivalent characterizations of chiral Koszulness (**10 unconditionally proved + 1 conditional + 1 partially proved**). Includes: A∞ formality, shadow-formality, E₂-formality, curve independence, graph-sum truncation, universal Koszulness, PBW universality, Barr-Beck-Lurie, FH concentration, FM boundary acyclicity (all unconditional); Lagrangian criterion (conditional on perfectness/nondegeneracy); D-module purity ((x)⟹(xii) proved, converse open).
...
- Koszulness characterization programme: recorded in concordance.tex sec:concordance-koszulness-programme. 12 equivalent characterizations of chiral Koszulness (**10 unconditionally proved + 1 conditional + 1 partially proved**, thm:koszul-equivalences-meta in chiral_koszul_pairs.tex). 10 unconditional: A∞ formality, shadow-formality, E₂-formality, curve independence, graph-sum truncation, universal Koszulness, PBW universality, Barr-Beck-Lurie, FH concentration, FM boundary acyclicity. Conditional: Lagrangian criterion (thm:lagrangian-koszulness, pending perfectness/nondegeneracy). Partially proved: D-module purity (conj:d-module-purity-koszulness, (x)⟹(xii) proved, converse open).
