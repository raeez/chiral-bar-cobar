...
session id: 019d86c5-9e48-7650-be47-69e49aa99a62
--------
user
<task>
...
SCOPE: Last 200 commits. Run: git log --oneline -200 -- chapters/examples/yangians_computations.tex | head -20
MC3 Baxter + Yangian. Verify constraint b=a-1/2 (AP201). Cross-check with Drinfeld [Dri85], Chari-Pressley [CP95].
