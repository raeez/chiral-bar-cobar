...
session id: 019d8434-1b9d-7d93-98ed-a077262e21d1
--------
user
<task>
...
MISSION: DEEP AUDIT of compute engines matching 'lattice' in /Users/raeez/chiral-bar-cobar

1. Find all engine files: ls /Users/raeez/chiral-bar-cobar/compute/lib/*lattice*.py
2. Find matching test files: ls /Users/raeez/chiral-bar-cobar/compute/tests/test_*lattice*.py
3. For each engine:
   ...
   e. Run the tests: cd /Users/raeez/chiral-bar-cobar && python3 -m pytest compute/tests/test_*lattice*.py -v --tb=short 2>&1 | tail -30
