...
session id: 019d8434-1787-7690-8982-5ba69172cb03
--------
user
<task>
...
MISSION: DEEP AUDIT of compute engines matching 'r_matrix' in /Users/raeez/chiral-bar-cobar

1. Find all engine files: ls /Users/raeez/chiral-bar-cobar/compute/lib/*r_matrix*.py
2. Find matching test files: ls /Users/raeez/chiral-bar-cobar/compute/tests/test_*r_matrix*.py
3. For each engine:
   ...
   e. Run the tests: cd /Users/raeez/chiral-bar-cobar && python3 -m pytest compute/tests/test_*r_matrix*.py -v --tb=short 2>&1 | tail -30
