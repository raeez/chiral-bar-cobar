...
session id: 019d8434-1b95-75d0-b45c-716dc7829c00
--------
user
<task>
...
MISSION: DEEP AUDIT of compute engines matching 'w_algebra' in /Users/raeez/chiral-bar-cobar

1. Find all engine files: ls /Users/raeez/chiral-bar-cobar/compute/lib/*w_algebra*.py
2. Find matching test files: ls /Users/raeez/chiral-bar-cobar/compute/tests/test_*w_algebra*.py
3. For each engine:
   ...
   e. Run the tests: cd /Users/raeez/chiral-bar-cobar && python3 -m pytest compute/tests/test_*w_algebra*.py -v --tb=short 2>&1 | tail -30
