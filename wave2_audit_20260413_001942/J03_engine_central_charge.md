...
MISSION: DEEP AUDIT of compute engines matching 'central_charge' in /Users/raeez/chiral-bar-cobar

1. Find all engine files: ls /Users/raeez/chiral-bar-cobar/compute/lib/*central_charge*.py
2. Find matching test files: ls /Users/raeez/chiral-bar-cobar/compute/tests/test_*central_charge*.py
3. For each engine:
   ...
   e. Run the tests: cd /Users/raeez/chiral-bar-cobar && python3 -m pytest compute/tests/test_*central_charge*.py -v --tb=short 2>&1 | tail -30
