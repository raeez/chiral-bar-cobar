...
session id: 019d8434-1f5f-7271-896b-a917f87ea82b
--------
user
<task>
...
MISSION: CONVENTION CONSISTENCY AUDIT for Virasoro Vir_c.

CANONICAL DATA: kappa=c/2, r(z)=(c/2)/z^3+2T/z, class M, self-dual c=13, K(Vir)=13
