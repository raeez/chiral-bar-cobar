...
session id: 019d8434-1f62-74f3-b436-b1713c3a6296
--------
user
<task>
...
MISSION: CONVENTION CONSISTENCY AUDIT for Yangians Y_hbar(g).

CANONICAL DATA: E_1-chiral (genuinely nonlocal), R-matrix independent, four types (classical/dg/chiral/spectral)
