...
session id: 019d8434-1b9a-73e3-b832-9fc7ba8be0cb
--------
user
<task>
...
MISSION: DEEP AUDIT of compute engines matching 'yangian' in /Users/raeez/chiral-bar-cobar

1. Find all engine files: ls /Users/raeez/chiral-bar-cobar/compute/lib/*yangian*.py
2. Find matching test files: ls /Users/raeez/chiral-bar-cobar/compute/tests/test_*yangian*.py
3. For each engine:
   ...
   e. Run the tests: cd /Users/raeez/chiral-bar-cobar && python3 -m pytest compute/tests/test_*yangian*.py -v --tb=short 2>&1 | tail -30
