...
Trace Theorem A proof chain end-to-end. Start from thm:bar-cobar-adjunction. Follow EVERY cited result. For each: exists? proved? hypotheses satisfied? Flag any missing node or circularity.
