...
MISSION: DEEP AUDIT of compute engines matching 'ghost' in /Users/raeez/chiral-bar-cobar

1. Find all engine files: ls /Users/raeez/chiral-bar-cobar/compute/lib/*ghost*.py
2. Find matching test files: ls /Users/raeez/chiral-bar-cobar/compute/tests/test_*ghost*.py
3. For each engine:
   ...
   e. Run the tests: cd /Users/raeez/chiral-bar-cobar && python3 -m pytest compute/tests/test_*ghost*.py -v --tb=short 2>&1 | tail -30
