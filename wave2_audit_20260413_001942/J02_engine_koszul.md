...
session id: 019d8434-17c0-7110-9bd8-201867c96ea8
--------
user
<task>
...
MISSION: DEEP AUDIT of compute engines matching 'koszul' in /Users/raeez/chiral-bar-cobar

1. Find all engine files: ls /Users/raeez/chiral-bar-cobar/compute/lib/*koszul*.py
2. Find matching test files: ls /Users/raeez/chiral-bar-cobar/compute/tests/test_*koszul*.py
3. For each engine:
   ...
   e. Run the tests: cd /Users/raeez/chiral-bar-cobar && python3 -m pytest compute/tests/test_*koszul*.py -v --tb=short 2>&1 | tail -30
