...
session id: 019d8434-1794-7832-b8bc-d117e892aef3
--------
user
<task>
...
MISSION: DEEP AUDIT of compute engines matching 'stokes' in /Users/raeez/chiral-bar-cobar

1. Find all engine files: ls /Users/raeez/chiral-bar-cobar/compute/lib/*stokes*.py
2. Find matching test files: ls /Users/raeez/chiral-bar-cobar/compute/tests/test_*stokes*.py
3. For each engine:
   ...
   e. Run the tests: cd /Users/raeez/chiral-bar-cobar && python3 -m pytest compute/tests/test_*stokes*.py -v --tb=short 2>&1 | tail -30
