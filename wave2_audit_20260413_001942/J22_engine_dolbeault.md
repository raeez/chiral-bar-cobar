...
session id: 019d8434-1c1b-7713-b3c7-f36fccfd014e
--------
user
<task>
...
MISSION: DEEP AUDIT of compute engines matching 'dolbeault' in /Users/raeez/calabi-yau-quantum-groups

1. Find all engine files: ls /Users/raeez/calabi-yau-quantum-groups/compute/lib/*dolbeault*.py
2. Find matching test files: ls /Users/raeez/calabi-yau-quantum-groups/compute/tests/test_*dolbeault*.py
3. For each engine:
   ...
   e. Run the tests: cd /Users/raeez/calabi-yau-quantum-groups && python3 -m pytest compute/tests/test_*dolbeault*.py -v --tb=short 2>&1 | tail -30
