...
session id: 019d8434-1b9b-7861-9817-9f5832cbc3e7
--------
user
<task>
...
MISSION: DEEP AUDIT of compute engines matching 'hilbert' in /Users/raeez/chiral-bar-cobar

1. Find all engine files: ls /Users/raeez/chiral-bar-cobar/compute/lib/*hilbert*.py
2. Find matching test files: ls /Users/raeez/chiral-bar-cobar/compute/tests/test_*hilbert*.py
3. For each engine:
   ...
   e. Run the tests: cd /Users/raeez/chiral-bar-cobar && python3 -m pytest compute/tests/test_*hilbert*.py -v --tb=short 2>&1 | tail -30
