...
session id: 019d8434-1f64-7351-a33c-65169ff1428d
--------
user
<task>
...
MISSION: DEEP AUDIT of compute engines matching 'swiss_cheese' in /Users/raeez/calabi-yau-quantum-groups

1. Find all engine files: ls /Users/raeez/calabi-yau-quantum-groups/compute/lib/*swiss_cheese*.py
2. Find matching test files: ls /Users/raeez/calabi-yau-quantum-groups/compute/tests/test_*swiss_cheese*.py
3. For each engine:
   ...
   e. Run the tests: cd /Users/raeez/calabi-yau-quantum-groups && python3 -m pytest compute/tests/test_*swiss_cheese*.py -v --tb=short 2>&1 | tail -30
