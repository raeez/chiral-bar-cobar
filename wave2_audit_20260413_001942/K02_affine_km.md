...
session id: 019d8434-1f60-7492-ad4e-fe3576b06439
--------
user
<task>
...
MISSION: CONVENTION CONSISTENCY AUDIT for Affine KM V_k(g).

CANONICAL DATA: kappa=dim(g)(k+h^v)/(2h^v), r(z)=k*Omega/z [trace-form], class L, k=0→dim(g)/2, k=-h^v→0 critical
