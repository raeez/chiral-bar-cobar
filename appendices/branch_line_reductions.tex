...
This appendix reorganizes a thread of frontier calculations around the
...
Second, the full universal class \(\Theta_{\cA}\) is already available
in the present repository by
Theorems~\ref{thm:universal-theta} and~\ref{thm:mc2-full-resolution}.
The new constructions below therefore have a precise role: they are
shadow and quotient theorems \emph{inside} the proved modular package.
