...
\begin{definition}[Arity-$r$ contact bundle and resonance class; \ClaimStatusConjectured]
...
\begin{conjecture}[All-arity boundary law for the resonance tower; \ClaimStatusConjectured]
...
\begin{theorem}[Bipartite complementarity principle; \ClaimStatusConjectured]
...
The constructions of \S\ref{sec:nms-feynman-transform-programme}--\S\ref{sec:nms-polarized-scattering-programme} yield a coherent programme of four conjectural theorems, ordered by structural depth.

\begin{conjecture}[Bipartite vanishing theorem; \ClaimStatusConjectured]
