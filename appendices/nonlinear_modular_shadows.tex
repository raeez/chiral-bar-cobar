...
\end{theorem}
\begin{proof}
This is a restatement of the bipartite vanishing theorem (Theorem~\ref{conj:nms-bipartite-vanishing}): the Lagrangian isotropy $\langle V^+,V^+\rangle=0=\langle V^-,V^-\rangle$ forces the same-colour blocks of the propagator to vanish, so every internal-edge contraction within a single colour is zero.
\end{proof}
...
\label{conj:nms-bipartite-vanishing}
