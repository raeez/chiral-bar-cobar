...
This appendix is \textbf{S-level}: a symbol ledger for fast lookup.
Its role is consistency control across H-level concepts and M-level
models, not the introduction of new claims.
\end{remark}

The governing question of this appendix is: which notation choices keep
the multi-chapter modular Koszul narrative unambiguous at every level.
