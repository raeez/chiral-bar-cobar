...
$B_n(X)$ & Unordered configuration space $C_n(X)/\Sigma_n$ \\
...
The algebraic bar complex is represented by the DG coalgebra model of Definition~\ref{def:bar-coalgebra}.
\end{definition}
...
The canonical affine OPE template is Equation~\ref{eq:affine-kac-moody-ope}.
\end{definition}
