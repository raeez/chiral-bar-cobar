...
$\mathrm{HH}^\bullet_{\mathrm{alg}}(A)$ & Classical algebraic Hochschild cohomology of an associative or dg algebra~$A$ \\
$\mathrm{HH}^\bullet_{\mathrm{cat}}(\cC)$ & Categorical Hochschild cohomology $\RHom_{\cC \otimes \cC^{\mathrm{op}}}(\id,\id)$ of a dg/$A_\infty$-category~$\cC$ \\
$\mathrm{THH}(R)$ & Topological Hochschild homology of an $E_1$-ring spectrum~$R$ \\
...
$\kappa(\cA)$ & Obstruction coefficient (modular characteristic) of chiral algebra $\cA$ \\
