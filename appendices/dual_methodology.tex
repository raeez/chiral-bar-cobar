...
This appendix is mixed-level by design: abstract functorial arguments
are \textbf{H-level}, while explicit filtrations, homotopies, and
formulas are \textbf{M-level}.  Its role is methodological control, not
new theorem-level content.
\end{remark}

The governing question of this appendix is: how the same theorem is
stabilized by an abstract homotopy-native proof and an explicit chain
model proof, with each perspective constraining the other.

Every major result is established via two complementary
