...
\begin{corollary}[Bar-cobar inversion establishes Koszulness \cite{LV12}; \ClaimStatusProvedElsewhere]
\label{cor:derived-koszul}
For any augmented $\Eone$-chiral algebra $\cA$, the counit of the bar-cobar
adjunction
\[
...
is Theorem~B (bar-cobar inversion), not a definition of Koszulness: the
...
\noindent\emph{Three functors, one input} (AP25 discipline): $B(\cA)$ is a
