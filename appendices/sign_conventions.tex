...
This appendix operates at \textbf{M-level}: a translation dictionary
for sign and grading conventions across sources (Loday--Vallette,
Beilinson--Drinfeld, Costello--Gwilliam).
\end{remark}

The governing question of this appendix is: which convention
translations are required so computations and theorem statements remain
compatible across the source literatures used in the monograph.
