...
The governing question of this appendix is the mathematical role of \emph{The combinatorial frontier of chiral bar cohomology}: which auxiliary input it supplies to the modular bar-cobar theory on curves, and how it should be used without inflating reference material into new theorematic claims.
\end{remark}

\begin{remark}[H/M/S route; Convention~\ref{conv:hms-levels}]
M/S-level reference; no new H-level inversion statements.
\end{remark}
...
\begin{remark}[The number \texorpdfstring{$\sqrt{13}$}{sqrt(13)}]
