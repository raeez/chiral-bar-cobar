...
This appendix is primarily M/S-level reference material. It records formulas, comparison statements, tables, or auxiliary identities, and it does not by itself promote new H-level inversion statements.
\end{remark}
...
\begin{conjecture}[$\mathcal{W}_3$ bar cohomology generating function; \ClaimStatusConjectured]\label{conj:w3-bar-gf}
...
\begin{conjecture}[Period-$6$ Pad\'e structure; \ClaimStatusConjectured]
