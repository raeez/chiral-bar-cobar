...
\item the \emph{ambient category} in which bar/cobar inversion is actually true;
...
\begin{lemma}[Weightwise stabilization of the bar complex \textup{[proved here]}]
...
\begin{theorem}[Stabilized completed bar/cobar recovery \textup{[proved here]}]
...
\begin{corollary}[Automatic tower convergence in positive degree \textup{[proved here]}]
...
\begin{theorem}[Weightwise Maurer--Cartan descent \textup{[proved here]}]
...
\begin{proposition}[Module/comodule passage for stabilized towers \textup{[proved here]}]
...
\begin{theorem}[Trace-theoretic bar duality \textup{[proved here]}]
...
\begin{corollary}[The Lagrangian envelope \textup{[proved here]}]
...
\begin{lemma}[Generator extension of exact monoidal functors \textup{[proved here]}]
...
\begin{theorem}[Meromorphic Tannakian reconstruction \textup{[proved here]}]
...
\begin{corollary}[Recognition on compact boundary modules \textup{[proved here]}]
...
\begin{lemma}[Scalar gauge invariance of finite RTT stages \textup{[proved here]}]
...
\begin{corollary}[Inverse kernel versus sign reversal \textup{[proved here]}]
...
\begin{theorem}[Finite-stage RTT bar adjointness \textup{[proved here]}]
...
\begin{corollary}[The degree-$2$ twisting cochain \textup{[proved here]}]
...
\begin{theorem}[Transport of the finite RTT relation space \textup{[proved here]}]
...
\begin{theorem}[Finite-stage shifted bar adjointness \textup{[proved here]}]
...
\begin{theorem}[Quotient/coideal descent \textup{[proved here]}]
...
\begin{proposition}[Stage $N=1$ twist is trivial; naive Cartan fixing collapses the root sector \textup{[proved here]}]
\label{prop:stage-one-cartan-collapse}
For $A_1$ at stage $N=1$, the bi-diagonal twist is trivial on generators:
\[
\Phi_{\mu,1}=\mathrm{id}.
\]
Moreover, any quotient of $U(\mathfrak{sl}_2)$ in which $h$ becomes a scalar
...
\begin{theorem}[Explicit rank-one orthogonal coideal and curved cobar model \textup{[proved here]}]
...
\begin{corollary}[Generalized Weyl normal form \textup{[proved here]}]
...
\begin{corollary}[Kleinian associated graded at the nilpotent point \textup{[proved here]}]
...
\begin{conjecture}[Rank-one BFN matching problem \textup{[conjectured]}]
...
\begin{theorem}[Fortified frontier package \textup{[proved here]}]
...
\begin{proof}
Each clause is the content of the cited theorem or corollary.  The point is not
a new computation in the proof but the fact that the programme has been split
