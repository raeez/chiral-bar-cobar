...
The governing question of this appendix is the mathematical role of \emph{Spectral sequences}: which auxiliary input it supplies to the modular bar-cobar theory on curves, and how it should be used without inflating reference material into new theorematic claims.
\end{remark}
