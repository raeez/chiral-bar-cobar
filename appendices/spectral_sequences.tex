...
\begin{theorem}[Classical convergence theorem; \ClaimStatusProvedElsewhere]
...
\begin{proposition}[Convergence for complete filtrations; \ClaimStatusProvedElsewhere]
...
organizes quantum corrections by genus.
...
\begin{theorem}[Genus spectral sequence; \ClaimStatusProvedElsewhere]
\label{thm:genus-ss}
...
\begin{theorem}[Convergence of genus spectral sequence; \ClaimStatusProvedElsewhere]
...
\begin{theorem}[Chevalley--Cousin spectral sequence; \ClaimStatusProvedElsewhere]
...
\begin{theorem}[Cousin resolution for holonomic D-modules; \ClaimStatusProvedElsewhere]
...
\begin{proposition}[Bar spectral sequence is multiplicative; \ClaimStatusProvedElsewhere]
...
\begin{theorem}[Convergence of multiplicative spectral sequences; \ClaimStatusProvedElsewhere]
