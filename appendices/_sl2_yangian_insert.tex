...
quadratic identification then lifts to a full bar--cobar inversion
because $K^2 \simeq \id$ holds on the class~$\mathbf L$ locus
...
a quadratic algebra and the bar--cobar inversion $K^2 \simeq \id$
holds chain-level. This should be contrasted with the Virasoro
