\label{chap:ordered-associative-kd}
...
\title[Ordered associative chiral Koszul duality]{Ordered Associative Chiral Koszul Duality from First Principles:\\
the diagonal bicomodule, Hochschild--coHochschild duality, and the genus-zero open trace formalism}
\author{OpenAI draft for repository integration}
\date{\today}
