...
This section operates at \textbf{M-level}: higher-genus spectral
sequences for explicit bar-complex and moduli-space calculations, with
S-level convergence shadows.
\end{remark}

The governing question of this section is: how genus-indexed filtrations
and moduli-space geometry control convergence and degeneration in the
higher-genus bar theory.
