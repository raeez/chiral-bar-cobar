...
The governing question of this appendix is the mathematical role of \emph{Nilpotent-completion frontier for non-quadratic Koszul duality}: which auxiliary input it supplies to the modular bar-cobar theory on curves, and how it should be used without inflating reference material into new theorematic claims.
\end{remark}
