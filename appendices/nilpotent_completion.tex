...
The $I$-adic completion framework and convergence criteria operate at
\textbf{M-level} (explicit pro-nilpotent chain models).  The
pro-nilpotent/coderived formalism points toward \textbf{H-level}
structures (derived completion, ind-pro categories) developed further
in Appendix~\ref{app:coderived}.
\end{remark}

The governing question of this appendix is: how bar constructions for
non-quadratic chiral algebras are completed so that Koszul dual objects
exist and remain computable.
