...
This appendix is primarily \textbf{S-level}: tabulated numerical and
coefficient data extracted from explicit calculations.  Where formulas
for residues, commutators, or graph integrals are written explicitly,
the input is M-level and should be read as support data for theorematic
claims proved in the main text.
\end{remark}

The governing question of this appendix is: which concrete constants,
weights, and coefficient tables are needed to make the portrait and
synthesis chapters computationally checkable.
...
\subsection{\texorpdfstring{$W_3$ commutators}{W 3 commutators}}
