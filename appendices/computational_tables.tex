...
This appendix collects numerical data for the bar complexes computed in Part~II: Kontsevich weights for the deformation quantization star product, OPE structure constants for low-rank Kac--Moody and $\mathcal{W}$-algebras, Arnold relation expansions through $n = 4$, and modular form data at genera~$1$ and~$2$.
