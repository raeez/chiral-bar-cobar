...
The purpose of this chapter is to isolate a first-principles mechanism that
...
The conceptual picture is this: the associated graded remembers the affine
geometry of the Slodowy slice, while the higher Taylor coefficients of the
completed dual remember exactly the nonlinear normal-ordering corrections that
survive after one chooses a strong generating set and a gauge.  In the
Bershadsky--Polyakov algebra the correction is purely quadratic and the canonical
dual is strict.  In $\mathcal W_4^{(2)}$ a genuine cubic term survives.  In
higher rank the subregular family exhibits canonical homotopy arity that grows
without bound.
