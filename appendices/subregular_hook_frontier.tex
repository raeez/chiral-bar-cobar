...
together, recent results of Fehily, Genra, and Butson--Nair show that generic
type-$A$ affine $W$-algebras can be related along the nilpotent-orbit order by
successive reduction and inverse reduction steps, and that the hook-type locus
forms the natural irreducible spine of this network
\cite{FehilyHook,GenraStages,ButsonNair}.  This does not itself classify strict
or higher duality on the nose, but it identifies the hook/subregular family as
the correct place where the first non-principal homological obstructions must be
understood.
