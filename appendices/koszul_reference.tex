...
system of curved $A_\infty$ relations (including the degree-$1$
...
and encodes all curved $A_\infty$ relations simultaneously: degree~$0$
gives Step~1, degree~$1$ gives Step~2. Centrality of~$m_0$ is the
