...
\begin{corollary}[Converse: geometric representability implies Koszul; \ClaimStatusConditional]\label{cor:geom-implies-koszul}
...
by Theorem~\ref{thm:bar-cobar-inversion-qi}, the coalgebra-side unit
$\eta\colon \widehat{\mathcal{C}}\to
\bar{B}(\Omega(\widehat{\mathcal{C}}))$
is a quasi-isomorphism for uncurved conilpotent coalgebras.
