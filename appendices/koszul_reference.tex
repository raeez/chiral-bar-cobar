...
as dg coalgebras, where $(\mathcal{A}^!)^\vee$ is the linear dual of the Koszul dual coalgebra.  Therefore $\mathcal{A}^!$ is geometrically representable (via Verdier/linear duality).
\end{proof}
