...
convolution algebras, curvature, and the shadow tower.
...
\hline
Shadow tower & N/A & N/A & N/A & $\Theta_\cA^{\leq r}$ \\
\hline
...
\emph{Sign consequence.}  The shadow tower's quartic contact invariant
...
Concretely, the MC equation for the shadow tower element $\Theta_\cA^{\leq 2} = \kappa(\cA)$ gives:
\[
