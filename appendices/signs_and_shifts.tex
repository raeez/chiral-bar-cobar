...
When reading other sources, consult this appendix to translate signs and conventions.
...
Our conventions match Kontsevich (lexicographic ordering), Costello--Gwilliam (cohomological grading), and Beilinson--Drinfeld (implicit signs).
The difference from Loday--Vallette is grading direction ($|d| = +1$ vs $-1$); the translation is a global sign reversal on the grading.
