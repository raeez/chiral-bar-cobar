...
This appendix operates at \textbf{M-level}: grading and sign
conventions for the explicit chain models used throughout the
monograph.
\end{remark}

The governing question of this appendix is: which grading and shift
rules ensure every bar/cobar and higher-operation formula has a stable,
globally compatible sign convention.
