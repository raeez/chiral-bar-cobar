...
def pinf_vs_coisson() -> Dict[str, Dict[str, object]]:
    ...
    return {
        "Coisson": {
            ...
            "direction": "descended strict PVA shadow",
        ...
        "P_inf_chiral": {
            ...
            "has_ope": True,
            "structure": "E_inf chiral product + L_infty chiral Lie operations with homotopy Leibniz",
            "direction": "upward homotopy chiral Poisson lift",
