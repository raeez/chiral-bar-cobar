...
def genus3_pixton_ideal_test(shadow: ShadowData) -> Dict[str, Any]:
    ...
    constraints. The MC constraints from the shadow obstruction tower should
...
def admcycles_comparison_genus2() -> Dict[str, Any]:
    ...
    return {
        ...
        'consistency': (
            ...
            'class-M shadow obstruction tower relations.'
        ),
    }
...
def shadow_depth_pixton_hierarchy() -> Dict[str, Any]:
    ...
    The conjecture (conj:pixton-from-shadows):
      Class-M shadow obstruction tower relations GENERATE the Pixton ideal.
