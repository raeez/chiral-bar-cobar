...
def boundary_koszul_dual_data() -> Dict[str, Any]:
    ...
    The branch A_E^! = Sym^{ch}(h_{24}^*) is the dual Heisenberg VOA.
    It is obtained from the bar-dual coalgebra A_E^i by Verdier duality,
    not by the bar-cobar inversion Omega B(A_E) ~= A_E.
