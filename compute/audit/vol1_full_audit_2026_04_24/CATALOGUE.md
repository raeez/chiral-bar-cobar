...
Generated on 2026-04-24 from the live Volume I repo plus the archived red-team ledgers.
...
- Tagged claims in current Volume I metadata: **3919**
- Current `ProvedHere` claims: **2017**
- Current proof-auditor findings: **737**
- Current proof-level critical findings: **0**
- Current proof-level serious findings: **20**
- Current `ProvedHere` claims without compute-test references: **1512**
...
- Duplicate title clusters across files: **155**
...
- `ambiguous_status`: 61
- `duplicate_paragraph_clusters`: 346
- `infinite_generator_drift`: 1
- `kl_scope_drift`: 1
- `mc2_parity_scalar_drift`: 5
- `periodicity_overclaim_drift`: 1
- `prior_version`: 8
- `untagged`: 120
- `virasoro_shadow_drift`: 2
