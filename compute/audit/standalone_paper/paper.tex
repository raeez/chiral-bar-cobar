...
MC element $\Theta_\cA$ and its shadow tower as the primary
...
\item \emph{Spectral projection.}
  ...
  \varepsilon_{Q_L}(s)$.
  Target: the shadow tower and the Epstein zeta.
...
or phase transitions in the shadow tower) is entirely unknown.
...
conjecture connecting the shadow tower to the geometry of
moduli spaces.
