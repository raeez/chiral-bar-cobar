...
$r^{\mathrm{aff}}(z) = k\,\Omega/z$.  The HPL transfer through the
...
$r^{\mathrm{aff}}(z) = k\,\Omega/z$ is a simple pole---the
...
gauge theory, the affine $r$-matrix $r^{\mathrm{aff}}(z) = k\,\Omega/z$
